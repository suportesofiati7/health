# Concept 49 - Wisdom Brief

## 1. Concept Snapshot
- Concept number: 49
- Concept folder path: `concepts/49-wisdom`
- Files inspected: 40 files, including `concepts/49-wisdom/index.html`, `concepts/49-wisdom/css/style.css`, `concepts/49-wisdom/partials/header.html`, `concepts/49-wisdom/partials/mobile-menu.html`, `concepts/49-wisdom/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/49-wisdom-desktop.png`
- `audit/screenshots/mobile/49-wisdom-mobile.png`
- `final/homepage-screenshots/desktop/concept-49-wisdom-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-49-wisdom-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: clean farm skincare translated into a Sofiati visual world, using farm-clean field notes as the governing asset language.
- Visitor emotion: wisdom-led care library.
...
- How it fits Sofiati: It is identified by `farm-clean field notes`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: wisdom-led care library.
...
## 4. Layout Signature
- Homepage structure: wisdom-quiet-route-index-hero-01, wisdom-large-type-statement-content-02, wisdom-consultation-desk-still-life-content-03, wisdom-skin-texture-editorial-content-04, wisdom-laser-light-sequence-pathway-05, wisdom-split-portrait-hero-visual-story-06
- Section rhythm: # 49-wisdom Page Flow Map Concept strategy: Wisdom uses wisdom-led care library as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are wisdom-quiet-route-index-hero-01, wisdom-large-type-statement-content-02, wisdom-consultation-desk-still-life-content-03, wisdom-skin-texture-editorial-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-wisdom`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/49-wisdom/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a farm-luxury header. The header is assigned the unique runtime marker `header-49-wisdom` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/49-wisdom/partials/header.html`, `concepts/49-wisdom/partials/navigation.html`, `concepts/49-wisdom/partials/mobile-menu.html`, `concepts/49-wisdom/css/style.css`, `concepts/49-wisdom/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/49-wisdom/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-wisdom-editorial`.
...
- Visual personality: The mobile menu uses a farm story menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Wisdom before treatment, care after`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-wisdom.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: wisdom-accordion-guidance-panel, wisdom-consultation-desk-still-life, wisdom-offset-consultation-ledger, wisdom-asymmetric-laser-panel. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: wisdom-accordion-guidance-panel, wisdom-consultation-desk-still-life, wisdom-offset-consultation-ledger, wisdom-asymmetric-laser-panel. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: wisdom-image-led-trust-strip, wisdom-large-type-statement, wisdom-split-portrait-hero, wisdom-full-bleed-botanical-divider. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: wisdom-accordion-guidance-panel, wisdom-consultation-desk-still-life, wisdom-offset-consultation-ledger, wisdom-asymmetric-laser-panel. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: wisdom-large-type-statement, wisdom-laser-light-sequence, wisdom-horizontal-care-journey, wisdom-magazine-article-grid. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: wisdom-offset-consultation-ledger, wisdom-full-bleed-botanical-divider, wisdom-contact-card-overlap, wisdom-portrait-and-process-band. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: wisdom-large-type-statement, wisdom-laser-light-sequence, wisdom-horizontal-care-journey, wisdom-magazine-article-grid. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: wisdom-portrait-and-process-band, wisdom-quiet-route-index, wisdom-laser-light-sequence, wisdom-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: wisdom-large-type-statement, wisdom-laser-light-sequence, wisdom-horizontal-care-journey, wisdom-magazine-article-grid. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: wisdom-image-led-trust-strip, wisdom-large-type-statement, wisdom-split-portrait-hero, wisdom-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: wisdom-accordion-guidance-panel, wisdom-consultation-desk-still-life, wisdom-offset-consultation-ledger, wisdom-asymmetric-laser-panel. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-49, public-footer-recipe-wisdom, public-footer-icons-book, public-footer-divider-paper-rule, public-footer-hover-soft-shift, public-footer-shell`; recipe `wisdom`.
...
- Decorative assets/background: The footer uses a clean beauty footer, local contact hierarchy and concept-specific footer marker `footer-49-wisdom`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C49-LABEL-001, C49-SITEMAP-001, C49-RENDER-001
- Files involved: `concepts/49-wisdom/partials/footer.html`, `concepts/49-wisdom/css/style.css`.
...
- Hero/portrait use: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-wisdom.webp`.
- Service/botanical/icons: A custom farm-clean field notes SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/49-wisdom/assets/animations/motion-path.svg`
- `concepts/49-wisdom/assets/backgrounds/botanical-background.svg`
- `concepts/49-wisdom/assets/backgrounds/mobile-menu-background.svg`
- `concepts/49-wisdom/assets/botanical/botanical-quote.svg`
- `concepts/49-wisdom/assets/botanical/bronze-branch.svg`
- `concepts/49-wisdom/assets/botanical/footer-botanical-stamp.svg`
- `concepts/49-wisdom/assets/botanical/gold-leaf-divider.svg`
- `concepts/49-wisdom/assets/botanical/monogram-wreath.svg`
- `concepts/49-wisdom/assets/botanical/sage-botanical-corner.svg`
- `concepts/49-wisdom/assets/botanical/section-separator.svg`
- `concepts/49-wisdom/assets/brand/assinatura-1.jpg`
- `concepts/49-wisdom/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Wisdom | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Wisdom concept.`
- H1 pattern: 1 H1 parsed; `Wisdom before treatment, care after`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/49-wisdom/sitemap.html` exists.
...
- What makes it different: It is identified by `farm-clean field notes`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-wisdom`, menu `public-menu-layout-wisdom-editorial`, footer recipe `wisdom`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `journal card rise controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `50` and `07` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `wisdom-led care library.` visual grammar.
...
## 21. Fixes Applied
- C49-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/49-wisdom/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C49-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/49-wisdom/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C49-RENDER-001
