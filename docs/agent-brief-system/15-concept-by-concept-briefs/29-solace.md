# Concept 29 - Solace Brief

## 1. Concept Snapshot
- Concept number: 29
- Concept folder path: `concepts/29-solace`
- Files inspected: 40 files, including `concepts/29-solace/index.html`, `concepts/29-solace/css/style.css`, `concepts/29-solace/partials/header.html`, `concepts/29-solace/partials/mobile-menu.html`, `concepts/29-solace/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/29-solace-desktop.png`
- `audit/screenshots/mobile/29-solace-mobile.png`
- `final/homepage-screenshots/desktop/concept-29-solace-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-29-solace-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: doctor journal translated into a Sofiati visual world, using doctor journal notecards as the governing asset language.
- Visitor emotion: solace support journey.
...
- How it fits Sofiati: It is identified by `doctor journal notecards`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: solace support journey.
...
## 4. Layout Signature
- Homepage structure: solace-quiet-route-index-hero-01, solace-large-type-statement-content-02, solace-consultation-desk-still-life-content-03, solace-skin-texture-editorial-content-04, solace-laser-light-sequence-pathway-05, solace-split-portrait-hero-visual-story-06
- Section rhythm: # 29-solace Page Flow Map Concept strategy: Solace uses solace support journey as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are solace-quiet-route-index-hero-01, solace-large-type-statement-content-02, solace-consultation-desk-still-life-content-03, solace-skin-texture-editorial-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-solace`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/29-solace/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a journal doctor header. The header is assigned the unique runtime marker `header-29-solace` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/29-solace/partials/header.html`, `concepts/29-solace/partials/navigation.html`, `concepts/29-solace/partials/mobile-menu.html`, `concepts/29-solace/css/style.css`, `concepts/29-solace/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/29-solace/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-warm-full`.
...
- Visual personality: The mobile menu uses a notebook menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Professional calm for sensitive decisions`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-solace.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: solace-accordion-guidance-panel, solace-consultation-desk-still-life, solace-offset-consultation-ledger, solace-asymmetric-laser-panel. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: solace-accordion-guidance-panel, solace-consultation-desk-still-life, solace-offset-consultation-ledger, solace-asymmetric-laser-panel. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: solace-image-led-trust-strip, solace-large-type-statement, solace-split-portrait-hero, solace-full-bleed-botanical-divider. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: solace-accordion-guidance-panel, solace-consultation-desk-still-life, solace-offset-consultation-ledger, solace-asymmetric-laser-panel. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: solace-large-type-statement, solace-laser-light-sequence, solace-horizontal-care-journey, solace-magazine-article-grid. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: solace-offset-consultation-ledger, solace-full-bleed-botanical-divider, solace-contact-card-overlap, solace-portrait-and-process-band. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: solace-large-type-statement, solace-laser-light-sequence, solace-horizontal-care-journey, solace-magazine-article-grid. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: solace-portrait-and-process-band, solace-quiet-route-index, solace-laser-light-sequence, solace-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: solace-large-type-statement, solace-laser-light-sequence, solace-horizontal-care-journey, solace-magazine-article-grid. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: solace-image-led-trust-strip, solace-large-type-statement, solace-split-portrait-hero, solace-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: solace-accordion-guidance-panel, solace-consultation-desk-still-life, solace-offset-consultation-ledger, solace-asymmetric-laser-panel. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-29, public-footer-recipe-solace, public-footer-icons-circle, public-footer-divider-soft-arc, public-footer-hover-soft-shift, public-footer-shell`; recipe `solace`.
...
- Decorative assets/background: The footer uses a personal practice footer, local contact hierarchy and concept-specific footer marker `footer-29-solace`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C29-LABEL-001, C29-SITEMAP-001, C29-RENDER-001
- Files involved: `concepts/29-solace/partials/footer.html`, `concepts/29-solace/css/style.css`.
...
- Hero/portrait use: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-solace.webp`.
- Service/botanical/icons: A custom doctor journal notecards SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/29-solace/assets/animations/motion-path.svg`
- `concepts/29-solace/assets/backgrounds/botanical-background.svg`
- `concepts/29-solace/assets/backgrounds/mobile-menu-background.svg`
- `concepts/29-solace/assets/botanical/botanical-quote.svg`
- `concepts/29-solace/assets/botanical/bronze-branch.svg`
- `concepts/29-solace/assets/botanical/footer-botanical-stamp.svg`
- `concepts/29-solace/assets/botanical/gold-leaf-divider.svg`
- `concepts/29-solace/assets/botanical/monogram-wreath.svg`
- `concepts/29-solace/assets/botanical/sage-botanical-corner.svg`
- `concepts/29-solace/assets/botanical/section-separator.svg`
- `concepts/29-solace/assets/brand/assinatura-1.jpg`
- `concepts/29-solace/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Solace | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Solace concept.`
- H1 pattern: 1 H1 parsed; `Professional calm for sensitive decisions`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/29-solace/sitemap.html` exists.
...
- What makes it different: It is identified by `doctor journal notecards`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-solace`, menu `public-menu-layout-warm-full`, footer recipe `solace`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `journal card rise controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `30` and `37` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `solace support journey.` visual grammar.
...
## 21. Fixes Applied
- C29-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/29-solace/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C29-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/29-solace/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C29-RENDER-001
