# Concept 04 - Renew Brief

## 1. Concept Snapshot
- Concept number: 04
- Concept folder path: `concepts/04-renew`
- Files inspected: 40 files, including `concepts/04-renew/index.html`, `concepts/04-renew/css/style.css`, `concepts/04-renew/partials/header.html`, `concepts/04-renew/partials/mobile-menu.html`, `concepts/04-renew/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/04-renew-desktop.png`
- `audit/screenshots/mobile/04-renew-mobile.png`
- `final/homepage-screenshots/desktop/concept-04-renew-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-04-renew-home-mobile.png`
- Status: strong
- Confidence level: high

## 2. Concept Purpose
- Intended impression: soft renewal journey translated into a Sofiati visual world, using laser dossier geometry as the governing asset language.
- Visitor emotion: renewal notebook.
...
- How it fits Sofiati: It is identified by `laser dossier geometry`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: renewal notebook.
...
## 4. Layout Signature
- Homepage structure: renew-stacked-proof-column-hero-01, renew-floating-note-system-content-02, renew-portrait-and-process-band-pathway-03, renew-image-led-trust-strip-content-04, renew-accordion-guidance-panel-content-05, renew-quiet-route-index-content-06
- Section rhythm: # 04-renew Page Flow Map Concept strategy: Renew uses renewal notebook as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are renew-stacked-proof-column-hero-01, renew-floating-note-system-content-02, renew-portrait-and-process-band-pathway-03, renew-image-led-trust-strip-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-transparent`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/04-renew/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a flowing botanical header. The header is assigned the unique runtime marker `header-04-renew` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/04-renew/partials/header.html`, `concepts/04-renew/partials/navigation.html`, `concepts/04-renew/partials/mobile-menu.html`, `concepts/04-renew/css/style.css`, `concepts/04-renew/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/04-renew/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-botanical-fade`.
...
- Visual personality: The mobile menu uses a organic transformation menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Personalised care with clinical calm`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-renew.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: renew-minimal-legal-ledger, renew-portrait-and-process-band, renew-large-type-statement, renew-split-portrait-hero. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: renew-minimal-legal-ledger, renew-portrait-and-process-band, renew-large-type-statement, renew-split-portrait-hero. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: renew-contact-card-overlap, renew-floating-note-system, renew-quiet-route-index, renew-laser-light-sequence. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: renew-minimal-legal-ledger, renew-portrait-and-process-band, renew-large-type-statement, renew-split-portrait-hero. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: renew-floating-note-system, renew-accordion-guidance-panel, renew-skin-texture-editorial, renew-editorial-image-chapter. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: renew-large-type-statement, renew-laser-light-sequence, renew-horizontal-care-journey, renew-magazine-article-grid. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: renew-floating-note-system, renew-accordion-guidance-panel, renew-skin-texture-editorial, renew-editorial-image-chapter. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: renew-magazine-article-grid, renew-stacked-proof-column, renew-accordion-guidance-panel, renew-skin-texture-editorial. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: renew-floating-note-system, renew-accordion-guidance-panel, renew-skin-texture-editorial, renew-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: renew-contact-card-overlap, renew-floating-note-system, renew-quiet-route-index, renew-laser-light-sequence. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: renew-minimal-legal-ledger, renew-portrait-and-process-band, renew-large-type-statement, renew-split-portrait-hero. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-04, public-footer-recipe-renew, public-footer-icons-sprig, public-footer-divider-soft-arc, public-footer-hover-gold-sweep, public-footer-shell`; recipe `renew`.
...
- Decorative assets/background: The footer uses a soft botanical footer, local contact hierarchy and concept-specific footer marker `footer-04-renew`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C04-LABEL-001, C04-SITEMAP-001
- Files involved: `concepts/04-renew/partials/footer.html`, `concepts/04-renew/css/style.css`.
...
- Hero/portrait use: business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-renew.webp`.
- Service/botanical/icons: A custom laser dossier geometry SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/04-renew/assets/animations/motion-path.svg`
- `concepts/04-renew/assets/backgrounds/botanical-background.svg`
- `concepts/04-renew/assets/backgrounds/mobile-menu-background.svg`
- `concepts/04-renew/assets/botanical/botanical-quote.svg`
- `concepts/04-renew/assets/botanical/bronze-branch.svg`
- `concepts/04-renew/assets/botanical/footer-botanical-stamp.svg`
- `concepts/04-renew/assets/botanical/gold-leaf-divider.svg`
- `concepts/04-renew/assets/botanical/monogram-wreath.svg`
- `concepts/04-renew/assets/botanical/sage-botanical-corner.svg`
- `concepts/04-renew/assets/botanical/section-separator.svg`
- `concepts/04-renew/assets/brand/assinatura-1.jpg`
- `concepts/04-renew/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Renew | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Renew concept.`
- H1 pattern: 1 H1 parsed; `Personalised care with clinical calm`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/04-renew/sitemap.html` exists.
...
- What makes it different: It is identified by `laser dossier geometry`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-transparent`, menu `public-menu-layout-botanical-fade`, footer recipe `renew`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `icon tilt controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `05` and `12` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `renewal notebook.` visual grammar.
...
## 21. Fixes Applied
- C04-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/04-renew/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C04-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/04-renew/sitemap.html`. Verification: Run rg for Brand and education..
