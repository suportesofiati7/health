# Concept 40 - Noble Brief

## 1. Concept Snapshot
- Concept number: 40
- Concept folder path: `concepts/40-noble`
- Files inspected: 40 files, including `concepts/40-noble/index.html`, `concepts/40-noble/css/style.css`, `concepts/40-noble/partials/header.html`, `concepts/40-noble/partials/mobile-menu.html`, `concepts/40-noble/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/40-noble-desktop.png`
- `audit/screenshots/mobile/40-noble-mobile.png`
- `final/homepage-screenshots/desktop/concept-40-noble-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-40-noble-home-mobile.png`
- Status: strong
- Confidence level: high

## 2. Concept Purpose
- Intended impression: prestige product editorial translated into a Sofiati visual world, using prestige formula shimmer as the governing asset language.
- Visitor emotion: noble restrained authority.
...
- How it fits Sofiati: It is identified by `prestige formula shimmer`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: noble restrained authority.
...
## 4. Layout Signature
- Homepage structure: noble-radial-results-map-hero-01, noble-magazine-article-grid-visual-story-02, noble-contact-card-overlap-pathway-03, noble-minimal-legal-ledger-content-04, noble-stacked-proof-column-content-05, noble-floating-note-system-content-06
- Section rhythm: # 40-noble Page Flow Map Concept strategy: Noble uses noble restrained authority as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are noble-radial-results-map-hero-01, noble-magazine-article-grid-visual-story-02, noble-contact-card-overlap-pathway-03, noble-minimal-legal-ledger-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-noble`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/40-noble/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a prestige header. The header is assigned the unique runtime marker `header-40-noble` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/40-noble/partials/header.html`, `concepts/40-noble/partials/navigation.html`, `concepts/40-noble/partials/mobile-menu.html`, `concepts/40-noble/css/style.css`, `concepts/40-noble/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/40-noble/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-dark-elegant`.
...
- Visual personality: The mobile menu uses a formula menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `A refined route to consultation`.
- Image placement: homepage images include assets/brand/sofiati-monogram-bronze.png, assets/images/laser/sofiati-laser-botanical-precision-story-background.webp, assets/images/journal/sofiati-journal-typography-palette-system.webp, assets/images/values/sofiati-values-care-confidence-safety-naturalness.webp
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-noble.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: noble-asymmetric-laser-panel, noble-contact-card-overlap, noble-portrait-and-process-band, noble-large-type-statement. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: noble-asymmetric-laser-panel, noble-contact-card-overlap, noble-portrait-and-process-band, noble-large-type-statement. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: noble-full-bleed-botanical-divider, noble-magazine-article-grid, noble-floating-note-system, noble-quiet-route-index. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: noble-asymmetric-laser-panel, noble-contact-card-overlap, noble-portrait-and-process-band, noble-large-type-statement. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: noble-magazine-article-grid, noble-stacked-proof-column, noble-accordion-guidance-panel, noble-skin-texture-editorial. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: noble-portrait-and-process-band, noble-quiet-route-index, noble-laser-light-sequence, noble-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: noble-magazine-article-grid, noble-stacked-proof-column, noble-accordion-guidance-panel, noble-skin-texture-editorial. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: noble-horizontal-care-journey, noble-radial-results-map, noble-stacked-proof-column, noble-accordion-guidance-panel. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: noble-magazine-article-grid, noble-stacked-proof-column, noble-accordion-guidance-panel, noble-skin-texture-editorial. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: noble-full-bleed-botanical-divider, noble-magazine-article-grid, noble-floating-note-system, noble-quiet-route-index. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: noble-asymmetric-laser-panel, noble-contact-card-overlap, noble-portrait-and-process-band, noble-large-type-statement. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-40, public-footer-recipe-noble, public-footer-icons-diamond, public-footer-divider-champagne-rule, public-footer-hover-gold-sweep, public-footer-shell`; recipe `noble`.
...
- Decorative assets/background: The footer uses a prestige footer, local contact hierarchy and concept-specific footer marker `footer-40-noble`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C40-LABEL-001, C40-SITEMAP-001
- Files involved: `concepts/40-noble/partials/footer.html`, `concepts/40-noble/css/style.css`.
...
- Hero/portrait use: journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-noble.webp`.
- Service/botanical/icons: A custom prestige formula shimmer SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/40-noble/assets/animations/motion-path.svg`
- `concepts/40-noble/assets/backgrounds/botanical-background.svg`
- `concepts/40-noble/assets/backgrounds/mobile-menu-background.svg`
- `concepts/40-noble/assets/botanical/botanical-quote.svg`
- `concepts/40-noble/assets/botanical/bronze-branch.svg`
- `concepts/40-noble/assets/botanical/footer-botanical-stamp.svg`
- `concepts/40-noble/assets/botanical/gold-leaf-divider.svg`
- `concepts/40-noble/assets/botanical/monogram-wreath.svg`
- `concepts/40-noble/assets/botanical/sage-botanical-corner.svg`
- `concepts/40-noble/assets/botanical/section-separator.svg`
- `concepts/40-noble/assets/brand/assinatura-1.jpg`
- `concepts/40-noble/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Noble | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Noble concept.`
- H1 pattern: 1 H1 parsed; `A refined route to consultation`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/40-noble/sitemap.html` exists.
...
- What makes it different: It is identified by `prestige formula shimmer`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-noble`, menu `public-menu-layout-dark-elegant`, footer recipe `noble`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `service badge pulse controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `41` and `48` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `noble restrained authority.` visual grammar.
...
## 21. Fixes Applied
- C40-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/40-noble/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C40-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/40-noble/sitemap.html`. Verification: Run rg for Brand and education..
