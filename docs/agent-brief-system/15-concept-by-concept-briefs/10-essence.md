# Concept 10 - Essence Brief

## 1. Concept Snapshot
- Concept number: 10
- Concept folder path: `concepts/10-essence`
- Files inspected: 40 files, including `concepts/10-essence/index.html`, `concepts/10-essence/css/style.css`, `concepts/10-essence/partials/header.html`, `concepts/10-essence/partials/mobile-menu.html`, `concepts/10-essence/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/10-essence-desktop.png`
- `audit/screenshots/mobile/10-essence-mobile.png`
- `final/homepage-screenshots/desktop/concept-10-essence-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-10-essence-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: distilled minimal appointment suite translated into a Sofiati visual world, using minimal appointment stationery as the governing asset language.
- Visitor emotion: quiet essence ledger.
...
- How it fits Sofiati: It is identified by `minimal appointment stationery`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: quiet essence ledger.
...
- Premium cues: footer botanical stamp appears in the hero, section strip, mobile menu, form and footer.
- Trust cues: professional role, CRBM, evaluation-led copy, legal/contact footer, and page-flow links.

## 4. Layout Signature
- Homepage structure: essence-large-type-statement-hero-01, essence-consultation-desk-still-life-visual-story-02, essence-skin-texture-editorial-pathway-03, essence-laser-light-sequence-content-04, essence-split-portrait-hero-content-05, essence-offset-consultation-ledger-content-06
- Section rhythm: # 10-essence Page Flow Map Concept strategy: Essence uses quiet essence ledger as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are essence-large-type-statement-hero-01, essence-consultation-desk-still-life-visual-story-02, essence-skin-texture-editorial-pathway-03, essence-laser-light-sequence-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-menu-only`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/10-essence/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a bare editorial mega-menu header. The header is assigned the unique runtime marker `header-10-essence` and a concept-specific CSS composition.
- Risks: C10-HEADER-001
- Files involved: `concepts/10-essence/partials/header.html`, `concepts/10-essence/partials/navigation.html`, `concepts/10-essence/partials/mobile-menu.html`, `concepts/10-essence/css/style.css`, `concepts/10-essence/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/10-essence/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-typographic-full`.
...
- Visual personality: The mobile menu uses a reduced story menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Aesthetic care shaped around you`.
- Image placement: homepage images include assets/brand/sofiati-monogram-bronze.png, assets/images/values/sofiati-values-care-confidence-safety-naturalness.webp, assets/images/home/sofiati-home-hero-botanical-clinical-luxury.webp, assets/images/laser/sofiati-laser-botanical-precision-story-background.webp
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-essence.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: essence-quiet-route-index, essence-skin-texture-editorial, essence-editorial-image-chapter, essence-radial-results-map. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: essence-quiet-route-index, essence-skin-texture-editorial, essence-editorial-image-chapter, essence-radial-results-map. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: essence-accordion-guidance-panel, essence-consultation-desk-still-life, essence-offset-consultation-ledger, essence-asymmetric-laser-panel. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: essence-quiet-route-index, essence-skin-texture-editorial, essence-editorial-image-chapter, essence-radial-results-map. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: essence-consultation-desk-still-life, essence-split-portrait-hero, essence-full-bleed-botanical-divider, essence-contact-card-overlap. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: essence-editorial-image-chapter, essence-asymmetric-laser-panel, essence-minimal-legal-ledger, essence-image-led-trust-strip. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: essence-consultation-desk-still-life, essence-split-portrait-hero, essence-full-bleed-botanical-divider, essence-contact-card-overlap. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: essence-image-led-trust-strip, essence-large-type-statement, essence-split-portrait-hero, essence-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: essence-consultation-desk-still-life, essence-split-portrait-hero, essence-full-bleed-botanical-divider, essence-contact-card-overlap. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: essence-accordion-guidance-panel, essence-consultation-desk-still-life, essence-offset-consultation-ledger, essence-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: essence-quiet-route-index, essence-skin-texture-editorial, essence-editorial-image-chapter, essence-radial-results-map. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-10, public-footer-recipe-essence, public-footer-icons-none, public-footer-divider-minimal, public-footer-hover-opacity-lift, public-footer-shell`; recipe `essence`.
...
- Decorative assets/background: The footer uses a split minimal CTA footer, local contact hierarchy and concept-specific footer marker `footer-10-essence`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C10-LABEL-001, C10-SITEMAP-001, C10-RENDER-001, C10-RENDER-002
- Files involved: `concepts/10-essence/partials/footer.html`, `concepts/10-essence/css/style.css`.
...
- Visual priority: portrait-led consultation form with a botanical frame, focus glow, privacy acknowledgement, honeypot, loading, success and error states.
...
- Primary colors: #A2AE9F, #798A80, #F3EFE5, #F8F4EA, #F8F7F2, #9A6B35, #FDE3B0, #273332, #706B63, #B9843D
- Accent/background variables: --sage: #A2AE9F, --deep-sage: #798A80, --ivory: #F3EFE5, --cream: #F8F4EA, --soft-white: #F8F7F2, --bronze: #9A6B35, --champagne: #FDE3B0, --ink: #273332, --muted: #706B63, --accent: #B9843D, --surface: #F7F2E8, --line: rgba(37,35,33,.14)
- Glow use: footer botanical stamp appears in the hero, section strip, mobile menu, form and footer.
...
- Hero/portrait use: journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-essence.webp`.
- Service/botanical/icons: A custom minimal appointment stationery SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/10-essence/assets/animations/motion-path.svg`
- `concepts/10-essence/assets/backgrounds/botanical-background.svg`
- `concepts/10-essence/assets/backgrounds/mobile-menu-background.svg`
- `concepts/10-essence/assets/botanical/botanical-quote.svg`
- `concepts/10-essence/assets/botanical/bronze-branch.svg`
- `concepts/10-essence/assets/botanical/footer-botanical-stamp.svg`
- `concepts/10-essence/assets/botanical/gold-leaf-divider.svg`
- `concepts/10-essence/assets/botanical/monogram-wreath.svg`
- `concepts/10-essence/assets/botanical/sage-botanical-corner.svg`
- `concepts/10-essence/assets/botanical/section-separator.svg`
- `concepts/10-essence/assets/brand/assinatura-1.jpg`
- `concepts/10-essence/assets/brand/footer-signature-watermark.png`
...
- Motion idea: service badge pulse controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Essence | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Essence concept.`
- H1 pattern: 1 H1 parsed; `Aesthetic care shaped around you`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/10-essence/sitemap.html` exists.
...
- What makes it different: It is identified by `minimal appointment stationery`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-menu-only`, menu `public-menu-layout-typographic-full`, footer recipe `essence`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `service badge pulse controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `11` and `18` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `quiet essence ledger.` visual grammar.
...
### C10-HEADER-001
- Page/component: homepage/header/footer / Desktop header visibility
...
### C10-RENDER-001
- Page/component: index.html / Header consultation CTA is not visible
...
## 21. Fixes Applied
- C10-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/10-essence/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C10-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/10-essence/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C10-HEADER-001, C10-RENDER-001, C10-RENDER-002
