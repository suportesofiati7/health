# Concept 42 - Softline Brief

## 1. Concept Snapshot
- Concept number: 42
- Concept folder path: `concepts/42-softline`
- Files inspected: 40 files, including `concepts/42-softline/index.html`, `concepts/42-softline/css/style.css`, `concepts/42-softline/partials/header.html`, `concepts/42-softline/partials/mobile-menu.html`, `concepts/42-softline/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/42-softline-desktop.png`
- `audit/screenshots/mobile/42-softline-mobile.png`
- `final/homepage-screenshots/desktop/concept-42-softline-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-42-softline-home-mobile.png`
- Status: strong
- Confidence level: high

## 2. Concept Purpose
- Intended impression: apothecary minimalism translated into a Sofiati visual world, using apothecary text stamps as the governing asset language.
- Visitor emotion: softline gentle pathway.
...
- How it fits Sofiati: It is identified by `apothecary text stamps`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: softline gentle pathway.
...
## 4. Layout Signature
- Homepage structure: softline-contact-card-overlap-hero-01, softline-portrait-and-process-band-contextual-journey, softline-stacked-proof-column-consultation-form-03, softline-floating-note-system-pathway-04, softline-portrait-and-process-band-content-05, softline-image-led-trust-strip-content-06
- Section rhythm: # 42-softline Page Flow Map Concept strategy: Softline uses softline gentle pathway as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are softline-contact-card-overlap-hero-01, softline-portrait-and-process-band-contextual-journey, softline-stacked-proof-column-consultation-form-03, softline-floating-note-system-pathway-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-softline`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/42-softline/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a apothecary header. The header is assigned the unique runtime marker `header-42-softline` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/42-softline/partials/header.html`, `concepts/42-softline/partials/navigation.html`, `concepts/42-softline/partials/mobile-menu.html`, `concepts/42-softline/css/style.css`, `concepts/42-softline/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/42-softline/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-curved-line`.
...
- Visual personality: The mobile menu uses a text-only apothecary menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Laser, skin and calm expertise`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-softline.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: softline-magazine-article-grid, softline-stacked-proof-column, softline-accordion-guidance-panel, softline-skin-texture-editorial. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: softline-magazine-article-grid, softline-stacked-proof-column, softline-accordion-guidance-panel, softline-skin-texture-editorial. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: softline-radial-results-map, softline-minimal-legal-ledger, softline-image-led-trust-strip, softline-consultation-desk-still-life. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: softline-magazine-article-grid, softline-stacked-proof-column, softline-accordion-guidance-panel, softline-skin-texture-editorial. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: softline-minimal-legal-ledger, softline-portrait-and-process-band, softline-large-type-statement, softline-split-portrait-hero. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: softline-accordion-guidance-panel, softline-consultation-desk-still-life, softline-offset-consultation-ledger, softline-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: softline-minimal-legal-ledger, softline-portrait-and-process-band, softline-large-type-statement, softline-split-portrait-hero. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: softline-asymmetric-laser-panel, softline-contact-card-overlap, softline-portrait-and-process-band, softline-large-type-statement. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: softline-minimal-legal-ledger, softline-portrait-and-process-band, softline-large-type-statement, softline-split-portrait-hero. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: softline-radial-results-map, softline-minimal-legal-ledger, softline-image-led-trust-strip, softline-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: softline-magazine-article-grid, softline-stacked-proof-column, softline-accordion-guidance-panel, softline-skin-texture-editorial. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-42, public-footer-recipe-softline, public-footer-icons-curve, public-footer-divider-soft-arc, public-footer-hover-underline, public-footer-shell`; recipe `softline`.
...
- Decorative assets/background: The footer uses a apothecary footer, local contact hierarchy and concept-specific footer marker `footer-42-softline`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C42-LABEL-001, C42-SITEMAP-001
- Files involved: `concepts/42-softline/partials/footer.html`, `concepts/42-softline/css/style.css`.
...
- Hero/portrait use: round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-softline.webp`.
- Service/botanical/icons: A custom apothecary text stamps SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/42-softline/assets/animations/motion-path.svg`
- `concepts/42-softline/assets/backgrounds/botanical-background.svg`
- `concepts/42-softline/assets/backgrounds/mobile-menu-background.svg`
- `concepts/42-softline/assets/botanical/botanical-quote.svg`
- `concepts/42-softline/assets/botanical/bronze-branch.svg`
- `concepts/42-softline/assets/botanical/footer-botanical-stamp.svg`
- `concepts/42-softline/assets/botanical/gold-leaf-divider.svg`
- `concepts/42-softline/assets/botanical/monogram-wreath.svg`
- `concepts/42-softline/assets/botanical/sage-botanical-corner.svg`
- `concepts/42-softline/assets/botanical/section-separator.svg`
- `concepts/42-softline/assets/brand/assinatura-1.jpg`
- `concepts/42-softline/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Softline | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Softline concept.`
- H1 pattern: 1 H1 parsed; `Laser, skin and calm expertise`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/42-softline/sitemap.html` exists.
...
- What makes it different: It is identified by `apothecary text stamps`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-softline`, menu `public-menu-layout-curved-line`, footer recipe `softline`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `leaf orbit controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `43` and `50` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `softline gentle pathway.` visual grammar.
...
## 21. Fixes Applied
- C42-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/42-softline/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C42-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/42-softline/sitemap.html`. Verification: Run rg for Brand and education..
