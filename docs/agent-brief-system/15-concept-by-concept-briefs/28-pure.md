# Concept 28 - Pure Brief

## 1. Concept Snapshot
- Concept number: 28
- Concept folder path: `concepts/28-pure`
- Files inspected: 40 files, including `concepts/28-pure/index.html`, `concepts/28-pure/css/style.css`, `concepts/28-pure/partials/header.html`, `concepts/28-pure/partials/mobile-menu.html`, `concepts/28-pure/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/28-pure-desktop.png`
- `audit/screenshots/mobile/28-pure-mobile.png`
- `final/homepage-screenshots/desktop/concept-28-pure-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-28-pure-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: focused wrinkle education translated into a Sofiati visual world, using single-service education marks as the governing asset language.
- Visitor emotion: pure ivory care path.
...
- How it fits Sofiati: It is identified by `single-service education marks`, portrait treatment `champagne line portrait seal`, motion `form focus glow`, form `business-card form` and footer `bronze strip footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: pure ivory care path.
...
## 4. Layout Signature
- Homepage structure: pure-accordion-guidance-panel-hero-01, pure-quiet-route-index-content-02, pure-large-type-statement-content-03, pure-consultation-desk-still-life-visual-story-04, pure-skin-texture-editorial-pathway-05, pure-laser-light-sequence-content-06
- Section rhythm: # 28-pure Page Flow Map Concept strategy: Pure uses pure ivory care path as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are pure-accordion-guidance-panel-hero-01, pure-quiet-route-index-content-02, pure-large-type-statement-content-03, pure-consultation-desk-still-life-visual-story-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-pure`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/28-pure/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a single-service header. The header is assigned the unique runtime marker `header-28-pure` and a concept-specific CSS composition.
- Risks: C28-LANG-001
- Files involved: `concepts/28-pure/partials/header.html`, `concepts/28-pure/partials/navigation.html`, `concepts/28-pure/partials/mobile-menu.html`, `concepts/28-pure/css/style.css`, `concepts/28-pure/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/28-pure/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-pure-ivory`.
...
- Visual personality: The mobile menu uses a question-led menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Skin and laser care without exaggeration`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is champagne line portrait seal, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-pure.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: pure-image-led-trust-strip, pure-large-type-statement, pure-split-portrait-hero, pure-full-bleed-botanical-divider. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: pure-image-led-trust-strip, pure-large-type-statement, pure-split-portrait-hero, pure-full-bleed-botanical-divider. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: pure-portrait-and-process-band, pure-quiet-route-index, pure-laser-light-sequence, pure-horizontal-care-journey. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: pure-image-led-trust-strip, pure-large-type-statement, pure-split-portrait-hero, pure-full-bleed-botanical-divider. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: pure-quiet-route-index, pure-skin-texture-editorial, pure-editorial-image-chapter, pure-radial-results-map. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: pure-split-portrait-hero, pure-horizontal-care-journey, pure-magazine-article-grid, pure-floating-note-system. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: pure-quiet-route-index, pure-skin-texture-editorial, pure-editorial-image-chapter, pure-radial-results-map. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: pure-floating-note-system, pure-accordion-guidance-panel, pure-skin-texture-editorial, pure-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: pure-quiet-route-index, pure-skin-texture-editorial, pure-editorial-image-chapter, pure-radial-results-map. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: pure-portrait-and-process-band, pure-quiet-route-index, pure-laser-light-sequence, pure-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: pure-image-led-trust-strip, pure-large-type-statement, pure-split-portrait-hero, pure-full-bleed-botanical-divider. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-28, public-footer-recipe-pure, public-footer-icons-none, public-footer-divider-minimal, public-footer-hover-opacity-lift, public-footer-shell`; recipe `pure`.
...
- Decorative assets/background: The footer uses a education footer, local contact hierarchy and concept-specific footer marker `footer-28-pure`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C28-LABEL-001, C28-SITEMAP-001, C28-FOOTER-001, C28-RENDER-001, C28-RENDER-002
- Files involved: `concepts/28-pure/partials/footer.html`, `concepts/28-pure/css/style.css`.
...
- Hero/portrait use: champagne line portrait seal, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-pure.webp`.
- Service/botanical/icons: A custom single-service education marks SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/28-pure/assets/animations/motion-path.svg`
- `concepts/28-pure/assets/backgrounds/botanical-background.svg`
- `concepts/28-pure/assets/backgrounds/mobile-menu-background.svg`
- `concepts/28-pure/assets/botanical/botanical-quote.svg`
- `concepts/28-pure/assets/botanical/bronze-branch.svg`
- `concepts/28-pure/assets/botanical/footer-botanical-stamp.svg`
- `concepts/28-pure/assets/botanical/gold-leaf-divider.svg`
- `concepts/28-pure/assets/botanical/monogram-wreath.svg`
- `concepts/28-pure/assets/botanical/sage-botanical-corner.svg`
- `concepts/28-pure/assets/botanical/section-separator.svg`
- `concepts/28-pure/assets/brand/assinatura-1.jpg`
- `concepts/28-pure/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Pure | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Pure concept.`
- H1 pattern: 1 H1 parsed; `Skin and laser care without exaggeration`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/28-pure/sitemap.html` exists.
...
- What makes it different: It is identified by `single-service education marks`, portrait treatment `champagne line portrait seal`, motion `form focus glow`, form `business-card form` and footer `bronze strip footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-pure`, menu `public-menu-layout-pure-ivory`, footer recipe `pure`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `form focus glow controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `29` and `36` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `pure ivory care path.` visual grammar.
...
## 21. Fixes Applied
- C28-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/28-pure/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C28-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/28-pure/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C28-LANG-001, C28-FOOTER-001, C28-RENDER-001, C28-RENDER-002
