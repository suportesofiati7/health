# Concept 19 - Verda Brief

## 1. Concept Snapshot
- Concept number: 19
- Concept folder path: `concepts/19-verda`
- Files inspected: 40 files, including `concepts/19-verda/index.html`, `concepts/19-verda/css/style.css`, `concepts/19-verda/partials/header.html`, `concepts/19-verda/partials/mobile-menu.html`, `concepts/19-verda/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/19-verda-desktop.png`
- `audit/screenshots/mobile/19-verda-mobile.png`
- `final/homepage-screenshots/desktop/concept-19-verda-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-19-verda-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: verdant botanical architecture translated into a Sofiati visual world, using local search direction tags as the governing asset language.
- Visitor emotion: verde botanical calm.
...
- How it fits Sofiati: It is identified by `local search direction tags`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: verde botanical calm.
...
- Premium cues: mobile-menu botanical field appears in the hero, section strip, mobile menu, form and footer.
- Trust cues: professional role, CRBM, evaluation-led copy, legal/contact footer, and page-flow links.

## 4. Layout Signature
- Homepage structure: verda-asymmetric-laser-panel-hero-01, verda-radial-results-map-content-02, verda-magazine-article-grid-content-03, verda-contact-card-overlap-content-04, verda-minimal-legal-ledger-pathway-05, verda-stacked-proof-column-visual-story-06
- Section rhythm: # 19-verda Page Flow Map Concept strategy: Verda uses verde botanical calm as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are verda-asymmetric-laser-panel-hero-01, verda-radial-results-map-content-02, verda-magazine-article-grid-content-03, verda-contact-card-overlap-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-verdant`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/19-verda/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a organic green navigation. The header is assigned the unique runtime marker `header-19-verda` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/19-verda/partials/header.html`, `concepts/19-verda/partials/navigation.html`, `concepts/19-verda/partials/mobile-menu.html`, `concepts/19-verda/css/style.css`, `concepts/19-verda/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/19-verda/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-deep-botanical`.
...
- Visual personality: The mobile menu uses a verdant quick-action menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Soft precision for laser and skin`.
- Image placement: homepage images include assets/brand/sofiati-monogram-bronze.png, assets/images/journal/sofiati-journal-typography-palette-system.webp, assets/images/values/sofiati-values-care-confidence-safety-naturalness.webp, assets/images/home/sofiati-home-hero-botanical-clinical-luxury.webp
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-verda.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: verda-full-bleed-botanical-divider, verda-magazine-article-grid, verda-floating-note-system, verda-quiet-route-index. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: verda-full-bleed-botanical-divider, verda-magazine-article-grid, verda-floating-note-system, verda-quiet-route-index. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: verda-horizontal-care-journey, verda-radial-results-map, verda-stacked-proof-column, verda-accordion-guidance-panel. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: verda-full-bleed-botanical-divider, verda-magazine-article-grid, verda-floating-note-system, verda-quiet-route-index. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: verda-radial-results-map, verda-minimal-legal-ledger, verda-image-led-trust-strip, verda-consultation-desk-still-life. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: verda-floating-note-system, verda-accordion-guidance-panel, verda-skin-texture-editorial, verda-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: verda-radial-results-map, verda-minimal-legal-ledger, verda-image-led-trust-strip, verda-consultation-desk-still-life. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: verda-editorial-image-chapter, verda-asymmetric-laser-panel, verda-minimal-legal-ledger, verda-image-led-trust-strip. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: verda-radial-results-map, verda-minimal-legal-ledger, verda-image-led-trust-strip, verda-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: verda-horizontal-care-journey, verda-radial-results-map, verda-stacked-proof-column, verda-accordion-guidance-panel. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: verda-full-bleed-botanical-divider, verda-magazine-article-grid, verda-floating-note-system, verda-quiet-route-index. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-19, public-footer-recipe-verda, public-footer-icons-sprig, public-footer-divider-organic-dots, public-footer-hover-soft-shift, public-footer-shell`; recipe `verda`.
...
- Decorative assets/background: The footer uses a strong botanical trust footer, local contact hierarchy and concept-specific footer marker `footer-19-verda`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C19-LABEL-001, C19-SITEMAP-001, C19-RENDER-001
- Files involved: `concepts/19-verda/partials/footer.html`, `concepts/19-verda/css/style.css`.
...
- Visual priority: mobile-first bottom form with a botanical frame, focus glow, privacy acknowledgement, honeypot, loading, success and error states.
...
- Primary colors: #A2AE9F, #798A80, #F3EFE5, #F8F4EA, #F8F7F2, #9A6B35, #FDE3B0, #3A3128, #706B63, #7C8E9B
- Accent/background variables: --sage: #A2AE9F, --deep-sage: #798A80, --ivory: #F3EFE5, --cream: #F8F4EA, --soft-white: #F8F7F2, --bronze: #9A6B35, --champagne: #FDE3B0, --ink: #3A3128, --muted: #706B63, --accent: #7C8E9B, --surface: #EEE8DC, --line: rgba(37,35,33,.14)
- Glow use: mobile-menu botanical field appears in the hero, section strip, mobile menu, form and footer.
...
- Hero/portrait use: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-verda.webp`.
- Service/botanical/icons: A custom local search direction tags SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/19-verda/assets/animations/motion-path.svg`
- `concepts/19-verda/assets/backgrounds/botanical-background.svg`
- `concepts/19-verda/assets/backgrounds/mobile-menu-background.svg`
- `concepts/19-verda/assets/botanical/botanical-quote.svg`
- `concepts/19-verda/assets/botanical/bronze-branch.svg`
- `concepts/19-verda/assets/botanical/footer-botanical-stamp.svg`
- `concepts/19-verda/assets/botanical/gold-leaf-divider.svg`
- `concepts/19-verda/assets/botanical/monogram-wreath.svg`
- `concepts/19-verda/assets/botanical/sage-botanical-corner.svg`
- `concepts/19-verda/assets/botanical/section-separator.svg`
- `concepts/19-verda/assets/brand/assinatura-1.jpg`
- `concepts/19-verda/assets/brand/footer-signature-watermark.png`
...
- Motion idea: journal card rise controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Verda | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Verda concept.`
- H1 pattern: 1 H1 parsed; `Soft precision for laser and skin`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/19-verda/sitemap.html` exists.
...
- What makes it different: It is identified by `local search direction tags`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-verdant`, menu `public-menu-layout-deep-botanical`, footer recipe `verda`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `journal card rise controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `20` and `27` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `verde botanical calm.` visual grammar.
...
## 21. Fixes Applied
- C19-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/19-verda/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C19-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/19-verda/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C19-RENDER-001
