# Concept 01 - Inspire Brief

## 1. Concept Snapshot
- Concept number: 01
- Concept folder path: `concepts/01-inspire`
- Files inspected: 40 files, including `concepts/01-inspire/index.html`, `concepts/01-inspire/css/style.css`, `concepts/01-inspire/partials/header.html`, `concepts/01-inspire/partials/mobile-menu.html`, `concepts/01-inspire/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/01-inspire-desktop.png`
- `audit/screenshots/mobile/01-inspire-mobile.png`
- `final/homepage-screenshots/desktop/concept-01-inspire-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-01-inspire-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: clean signature editorial translated into a Sofiati visual world, using pressed botanical editorial as the governing asset language.
- Visitor emotion: pressed botanical editorial.
...
- How it fits Sofiati: It is identified by `pressed botanical editorial`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: pressed botanical editorial.
...
## 4. Layout Signature
- Homepage structure: inspire-magazine-article-grid-hero-01, inspire-contact-card-overlap-pathway-02, inspire-minimal-legal-ledger-content-03, inspire-stacked-proof-column-content-04, inspire-floating-note-system-visual-story-05, inspire-portrait-and-process-band-content-06
- Section rhythm: # 01-inspire Page Flow Map Concept strategy: Inspire uses pressed botanical editorial as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are inspire-magazine-article-grid-hero-01, inspire-contact-card-overlap-pathway-02, inspire-minimal-legal-ledger-content-03, inspire-stacked-proof-column-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-split`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/01-inspire/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a quiet split masthead with centered brand. The header is assigned the unique runtime marker `header-01-inspire` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/01-inspire/partials/header.html`, `concepts/01-inspire/partials/navigation.html`, `concepts/01-inspire/partials/mobile-menu.html`, `concepts/01-inspire/css/style.css`, `concepts/01-inspire/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/01-inspire/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-editorial-full`.
...
- Visual personality: The mobile menu uses a chaptered signature drawer with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Advanced aesthetic biomedicine with precision and care`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-inspire.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: inspire-radial-results-map, inspire-minimal-legal-ledger, inspire-image-led-trust-strip, inspire-consultation-desk-still-life. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: inspire-radial-results-map, inspire-minimal-legal-ledger, inspire-image-led-trust-strip, inspire-consultation-desk-still-life. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: inspire-asymmetric-laser-panel, inspire-contact-card-overlap, inspire-portrait-and-process-band, inspire-large-type-statement. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: inspire-radial-results-map, inspire-minimal-legal-ledger, inspire-image-led-trust-strip, inspire-consultation-desk-still-life. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: inspire-contact-card-overlap, inspire-floating-note-system, inspire-quiet-route-index, inspire-laser-light-sequence. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: inspire-image-led-trust-strip, inspire-large-type-statement, inspire-split-portrait-hero, inspire-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: inspire-contact-card-overlap, inspire-floating-note-system, inspire-quiet-route-index, inspire-laser-light-sequence. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: inspire-full-bleed-botanical-divider, inspire-magazine-article-grid, inspire-floating-note-system, inspire-quiet-route-index. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: inspire-contact-card-overlap, inspire-floating-note-system, inspire-quiet-route-index, inspire-laser-light-sequence. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: inspire-asymmetric-laser-panel, inspire-contact-card-overlap, inspire-portrait-and-process-band, inspire-large-type-statement. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: inspire-radial-results-map, inspire-minimal-legal-ledger, inspire-image-led-trust-strip, inspire-consultation-desk-still-life. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-01, public-footer-recipe-inspire, public-footer-icons-dot, public-footer-divider-topline, public-footer-hover-underline, public-footer-shell`; recipe `inspire`.
...
- Decorative assets/background: The footer uses a business-card signature footer, local contact hierarchy and concept-specific footer marker `footer-01-inspire`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C01-LABEL-001, C01-SITEMAP-001, C01-RENDER-001, C01-RENDER-002
- Files involved: `concepts/01-inspire/partials/footer.html`, `concepts/01-inspire/css/style.css`.
...
- Hero/portrait use: arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-inspire.webp`.
- Service/botanical/icons: A custom pressed botanical editorial SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/01-inspire/assets/animations/motion-path.svg`
- `concepts/01-inspire/assets/backgrounds/botanical-background.svg`
- `concepts/01-inspire/assets/backgrounds/mobile-menu-background.svg`
- `concepts/01-inspire/assets/botanical/botanical-quote.svg`
- `concepts/01-inspire/assets/botanical/bronze-branch.svg`
- `concepts/01-inspire/assets/botanical/footer-botanical-stamp.svg`
- `concepts/01-inspire/assets/botanical/gold-leaf-divider.svg`
- `concepts/01-inspire/assets/botanical/monogram-wreath.svg`
- `concepts/01-inspire/assets/botanical/sage-botanical-corner.svg`
- `concepts/01-inspire/assets/botanical/section-separator.svg`
- `concepts/01-inspire/assets/brand/assinatura-1.jpg`
- `concepts/01-inspire/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Inspire | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Inspire concept.`
- H1 pattern: 1 H1 parsed; `Advanced aesthetic biomedicine with precision and care`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/01-inspire/sitemap.html` exists.
...
- What makes it different: It is identified by `pressed botanical editorial`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-split`, menu `public-menu-layout-editorial-full`, footer recipe `inspire`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `line reveal controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `02` and `09` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `pressed botanical editorial.` visual grammar.
...
### C01-RENDER-001
- Page/component: index.html / Desktop nav uses 3 rows
...
## 21. Fixes Applied
- C01-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/01-inspire/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C01-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/01-inspire/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C01-RENDER-001, C01-RENDER-002
