# Concept 45 - Silhouette Brief

## 1. Concept Snapshot
- Concept number: 45
- Concept folder path: `concepts/45-silhouette`
- Files inspected: 40 files, including `concepts/45-silhouette/index.html`, `concepts/45-silhouette/css/style.css`, `concepts/45-silhouette/partials/header.html`, `concepts/45-silhouette/partials/mobile-menu.html`, `concepts/45-silhouette/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/45-silhouette-desktop.png`
- `audit/screenshots/mobile/45-silhouette-mobile.png`
- `final/homepage-screenshots/desktop/concept-45-silhouette-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-45-silhouette-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: clinical skincare drops translated into a Sofiati visual world, using clinical drop capsules as the governing asset language.
- Visitor emotion: silhouette image-led minimalism.
...
- How it fits Sofiati: It is identified by `clinical drop capsules`, portrait treatment `full-height consultation portrait badge`, motion `gold shimmer`, form `step-style consultation form` and footer `botanical map footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: silhouette image-led minimalism.
...
## 4. Layout Signature
- Homepage structure: silhouette-floating-note-system-hero-01, silhouette-portrait-and-process-band-content-02, silhouette-image-led-trust-strip-visual-story-03, silhouette-accordion-guidance-panel-content-04, silhouette-quiet-route-index-pathway-05, silhouette-large-type-statement-content-06
- Section rhythm: # 45-silhouette Page Flow Map Concept strategy: Silhouette uses silhouette image-led minimalism as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are silhouette-floating-note-system-hero-01, silhouette-portrait-and-process-band-content-02, silhouette-image-led-trust-strip-visual-story-03, silhouette-accordion-guidance-panel-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-silhouette`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/45-silhouette/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a drop-commerce header. The header is assigned the unique runtime marker `header-45-silhouette` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/45-silhouette/partials/header.html`, `concepts/45-silhouette/partials/navigation.html`, `concepts/45-silhouette/partials/mobile-menu.html`, `concepts/45-silhouette/css/style.css`, `concepts/45-silhouette/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/45-silhouette/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-silhouette-overlay`.
...
- Visual personality: The mobile menu uses a regimen menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Clear protocols for natural-looking care`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is full-height consultation portrait badge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-silhouette.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: silhouette-stacked-proof-column, silhouette-image-led-trust-strip, silhouette-consultation-desk-still-life, silhouette-offset-consultation-ledger. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: silhouette-stacked-proof-column, silhouette-image-led-trust-strip, silhouette-consultation-desk-still-life, silhouette-offset-consultation-ledger. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: silhouette-minimal-legal-ledger, silhouette-portrait-and-process-band, silhouette-large-type-statement, silhouette-split-portrait-hero. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: silhouette-stacked-proof-column, silhouette-image-led-trust-strip, silhouette-consultation-desk-still-life, silhouette-offset-consultation-ledger. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: silhouette-portrait-and-process-band, silhouette-quiet-route-index, silhouette-laser-light-sequence, silhouette-horizontal-care-journey. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: silhouette-consultation-desk-still-life, silhouette-split-portrait-hero, silhouette-full-bleed-botanical-divider, silhouette-contact-card-overlap. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: silhouette-portrait-and-process-band, silhouette-quiet-route-index, silhouette-laser-light-sequence, silhouette-horizontal-care-journey. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: silhouette-contact-card-overlap, silhouette-floating-note-system, silhouette-quiet-route-index, silhouette-laser-light-sequence. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: silhouette-portrait-and-process-band, silhouette-quiet-route-index, silhouette-laser-light-sequence, silhouette-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: silhouette-minimal-legal-ledger, silhouette-portrait-and-process-band, silhouette-large-type-statement, silhouette-split-portrait-hero. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
...
## 9. Footer Signature
- Footer structure: classes `public-footer-45, public-footer-recipe-silhouette, public-footer-icons-silhouette, public-footer-divider-minimal, public-footer-hover-opacity-lift, public-footer-shell`; recipe `silhouette`.
...
- Decorative assets/background: The footer uses a clinical shop footer, local contact hierarchy and concept-specific footer marker `footer-45-silhouette`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C45-LABEL-001, C45-SITEMAP-001, C45-RENDER-001
- Files involved: `concepts/45-silhouette/partials/footer.html`, `concepts/45-silhouette/css/style.css`.
...
- Hero/portrait use: full-height consultation portrait badge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-silhouette.webp`.
- Service/botanical/icons: A custom clinical drop capsules SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/45-silhouette/assets/animations/motion-path.svg`
- `concepts/45-silhouette/assets/backgrounds/botanical-background.svg`
- `concepts/45-silhouette/assets/backgrounds/mobile-menu-background.svg`
- `concepts/45-silhouette/assets/botanical/botanical-quote.svg`
- `concepts/45-silhouette/assets/botanical/bronze-branch.svg`
- `concepts/45-silhouette/assets/botanical/footer-botanical-stamp.svg`
- `concepts/45-silhouette/assets/botanical/gold-leaf-divider.svg`
- `concepts/45-silhouette/assets/botanical/monogram-wreath.svg`
- `concepts/45-silhouette/assets/botanical/sage-botanical-corner.svg`
- `concepts/45-silhouette/assets/botanical/section-separator.svg`
- `concepts/45-silhouette/assets/brand/assinatura-1.jpg`
- `concepts/45-silhouette/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Silhouette | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Silhouette concept.`
- H1 pattern: 1 H1 parsed; `Clear protocols for natural-looking care`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/45-silhouette/sitemap.html` exists.
...
- What makes it different: It is identified by `clinical drop capsules`, portrait treatment `full-height consultation portrait badge`, motion `gold shimmer`, form `step-style consultation form` and footer `botanical map footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-silhouette`, menu `public-menu-layout-silhouette-overlay`, footer recipe `silhouette`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `gold shimmer controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `46` and `03` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `silhouette image-led minimalism.` visual grammar.
...
## 21. Fixes Applied
- C45-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/45-silhouette/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C45-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/45-silhouette/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C45-RENDER-001
