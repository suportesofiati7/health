# Concept 41 - Vista Brief

## 1. Concept Snapshot
- Concept number: 41
- Concept folder path: `concepts/41-vista`
- Files inspected: 40 files, including `concepts/41-vista/index.html`, `concepts/41-vista/css/style.css`, `concepts/41-vista/partials/header.html`, `concepts/41-vista/partials/mobile-menu.html`, `concepts/41-vista/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/41-vista-desktop.png`
- `audit/screenshots/mobile/41-vista-mobile.png`
- `final/homepage-screenshots/desktop/concept-41-vista-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-41-vista-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: ritual beauty storytelling translated into a Sofiati visual world, using ritual story seals as the governing asset language.
- Visitor emotion: vista navigation panorama.
...
- How it fits Sofiati: It is identified by `ritual story seals`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: vista navigation panorama.
...
## 4. Layout Signature
- Homepage structure: vista-magazine-article-grid-hero-01, vista-contact-card-overlap-pathway-02, vista-minimal-legal-ledger-content-03, vista-stacked-proof-column-content-04, vista-floating-note-system-visual-story-05, vista-portrait-and-process-band-content-06
- Section rhythm: # 41-vista Page Flow Map Concept strategy: Vista uses vista navigation panorama as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are vista-magazine-article-grid-hero-01, vista-contact-card-overlap-pathway-02, vista-minimal-legal-ledger-content-03, vista-stacked-proof-column-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-vista`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/41-vista/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a ritual header. The header is assigned the unique runtime marker `header-41-vista` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/41-vista/partials/header.html`, `concepts/41-vista/partials/navigation.html`, `concepts/41-vista/partials/mobile-menu.html`, `concepts/41-vista/css/style.css`, `concepts/41-vista/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/41-vista/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-wide-panel`.
...
- Visual personality: The mobile menu uses a ritual drawer menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Precision care, never pressure`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-vista.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: vista-radial-results-map, vista-minimal-legal-ledger, vista-image-led-trust-strip, vista-consultation-desk-still-life. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: vista-radial-results-map, vista-minimal-legal-ledger, vista-image-led-trust-strip, vista-consultation-desk-still-life. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: vista-asymmetric-laser-panel, vista-contact-card-overlap, vista-portrait-and-process-band, vista-large-type-statement. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: vista-radial-results-map, vista-minimal-legal-ledger, vista-image-led-trust-strip, vista-consultation-desk-still-life. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: vista-contact-card-overlap, vista-floating-note-system, vista-quiet-route-index, vista-laser-light-sequence. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: vista-image-led-trust-strip, vista-large-type-statement, vista-split-portrait-hero, vista-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: vista-contact-card-overlap, vista-floating-note-system, vista-quiet-route-index, vista-laser-light-sequence. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: vista-full-bleed-botanical-divider, vista-magazine-article-grid, vista-floating-note-system, vista-quiet-route-index. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: vista-contact-card-overlap, vista-floating-note-system, vista-quiet-route-index, vista-laser-light-sequence. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: vista-asymmetric-laser-panel, vista-contact-card-overlap, vista-portrait-and-process-band, vista-large-type-statement. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
...
## 9. Footer Signature
- Footer structure: classes `public-footer-41, public-footer-recipe-vista, public-footer-icons-horizon, public-footer-divider-wide-rule, public-footer-hover-left-indent, public-footer-shell`; recipe `vista`.
...
- Decorative assets/background: The footer uses a story footer, local contact hierarchy and concept-specific footer marker `footer-41-vista`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C41-LABEL-001, C41-SITEMAP-001, C41-RENDER-001
- Files involved: `concepts/41-vista/partials/footer.html`, `concepts/41-vista/css/style.css`.
...
- Hero/portrait use: arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-vista.webp`.
- Service/botanical/icons: A custom ritual story seals SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/41-vista/assets/animations/motion-path.svg`
- `concepts/41-vista/assets/backgrounds/botanical-background.svg`
- `concepts/41-vista/assets/backgrounds/mobile-menu-background.svg`
- `concepts/41-vista/assets/botanical/botanical-quote.svg`
- `concepts/41-vista/assets/botanical/bronze-branch.svg`
- `concepts/41-vista/assets/botanical/footer-botanical-stamp.svg`
- `concepts/41-vista/assets/botanical/gold-leaf-divider.svg`
- `concepts/41-vista/assets/botanical/monogram-wreath.svg`
- `concepts/41-vista/assets/botanical/sage-botanical-corner.svg`
- `concepts/41-vista/assets/botanical/section-separator.svg`
- `concepts/41-vista/assets/brand/assinatura-1.jpg`
- `concepts/41-vista/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Vista | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Vista concept.`
- H1 pattern: 1 H1 parsed; `Precision care, never pressure`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/41-vista/sitemap.html` exists.
...
- What makes it different: It is identified by `ritual story seals`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-vista`, menu `public-menu-layout-wide-panel`, footer recipe `vista`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `line reveal controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `42` and `49` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `vista navigation panorama.` visual grammar.
...
## 21. Fixes Applied
- C41-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/41-vista/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C41-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/41-vista/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C41-RENDER-001
