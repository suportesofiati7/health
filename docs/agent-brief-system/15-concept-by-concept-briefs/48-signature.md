# Concept 48 - Signature Brief

## 1. Concept Snapshot
- Concept number: 48
- Concept folder path: `concepts/48-signature`
- Files inspected: 40 files, including `concepts/48-signature/index.html`, `concepts/48-signature/css/style.css`, `concepts/48-signature/partials/header.html`, `concepts/48-signature/partials/mobile-menu.html`, `concepts/48-signature/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/48-signature-desktop.png`
- `audit/screenshots/mobile/48-signature-mobile.png`
- `final/homepage-screenshots/desktop/concept-48-signature-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-48-signature-home-mobile.png`
- Status: strong
- Confidence level: high

## 2. Concept Purpose
- Intended impression: botanical serum story translated into a Sofiati visual world, using botanical serum line growth as the governing asset language.
- Visitor emotion: signature brand dossier.
...
- How it fits Sofiati: It is identified by `botanical serum line growth`, portrait treatment `champagne line portrait seal`, motion `form focus glow`, form `business-card form` and footer `bronze strip footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: signature brand dossier.
...
## 4. Layout Signature
- Homepage structure: signature-accordion-guidance-panel-hero-01, signature-quiet-route-index-content-02, signature-large-type-statement-content-03, signature-consultation-desk-still-life-visual-story-04, signature-skin-texture-editorial-pathway-05, signature-laser-light-sequence-content-06
- Section rhythm: # 48-signature Page Flow Map Concept strategy: Signature uses signature brand dossier as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are signature-accordion-guidance-panel-hero-01, signature-quiet-route-index-content-02, signature-large-type-statement-content-03, signature-consultation-desk-still-life-visual-story-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-signature`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/48-signature/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a botanical story header. The header is assigned the unique runtime marker `header-48-signature` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/48-signature/partials/header.html`, `concepts/48-signature/partials/navigation.html`, `concepts/48-signature/partials/mobile-menu.html`, `concepts/48-signature/css/style.css`, `concepts/48-signature/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/48-signature/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-signature-full`.
...
- Visual personality: The mobile menu uses a serum story menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Signature care for laser and skin`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is champagne line portrait seal, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-signature.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: signature-image-led-trust-strip, signature-large-type-statement, signature-split-portrait-hero, signature-full-bleed-botanical-divider. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: signature-image-led-trust-strip, signature-large-type-statement, signature-split-portrait-hero, signature-full-bleed-botanical-divider. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: signature-portrait-and-process-band, signature-quiet-route-index, signature-laser-light-sequence, signature-horizontal-care-journey. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: signature-image-led-trust-strip, signature-large-type-statement, signature-split-portrait-hero, signature-full-bleed-botanical-divider. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: signature-quiet-route-index, signature-skin-texture-editorial, signature-editorial-image-chapter, signature-radial-results-map. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: signature-split-portrait-hero, signature-horizontal-care-journey, signature-magazine-article-grid, signature-floating-note-system. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: signature-quiet-route-index, signature-skin-texture-editorial, signature-editorial-image-chapter, signature-radial-results-map. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: signature-floating-note-system, signature-accordion-guidance-panel, signature-skin-texture-editorial, signature-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: signature-quiet-route-index, signature-skin-texture-editorial, signature-editorial-image-chapter, signature-radial-results-map. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: signature-portrait-and-process-band, signature-quiet-route-index, signature-laser-light-sequence, signature-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: signature-image-led-trust-strip, signature-large-type-statement, signature-split-portrait-hero, signature-full-bleed-botanical-divider. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-48, public-footer-recipe-signature, public-footer-icons-signature, public-footer-divider-editorial-rule, public-footer-hover-underline, public-footer-shell`; recipe `signature`.
...
- Decorative assets/background: The footer uses a botanical footer, local contact hierarchy and concept-specific footer marker `footer-48-signature`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C48-LABEL-001, C48-SITEMAP-001
- Files involved: `concepts/48-signature/partials/footer.html`, `concepts/48-signature/css/style.css`.
...
- Hero/portrait use: champagne line portrait seal, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-signature.webp`.
- Service/botanical/icons: A custom botanical serum line growth SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/48-signature/assets/animations/motion-path.svg`
- `concepts/48-signature/assets/backgrounds/botanical-background.svg`
- `concepts/48-signature/assets/backgrounds/mobile-menu-background.svg`
- `concepts/48-signature/assets/botanical/botanical-quote.svg`
- `concepts/48-signature/assets/botanical/bronze-branch.svg`
- `concepts/48-signature/assets/botanical/footer-botanical-stamp.svg`
- `concepts/48-signature/assets/botanical/gold-leaf-divider.svg`
- `concepts/48-signature/assets/botanical/monogram-wreath.svg`
- `concepts/48-signature/assets/botanical/sage-botanical-corner.svg`
- `concepts/48-signature/assets/botanical/section-separator.svg`
- `concepts/48-signature/assets/brand/assinatura-1.jpg`
- `concepts/48-signature/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Signature | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Signature concept.`
- H1 pattern: 1 H1 parsed; `Signature care for laser and skin`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/48-signature/sitemap.html` exists.
...
- What makes it different: It is identified by `botanical serum line growth`, portrait treatment `champagne line portrait seal`, motion `form focus glow`, form `business-card form` and footer `bronze strip footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-signature`, menu `public-menu-layout-signature-full`, footer recipe `signature`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `form focus glow controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `49` and `06` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `signature brand dossier.` visual grammar.
...
## 21. Fixes Applied
- C48-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/48-signature/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C48-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/48-signature/sitemap.html`. Verification: Run rg for Brand and education..
