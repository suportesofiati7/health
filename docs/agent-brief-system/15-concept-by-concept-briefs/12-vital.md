# Concept 12 - Vital Brief

## 1. Concept Snapshot
- Concept number: 12
- Concept folder path: `concepts/12-vital`
- Files inspected: 40 files, including `concepts/12-vital/index.html`, `concepts/12-vital/css/style.css`, `concepts/12-vital/partials/header.html`, `concepts/12-vital/partials/mobile-menu.html`, `concepts/12-vital/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/12-vital-desktop.png`
- `audit/screenshots/mobile/12-vital-mobile.png`
- `final/homepage-screenshots/desktop/concept-12-vital-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-12-vital-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: dynamic care journey portal translated into a Sofiati visual world, using dermatology portal pictograms as the governing asset language.
- Visitor emotion: vital clinical rhythm.
...
- How it fits Sofiati: It is identified by `dermatology portal pictograms`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: vital clinical rhythm.
...
## 4. Layout Signature
- Homepage structure: vital-skin-texture-editorial-hero-01, vital-editorial-image-chapter-contextual-journey, vital-split-portrait-hero-consultation-form-03, vital-offset-consultation-ledger-pathway-04, vital-editorial-image-chapter-content-05, vital-horizontal-care-journey-content-06
- Section rhythm: # 12-vital Page Flow Map Concept strategy: Vital uses vital clinical rhythm as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are vital-skin-texture-editorial-hero-01, vital-editorial-image-chapter-contextual-journey, vital-split-portrait-hero-consultation-form-03, vital-offset-consultation-ledger-pathway-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-dynamic`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/12-vital/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a journey portal navigation. The header is assigned the unique runtime marker `header-12-vital` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/12-vital/partials/header.html`, `concepts/12-vital/partials/navigation.html`, `concepts/12-vital/partials/mobile-menu.html`, `concepts/12-vital/css/style.css`, `concepts/12-vital/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/12-vital/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-energetic-drawer`.
...
- Visual personality: The mobile menu uses a dynamic category drawer with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Warm, precise and individualised care`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-vital.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: vital-consultation-desk-still-life, vital-split-portrait-hero, vital-full-bleed-botanical-divider, vital-contact-card-overlap. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: vital-consultation-desk-still-life, vital-split-portrait-hero, vital-full-bleed-botanical-divider, vital-contact-card-overlap. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: vital-large-type-statement, vital-laser-light-sequence, vital-horizontal-care-journey, vital-magazine-article-grid. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: vital-consultation-desk-still-life, vital-split-portrait-hero, vital-full-bleed-botanical-divider, vital-contact-card-overlap. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: vital-laser-light-sequence, vital-editorial-image-chapter, vital-radial-results-map, vital-stacked-proof-column. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: vital-full-bleed-botanical-divider, vital-magazine-article-grid, vital-floating-note-system, vital-quiet-route-index. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: vital-laser-light-sequence, vital-editorial-image-chapter, vital-radial-results-map, vital-stacked-proof-column. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: vital-quiet-route-index, vital-skin-texture-editorial, vital-editorial-image-chapter, vital-radial-results-map. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: vital-laser-light-sequence, vital-editorial-image-chapter, vital-radial-results-map, vital-stacked-proof-column. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: vital-large-type-statement, vital-laser-light-sequence, vital-horizontal-care-journey, vital-magazine-article-grid. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: vital-consultation-desk-still-life, vital-split-portrait-hero, vital-full-bleed-botanical-divider, vital-contact-card-overlap. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-12, public-footer-recipe-vital, public-footer-icons-arrow, public-footer-divider-motion-line, public-footer-hover-left-indent, public-footer-shell`; recipe `vital`.
...
- Decorative assets/background: The footer uses a journey directory footer, local contact hierarchy and concept-specific footer marker `footer-12-vital`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C12-LABEL-001, C12-SITEMAP-001, C12-RENDER-001
- Files involved: `concepts/12-vital/partials/footer.html`, `concepts/12-vital/css/style.css`.
...
- Hero/portrait use: round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-vital.webp`.
- Service/botanical/icons: A custom dermatology portal pictograms SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/12-vital/assets/animations/motion-path.svg`
- `concepts/12-vital/assets/backgrounds/botanical-background.svg`
- `concepts/12-vital/assets/backgrounds/mobile-menu-background.svg`
- `concepts/12-vital/assets/botanical/botanical-quote.svg`
- `concepts/12-vital/assets/botanical/bronze-branch.svg`
- `concepts/12-vital/assets/botanical/footer-botanical-stamp.svg`
- `concepts/12-vital/assets/botanical/gold-leaf-divider.svg`
- `concepts/12-vital/assets/botanical/monogram-wreath.svg`
- `concepts/12-vital/assets/botanical/sage-botanical-corner.svg`
- `concepts/12-vital/assets/botanical/section-separator.svg`
- `concepts/12-vital/assets/brand/assinatura-1.jpg`
- `concepts/12-vital/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Vital | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Vital concept.`
- H1 pattern: 1 H1 parsed; `Warm, precise and individualised care`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/12-vital/sitemap.html` exists.
...
- What makes it different: It is identified by `dermatology portal pictograms`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-dynamic`, menu `public-menu-layout-energetic-drawer`, footer recipe `vital`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `leaf orbit controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `13` and `20` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `vital clinical rhythm.` visual grammar.
...
## 21. Fixes Applied
- C12-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/12-vital/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C12-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/12-vital/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C12-RENDER-001
