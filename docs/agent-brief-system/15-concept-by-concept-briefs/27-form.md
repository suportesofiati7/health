# Concept 27 - Form Brief

## 1. Concept Snapshot
- Concept number: 27
- Concept folder path: `concepts/27-form`
- Files inspected: 40 files, including `concepts/27-form/index.html`, `concepts/27-form/css/style.css`, `concepts/27-form/partials/header.html`, `concepts/27-form/partials/mobile-menu.html`, `concepts/27-form/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/27-form-desktop.png`
- `audit/screenshots/mobile/27-form-mobile.png`
- `final/homepage-screenshots/desktop/concept-27-form-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-27-form-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: procedure library translated into a Sofiati visual world, using procedure library tabs as the governing asset language.
- Visitor emotion: form and structure study.
...
- How it fits Sofiati: It is identified by `procedure library tabs`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: form and structure study.
...
## 4. Layout Signature
- Homepage structure: form-image-led-trust-strip-hero-01, form-accordion-guidance-panel-content-02, form-quiet-route-index-visual-story-03, form-consultation-desk-still-life-contextual-journey, form-consultation-desk-still-life-consultation-form-05, form-skin-texture-editorial-pathway-06
- Section rhythm: # 27-form Page Flow Map Concept strategy: Form uses form and structure study as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are form-image-led-trust-strip-hero-01, form-accordion-guidance-panel-content-02, form-quiet-route-index-visual-story-03, form-consultation-desk-still-life-contextual-journey
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-form`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/27-form/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a library header. The header is assigned the unique runtime marker `header-27-form` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/27-form/partials/header.html`, `concepts/27-form/partials/navigation.html`, `concepts/27-form/partials/mobile-menu.html`, `concepts/27-form/css/style.css`, `concepts/27-form/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/27-form/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-shape-panels`.
...
- Visual personality: The mobile menu uses a mega library menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Care that protects natural expression`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-form.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: form-portrait-and-process-band, form-quiet-route-index, form-laser-light-sequence, form-horizontal-care-journey. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: form-portrait-and-process-band, form-quiet-route-index, form-laser-light-sequence, form-horizontal-care-journey. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: form-floating-note-system, form-accordion-guidance-panel, form-skin-texture-editorial, form-editorial-image-chapter. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: form-portrait-and-process-band, form-quiet-route-index, form-laser-light-sequence, form-horizontal-care-journey. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: form-accordion-guidance-panel, form-consultation-desk-still-life, form-offset-consultation-ledger, form-asymmetric-laser-panel. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: form-laser-light-sequence, form-editorial-image-chapter, form-radial-results-map, form-stacked-proof-column. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: form-accordion-guidance-panel, form-consultation-desk-still-life, form-offset-consultation-ledger, form-asymmetric-laser-panel. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: form-stacked-proof-column, form-image-led-trust-strip, form-consultation-desk-still-life, form-offset-consultation-ledger. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: form-accordion-guidance-panel, form-consultation-desk-still-life, form-offset-consultation-ledger, form-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: form-floating-note-system, form-accordion-guidance-panel, form-skin-texture-editorial, form-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: form-portrait-and-process-band, form-quiet-route-index, form-laser-light-sequence, form-horizontal-care-journey. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-27, public-footer-recipe-form, public-footer-icons-angle, public-footer-divider-diagonal, public-footer-hover-underline, public-footer-shell`; recipe `form`.
...
- Decorative assets/background: The footer uses a procedure footer, local contact hierarchy and concept-specific footer marker `footer-27-form`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C27-LABEL-001, C27-SITEMAP-001, C27-RENDER-001
- Files involved: `concepts/27-form/partials/footer.html`, `concepts/27-form/css/style.css`.
...
- Hero/portrait use: clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-form.webp`.
- Service/botanical/icons: A custom procedure library tabs SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/27-form/assets/animations/motion-path.svg`
- `concepts/27-form/assets/backgrounds/botanical-background.svg`
- `concepts/27-form/assets/backgrounds/mobile-menu-background.svg`
- `concepts/27-form/assets/botanical/botanical-quote.svg`
- `concepts/27-form/assets/botanical/bronze-branch.svg`
- `concepts/27-form/assets/botanical/footer-botanical-stamp.svg`
- `concepts/27-form/assets/botanical/gold-leaf-divider.svg`
- `concepts/27-form/assets/botanical/monogram-wreath.svg`
- `concepts/27-form/assets/botanical/sage-botanical-corner.svg`
- `concepts/27-form/assets/botanical/section-separator.svg`
- `concepts/27-form/assets/brand/assinatura-1.jpg`
- `concepts/27-form/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Form | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Form concept.`
- H1 pattern: 1 H1 parsed; `Care that protects natural expression`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/27-form/sitemap.html` exists.
...
- What makes it different: It is identified by `procedure library tabs`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-form`, menu `public-menu-layout-shape-panels`, footer recipe `form`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `divider trace controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `28` and `35` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `form and structure study.` visual grammar.
...
### C27-LOGO-001
- Page/component: homepage/header/footer / Header logo
...
## 21. Fixes Applied
- C27-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/27-form/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C27-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/27-form/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C27-LOGO-001, C27-RENDER-001
