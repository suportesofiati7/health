# Concept 30 - Method Brief

## 1. Concept Snapshot
- Concept number: 30
- Concept folder path: `concepts/30-method`
- Files inspected: 40 files, including `concepts/30-method/index.html`, `concepts/30-method/css/style.css`, `concepts/30-method/partials/header.html`, `concepts/30-method/partials/mobile-menu.html`, `concepts/30-method/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/30-method-desktop.png`
- `audit/screenshots/mobile/30-method-mobile.png`
- `final/homepage-screenshots/desktop/concept-30-method-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-30-method-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: appointment concierge translated into a Sofiati visual world, using booking concierge steps as the governing asset language.
- Visitor emotion: methodical evaluation manual.
...
- How it fits Sofiati: It is identified by `booking concierge steps`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: methodical evaluation manual.
...
## 4. Layout Signature
- Homepage structure: method-large-type-statement-hero-01, method-consultation-desk-still-life-visual-story-02, method-skin-texture-editorial-pathway-03, method-laser-light-sequence-content-04, method-split-portrait-hero-content-05, method-offset-consultation-ledger-content-06
- Section rhythm: # 30-method Page Flow Map Concept strategy: Method uses methodical evaluation manual as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are method-large-type-statement-hero-01, method-consultation-desk-still-life-visual-story-02, method-skin-texture-editorial-pathway-03, method-laser-light-sequence-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-method`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/30-method/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a concierge booking header. The header is assigned the unique runtime marker `header-30-method` and a concept-specific CSS composition.
- Risks: C30-NAV-001
- Files involved: `concepts/30-method/partials/header.html`, `concepts/30-method/partials/navigation.html`, `concepts/30-method/partials/mobile-menu.html`, `concepts/30-method/css/style.css`, `concepts/30-method/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/30-method/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-process-step`.
...
- Visual personality: The mobile menu uses a booking sheet menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Clarity, safety and skin quality`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-method.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: method-quiet-route-index, method-skin-texture-editorial, method-editorial-image-chapter, method-radial-results-map. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: method-quiet-route-index, method-skin-texture-editorial, method-editorial-image-chapter, method-radial-results-map. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: method-accordion-guidance-panel, method-consultation-desk-still-life, method-offset-consultation-ledger, method-asymmetric-laser-panel. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: method-quiet-route-index, method-skin-texture-editorial, method-editorial-image-chapter, method-radial-results-map. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: method-consultation-desk-still-life, method-split-portrait-hero, method-full-bleed-botanical-divider, method-contact-card-overlap. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: method-editorial-image-chapter, method-asymmetric-laser-panel, method-minimal-legal-ledger, method-image-led-trust-strip. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: method-consultation-desk-still-life, method-split-portrait-hero, method-full-bleed-botanical-divider, method-contact-card-overlap. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: method-image-led-trust-strip, method-large-type-statement, method-split-portrait-hero, method-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: method-consultation-desk-still-life, method-split-portrait-hero, method-full-bleed-botanical-divider, method-contact-card-overlap. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: method-accordion-guidance-panel, method-consultation-desk-still-life, method-offset-consultation-ledger, method-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: method-quiet-route-index, method-skin-texture-editorial, method-editorial-image-chapter, method-radial-results-map. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-30, public-footer-recipe-method, public-footer-icons-step, public-footer-divider-vertical-rules, public-footer-hover-left-indent, public-footer-shell`; recipe `method`.
...
- Decorative assets/background: The footer uses a Sloane-style footer, local contact hierarchy and concept-specific footer marker `footer-30-method`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C30-LABEL-001, C30-SITEMAP-001, C30-RENDER-001, C30-RENDER-002
- Files involved: `concepts/30-method/partials/footer.html`, `concepts/30-method/css/style.css`.
...
- Hero/portrait use: journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-method.webp`.
- Service/botanical/icons: A custom booking concierge steps SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/30-method/assets/animations/motion-path.svg`
- `concepts/30-method/assets/backgrounds/botanical-background.svg`
- `concepts/30-method/assets/backgrounds/mobile-menu-background.svg`
- `concepts/30-method/assets/botanical/botanical-quote.svg`
- `concepts/30-method/assets/botanical/bronze-branch.svg`
- `concepts/30-method/assets/botanical/footer-botanical-stamp.svg`
- `concepts/30-method/assets/botanical/gold-leaf-divider.svg`
- `concepts/30-method/assets/botanical/monogram-wreath.svg`
- `concepts/30-method/assets/botanical/sage-botanical-corner.svg`
- `concepts/30-method/assets/botanical/section-separator.svg`
- `concepts/30-method/assets/brand/assinatura-1.jpg`
- `concepts/30-method/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Method | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Method concept.`
- H1 pattern: 1 H1 parsed; `Clarity, safety and skin quality`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/30-method/sitemap.html` exists.
...
- What makes it different: It is identified by `booking concierge steps`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-method`, menu `public-menu-layout-process-step`, footer recipe `method`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `service badge pulse controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `31` and `38` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `methodical evaluation manual.` visual grammar.
...
## 21. Fixes Applied
- C30-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/30-method/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C30-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/30-method/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C30-NAV-001, C30-RENDER-001, C30-RENDER-002
