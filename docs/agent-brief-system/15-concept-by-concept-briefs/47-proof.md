# Concept 47 - Proof Brief

## 1. Concept Snapshot
- Concept number: 47
- Concept folder path: `concepts/47-proof`
- Files inspected: 40 files, including `concepts/47-proof/index.html`, `concepts/47-proof/css/style.css`, `concepts/47-proof/partials/header.html`, `concepts/47-proof/partials/mobile-menu.html`, `concepts/47-proof/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/47-proof-desktop.png`
- `audit/screenshots/mobile/47-proof-mobile.png`
- `final/homepage-screenshots/desktop/concept-47-proof-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-47-proof-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: expert routine blog translated into a Sofiati visual world, using expert routine sequence as the governing asset language.
- Visitor emotion: proof-focused responsibility system.
...
- How it fits Sofiati: It is identified by `expert routine sequence`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: proof-focused responsibility system.
...
## 4. Layout Signature
- Homepage structure: proof-image-led-trust-strip-hero-01, proof-accordion-guidance-panel-content-02, proof-quiet-route-index-visual-story-03, proof-consultation-desk-still-life-contextual-journey, proof-consultation-desk-still-life-consultation-form-05, proof-skin-texture-editorial-pathway-06
- Section rhythm: # 47-proof Page Flow Map Concept strategy: Proof uses proof-focused responsibility system as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are proof-image-led-trust-strip-hero-01, proof-accordion-guidance-panel-content-02, proof-quiet-route-index-visual-story-03, proof-consultation-desk-still-life-contextual-journey
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-proof`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/47-proof/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a expert routine header. The header is assigned the unique runtime marker `header-47-proof` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/47-proof/partials/header.html`, `concepts/47-proof/partials/navigation.html`, `concepts/47-proof/partials/mobile-menu.html`, `concepts/47-proof/css/style.css`, `concepts/47-proof/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/47-proof/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-structured-proof`.
...
- Visual personality: The mobile menu uses a routine menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Skin education with a premium calm`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-proof.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: proof-portrait-and-process-band, proof-quiet-route-index, proof-laser-light-sequence, proof-horizontal-care-journey. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: proof-portrait-and-process-band, proof-quiet-route-index, proof-laser-light-sequence, proof-horizontal-care-journey. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: proof-floating-note-system, proof-accordion-guidance-panel, proof-skin-texture-editorial, proof-editorial-image-chapter. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: proof-portrait-and-process-band, proof-quiet-route-index, proof-laser-light-sequence, proof-horizontal-care-journey. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: proof-accordion-guidance-panel, proof-consultation-desk-still-life, proof-offset-consultation-ledger, proof-asymmetric-laser-panel. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: proof-laser-light-sequence, proof-editorial-image-chapter, proof-radial-results-map, proof-stacked-proof-column. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: proof-accordion-guidance-panel, proof-consultation-desk-still-life, proof-offset-consultation-ledger, proof-asymmetric-laser-panel. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: proof-stacked-proof-column, proof-image-led-trust-strip, proof-consultation-desk-still-life, proof-offset-consultation-ledger. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: proof-accordion-guidance-panel, proof-consultation-desk-still-life, proof-offset-consultation-ledger, proof-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: proof-floating-note-system, proof-accordion-guidance-panel, proof-skin-texture-editorial, proof-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: proof-portrait-and-process-band, proof-quiet-route-index, proof-laser-light-sequence, proof-horizontal-care-journey. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-47, public-footer-recipe-proof, public-footer-icons-check, public-footer-divider-vertical-rules, public-footer-hover-left-indent, public-footer-shell`; recipe `proof`.
...
- Decorative assets/background: The footer uses a expert footer, local contact hierarchy and concept-specific footer marker `footer-47-proof`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C47-LABEL-001, C47-SITEMAP-001, C47-RENDER-001
- Files involved: `concepts/47-proof/partials/footer.html`, `concepts/47-proof/css/style.css`.
...
- Hero/portrait use: clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-proof.webp`.
- Service/botanical/icons: A custom expert routine sequence SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/47-proof/assets/animations/motion-path.svg`
- `concepts/47-proof/assets/backgrounds/botanical-background.svg`
- `concepts/47-proof/assets/backgrounds/mobile-menu-background.svg`
- `concepts/47-proof/assets/botanical/botanical-quote.svg`
- `concepts/47-proof/assets/botanical/bronze-branch.svg`
- `concepts/47-proof/assets/botanical/footer-botanical-stamp.svg`
- `concepts/47-proof/assets/botanical/gold-leaf-divider.svg`
- `concepts/47-proof/assets/botanical/monogram-wreath.svg`
- `concepts/47-proof/assets/botanical/sage-botanical-corner.svg`
- `concepts/47-proof/assets/botanical/section-separator.svg`
- `concepts/47-proof/assets/brand/assinatura-1.jpg`
- `concepts/47-proof/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Proof | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Proof concept.`
- H1 pattern: 1 H1 parsed; `Skin education with a premium calm`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/47-proof/sitemap.html` exists.
...
- What makes it different: It is identified by `expert routine sequence`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-proof`, menu `public-menu-layout-structured-proof`, footer recipe `proof`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `divider trace controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `48` and `05` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `proof-focused responsibility system.` visual grammar.
...
## 21. Fixes Applied
- C47-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/47-proof/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C47-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/47-proof/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C47-RENDER-001
