# Concept 21 - Calm Brief

## 1. Concept Snapshot
- Concept number: 21
- Concept folder path: `concepts/21-calm`
- Files inspected: 40 files, including `concepts/21-calm/index.html`, `concepts/21-calm/css/style.css`, `concepts/21-calm/partials/header.html`, `concepts/21-calm/partials/mobile-menu.html`, `concepts/21-calm/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/21-calm-desktop.png`
- `audit/screenshots/mobile/21-calm-mobile.png`
- `final/homepage-screenshots/desktop/concept-21-calm-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-21-calm-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: international private clinic translated into a Sofiati visual world, using concierge clinic panels as the governing asset language.
- Visitor emotion: calm consultation suite.
...
- How it fits Sofiati: It is identified by `concierge clinic panels`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: calm consultation suite.
...
## 4. Layout Signature
- Homepage structure: calm-magazine-article-grid-hero-01, calm-contact-card-overlap-pathway-02, calm-minimal-legal-ledger-content-03, calm-stacked-proof-column-content-04, calm-floating-note-system-visual-story-05, calm-portrait-and-process-band-content-06
- Section rhythm: # 21-calm Page Flow Map Concept strategy: Calm uses calm consultation suite as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are calm-magazine-article-grid-hero-01, calm-contact-card-overlap-pathway-02, calm-minimal-legal-ledger-content-03, calm-stacked-proof-column-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-calm`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/21-calm/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a concierge header. The header is assigned the unique runtime marker `header-21-calm` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/21-calm/partials/header.html`, `concepts/21-calm/partials/navigation.html`, `concepts/21-calm/partials/mobile-menu.html`, `concepts/21-calm/css/style.css`, `concepts/21-calm/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/21-calm/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-calm-cream`.
...
- Visual personality: The mobile menu uses a private clinic menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Botanical calm, clinical precision`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-calm.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: calm-radial-results-map, calm-minimal-legal-ledger, calm-image-led-trust-strip, calm-consultation-desk-still-life. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: calm-radial-results-map, calm-minimal-legal-ledger, calm-image-led-trust-strip, calm-consultation-desk-still-life. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: calm-asymmetric-laser-panel, calm-contact-card-overlap, calm-portrait-and-process-band, calm-large-type-statement. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: calm-radial-results-map, calm-minimal-legal-ledger, calm-image-led-trust-strip, calm-consultation-desk-still-life. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: calm-contact-card-overlap, calm-floating-note-system, calm-quiet-route-index, calm-laser-light-sequence. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: calm-image-led-trust-strip, calm-large-type-statement, calm-split-portrait-hero, calm-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: calm-contact-card-overlap, calm-floating-note-system, calm-quiet-route-index, calm-laser-light-sequence. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: calm-full-bleed-botanical-divider, calm-magazine-article-grid, calm-floating-note-system, calm-quiet-route-index. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: calm-contact-card-overlap, calm-floating-note-system, calm-quiet-route-index, calm-laser-light-sequence. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: calm-asymmetric-laser-panel, calm-contact-card-overlap, calm-portrait-and-process-band, calm-large-type-statement. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: calm-radial-results-map, calm-minimal-legal-ledger, calm-image-led-trust-strip, calm-consultation-desk-still-life. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-21, public-footer-recipe-calm, public-footer-icons-dash, public-footer-divider-minimal, public-footer-hover-opacity-lift, public-footer-shell`; recipe `calm`.
...
- Decorative assets/background: The footer uses a concierge footer, local contact hierarchy and concept-specific footer marker `footer-21-calm`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C21-LABEL-001, C21-SITEMAP-001, C21-RENDER-001
- Files involved: `concepts/21-calm/partials/footer.html`, `concepts/21-calm/css/style.css`.
...
- Hero/portrait use: arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-calm.webp`.
- Service/botanical/icons: A custom concierge clinic panels SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/21-calm/assets/animations/motion-path.svg`
- `concepts/21-calm/assets/backgrounds/botanical-background.svg`
- `concepts/21-calm/assets/backgrounds/mobile-menu-background.svg`
- `concepts/21-calm/assets/botanical/botanical-quote.svg`
- `concepts/21-calm/assets/botanical/bronze-branch.svg`
- `concepts/21-calm/assets/botanical/footer-botanical-stamp.svg`
- `concepts/21-calm/assets/botanical/gold-leaf-divider.svg`
- `concepts/21-calm/assets/botanical/monogram-wreath.svg`
- `concepts/21-calm/assets/botanical/sage-botanical-corner.svg`
- `concepts/21-calm/assets/botanical/section-separator.svg`
- `concepts/21-calm/assets/brand/assinatura-1.jpg`
- `concepts/21-calm/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Calm | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Calm concept.`
- H1 pattern: 1 H1 parsed; `Botanical calm, clinical precision`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/21-calm/sitemap.html` exists.
...
- What makes it different: It is identified by `concierge clinic panels`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-calm`, menu `public-menu-layout-calm-cream`, footer recipe `calm`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `line reveal controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `22` and `29` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `calm consultation suite.` visual grammar.
...
## 21. Fixes Applied
- C21-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/21-calm/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C21-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/21-calm/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C21-RENDER-001
