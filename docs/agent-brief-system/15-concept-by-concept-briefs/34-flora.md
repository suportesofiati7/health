# Concept 34 - Flora Brief

## 1. Concept Snapshot
- Concept number: 34
- Concept folder path: `concepts/34-flora`
- Files inspected: 40 files, including `concepts/34-flora/index.html`, `concepts/34-flora/css/style.css`, `concepts/34-flora/partials/header.html`, `concepts/34-flora/partials/mobile-menu.html`, `concepts/34-flora/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/34-flora-desktop.png`
- `audit/screenshots/mobile/34-flora-mobile.png`
- `final/homepage-screenshots/desktop/concept-34-flora-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-34-flora-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: artisan boutique clinic translated into a Sofiati visual world, using artisan botanical craft as the governing asset language.
- Visitor emotion: flora clinical garden.
...
- How it fits Sofiati: It is identified by `artisan botanical craft`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: flora clinical garden.
...
## 4. Layout Signature
- Homepage structure: flora-split-portrait-hero-hero-01, flora-offset-consultation-ledger-content-02, flora-editorial-image-chapter-pathway-03, flora-horizontal-care-journey-content-04, flora-full-bleed-botanical-divider-content-05, flora-asymmetric-laser-panel-content-06
- Section rhythm: # 34-flora Page Flow Map Concept strategy: Flora uses flora clinical garden as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are flora-split-portrait-hero-hero-01, flora-offset-consultation-ledger-content-02, flora-editorial-image-chapter-pathway-03, flora-horizontal-care-journey-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-flora`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/34-flora/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a atelier header. The header is assigned the unique runtime marker `header-34-flora` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/34-flora/partials/header.html`, `concepts/34-flora/partials/navigation.html`, `concepts/34-flora/partials/mobile-menu.html`, `concepts/34-flora/css/style.css`, `concepts/34-flora/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/34-flora/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-floral-full`.
...
- Visual personality: The mobile menu uses a artisan menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Laser knowledge with refined comfort`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-flora.webp`..
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: flora-offset-consultation-ledger, flora-full-bleed-botanical-divider, flora-contact-card-overlap, flora-portrait-and-process-band. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: flora-radial-results-map, flora-minimal-legal-ledger, flora-image-led-trust-strip, flora-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: flora-offset-consultation-ledger, flora-full-bleed-botanical-divider, flora-contact-card-overlap, flora-portrait-and-process-band. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: flora-consultation-desk-still-life, flora-split-portrait-hero, flora-full-bleed-botanical-divider, flora-contact-card-overlap. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: flora-offset-consultation-ledger, flora-full-bleed-botanical-divider, flora-contact-card-overlap, flora-portrait-and-process-band. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: flora-skin-texture-editorial, flora-offset-consultation-ledger, flora-asymmetric-laser-panel, flora-minimal-legal-ledger. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
...
## 9. Footer Signature
- Footer structure: classes `public-footer-34, public-footer-recipe-flora, public-footer-icons-sprig, public-footer-divider-organic-dots, public-footer-hover-soft-shift, public-footer-shell`; recipe `flora`.
...
- Decorative assets/background: The footer uses a crafted footer, local contact hierarchy and concept-specific footer marker `footer-34-flora`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C34-LABEL-001, C34-SITEMAP-001, C34-RENDER-001
- Files involved: `concepts/34-flora/partials/footer.html`, `concepts/34-flora/css/style.css`.
...
- Hero/portrait use: business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-flora.webp`.
- Service/botanical/icons: A custom artisan botanical craft SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/34-flora/assets/animations/motion-path.svg`
- `concepts/34-flora/assets/backgrounds/botanical-background.svg`
- `concepts/34-flora/assets/backgrounds/mobile-menu-background.svg`
- `concepts/34-flora/assets/botanical/botanical-quote.svg`
- `concepts/34-flora/assets/botanical/bronze-branch.svg`
- `concepts/34-flora/assets/botanical/footer-botanical-stamp.svg`
- `concepts/34-flora/assets/botanical/gold-leaf-divider.svg`
- `concepts/34-flora/assets/botanical/monogram-wreath.svg`
- `concepts/34-flora/assets/botanical/sage-botanical-corner.svg`
- `concepts/34-flora/assets/botanical/section-separator.svg`
- `concepts/34-flora/assets/brand/assinatura-1.jpg`
- `concepts/34-flora/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Flora | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Flora concept.`
- H1 pattern: 1 H1 parsed; `Laser knowledge with refined comfort`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/34-flora/sitemap.html` exists.
...
- What makes it different: It is identified by `artisan botanical craft`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-flora`, menu `public-menu-layout-floral-full`, footer recipe `flora`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `icon tilt controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `35` and `42` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `flora clinical garden.` visual grammar.
...
## 21. Fixes Applied
- C34-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/34-flora/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C34-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/34-flora/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C34-RENDER-001
