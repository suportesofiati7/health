# Concept 20 - Halo Brief

## 1. Concept Snapshot
- Concept number: 20
- Concept folder path: `concepts/20-halo`
- Files inspected: 40 files, including `concepts/20-halo/index.html`, `concepts/20-halo/css/style.css`, `concepts/20-halo/partials/header.html`, `concepts/20-halo/partials/mobile-menu.html`, `concepts/20-halo/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/20-halo-desktop.png`
- `audit/screenshots/mobile/20-halo-mobile.png`
- `final/homepage-screenshots/desktop/concept-20-halo-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-20-halo-home-mobile.png`
- Status: strong
- Confidence level: high

## 2. Concept Purpose
- Intended impression: circular radial profile pathway translated into a Sofiati visual world, using physician profile stamp as the governing asset language.
- Visitor emotion: halo trust composition.
...
- How it fits Sofiati: It is identified by `physician profile stamp`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: halo trust composition.
...
## 4. Layout Signature
- Homepage structure: halo-radial-results-map-hero-01, halo-magazine-article-grid-visual-story-02, halo-contact-card-overlap-pathway-03, halo-minimal-legal-ledger-content-04, halo-stacked-proof-column-content-05, halo-floating-note-system-content-06
- Section rhythm: # 20-halo Page Flow Map Concept strategy: Halo uses halo trust composition as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are halo-radial-results-map-hero-01, halo-magazine-article-grid-visual-story-02, halo-contact-card-overlap-pathway-03, halo-minimal-legal-ledger-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-halo`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/20-halo/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a halo profile header. The header is assigned the unique runtime marker `header-20-halo` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/20-halo/partials/header.html`, `concepts/20-halo/partials/navigation.html`, `concepts/20-halo/partials/mobile-menu.html`, `concepts/20-halo/css/style.css`, `concepts/20-halo/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/20-halo/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-radial`.
...
- Visual personality: The mobile menu uses a radial bio drawer with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Clear guidance before aesthetic protocols`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-halo.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: halo-asymmetric-laser-panel, halo-contact-card-overlap, halo-portrait-and-process-band, halo-large-type-statement. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: halo-asymmetric-laser-panel, halo-contact-card-overlap, halo-portrait-and-process-band, halo-large-type-statement. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: halo-full-bleed-botanical-divider, halo-magazine-article-grid, halo-floating-note-system, halo-quiet-route-index. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: halo-asymmetric-laser-panel, halo-contact-card-overlap, halo-portrait-and-process-band, halo-large-type-statement. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: halo-magazine-article-grid, halo-stacked-proof-column, halo-accordion-guidance-panel, halo-skin-texture-editorial. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: halo-portrait-and-process-band, halo-quiet-route-index, halo-laser-light-sequence, halo-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: halo-magazine-article-grid, halo-stacked-proof-column, halo-accordion-guidance-panel, halo-skin-texture-editorial. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: halo-horizontal-care-journey, halo-radial-results-map, halo-stacked-proof-column, halo-accordion-guidance-panel. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: halo-magazine-article-grid, halo-stacked-proof-column, halo-accordion-guidance-panel, halo-skin-texture-editorial. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: halo-full-bleed-botanical-divider, halo-magazine-article-grid, halo-floating-note-system, halo-quiet-route-index. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: halo-asymmetric-laser-panel, halo-contact-card-overlap, halo-portrait-and-process-band, halo-large-type-statement. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-20, public-footer-recipe-halo, public-footer-icons-halo, public-footer-divider-centerline, public-footer-hover-underline, public-footer-shell`; recipe `halo`.
...
- Decorative assets/background: The footer uses a circular profile footer, local contact hierarchy and concept-specific footer marker `footer-20-halo`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C20-LABEL-001, C20-SITEMAP-001
- Files involved: `concepts/20-halo/partials/footer.html`, `concepts/20-halo/css/style.css`.
...
- Hero/portrait use: journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-halo.webp`.
- Service/botanical/icons: A custom physician profile stamp SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/20-halo/assets/animations/motion-path.svg`
- `concepts/20-halo/assets/backgrounds/botanical-background.svg`
- `concepts/20-halo/assets/backgrounds/mobile-menu-background.svg`
- `concepts/20-halo/assets/botanical/botanical-quote.svg`
- `concepts/20-halo/assets/botanical/bronze-branch.svg`
- `concepts/20-halo/assets/botanical/footer-botanical-stamp.svg`
- `concepts/20-halo/assets/botanical/gold-leaf-divider.svg`
- `concepts/20-halo/assets/botanical/monogram-wreath.svg`
- `concepts/20-halo/assets/botanical/sage-botanical-corner.svg`
- `concepts/20-halo/assets/botanical/section-separator.svg`
- `concepts/20-halo/assets/brand/assinatura-1.jpg`
- `concepts/20-halo/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Halo | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Halo concept.`
- H1 pattern: 1 H1 parsed; `Clear guidance before aesthetic protocols`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/20-halo/sitemap.html` exists.
...
- What makes it different: It is identified by `physician profile stamp`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-halo`, menu `public-menu-layout-radial`, footer recipe `halo`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `service badge pulse controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `21` and `28` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `halo trust composition.` visual grammar.
...
## 21. Fixes Applied
- C20-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/20-halo/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C20-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/20-halo/sitemap.html`. Verification: Run rg for Brand and education..
