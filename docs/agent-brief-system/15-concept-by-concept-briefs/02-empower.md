# Concept 02 - Empower Brief

## 1. Concept Snapshot
- Concept number: 02
- Concept folder path: `concepts/02-empower`
- Files inspected: 40 files, including `concepts/02-empower/index.html`, `concepts/02-empower/css/style.css`, `concepts/02-empower/partials/header.html`, `concepts/02-empower/partials/mobile-menu.html`, `concepts/02-empower/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/02-empower-desktop.png`
- `audit/screenshots/mobile/02-empower-mobile.png`
- `final/homepage-screenshots/desktop/concept-02-empower-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-02-empower-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: decision-led consultation studio translated into a Sofiati visual world, using business-card seal system as the governing asset language.
- Visitor emotion: decision-led consultation studio.
...
- How it fits Sofiati: It is identified by `business-card seal system`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: decision-led consultation studio.
...
## 4. Layout Signature
- Homepage structure: empower-contact-card-overlap-hero-01, empower-portrait-and-process-band-contextual-journey, empower-stacked-proof-column-consultation-form-03, empower-floating-note-system-pathway-04, empower-portrait-and-process-band-content-05, empower-image-led-trust-strip-content-06
- Section rhythm: # 02-empower Page Flow Map Concept strategy: Empower uses decision-led consultation studio as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are empower-contact-card-overlap-hero-01, empower-portrait-and-process-band-contextual-journey, empower-stacked-proof-column-consultation-form-03, empower-floating-note-system-pathway-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-capsule`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/02-empower/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a sticky appointment decision bar. The header is assigned the unique runtime marker `header-02-empower` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/02-empower/partials/header.html`, `concepts/02-empower/partials/navigation.html`, `concepts/02-empower/partials/mobile-menu.html`, `concepts/02-empower/css/style.css`, `concepts/02-empower/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/02-empower/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-bottom-sheet`.
...
- Visual personality: The mobile menu uses a authority contact-sheet menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `A calmer way to care for skin and confidence`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-empower.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: empower-magazine-article-grid, empower-stacked-proof-column, empower-accordion-guidance-panel, empower-skin-texture-editorial. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: empower-magazine-article-grid, empower-stacked-proof-column, empower-accordion-guidance-panel, empower-skin-texture-editorial. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: empower-radial-results-map, empower-minimal-legal-ledger, empower-image-led-trust-strip, empower-consultation-desk-still-life. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: empower-magazine-article-grid, empower-stacked-proof-column, empower-accordion-guidance-panel, empower-skin-texture-editorial. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: empower-minimal-legal-ledger, empower-portrait-and-process-band, empower-large-type-statement, empower-split-portrait-hero. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: empower-accordion-guidance-panel, empower-consultation-desk-still-life, empower-offset-consultation-ledger, empower-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: empower-minimal-legal-ledger, empower-portrait-and-process-band, empower-large-type-statement, empower-split-portrait-hero. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: empower-asymmetric-laser-panel, empower-contact-card-overlap, empower-portrait-and-process-band, empower-large-type-statement. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: empower-minimal-legal-ledger, empower-portrait-and-process-band, empower-large-type-statement, empower-split-portrait-hero. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: empower-radial-results-map, empower-minimal-legal-ledger, empower-image-led-trust-strip, empower-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: empower-magazine-article-grid, empower-stacked-proof-column, empower-accordion-guidance-panel, empower-skin-texture-editorial. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-02, public-footer-recipe-empower, public-footer-icons-leaf, public-footer-divider-leftline, public-footer-hover-soft-shift, public-footer-shell`; recipe `empower`.
...
- Decorative assets/background: The footer uses a professional authority footer, local contact hierarchy and concept-specific footer marker `footer-02-empower`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C02-LABEL-001, C02-SITEMAP-001, C02-RENDER-001
- Files involved: `concepts/02-empower/partials/footer.html`, `concepts/02-empower/css/style.css`.
...
- Hero/portrait use: round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-empower.webp`.
- Service/botanical/icons: A custom business-card seal system SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/02-empower/assets/animations/motion-path.svg`
- `concepts/02-empower/assets/backgrounds/botanical-background.svg`
- `concepts/02-empower/assets/backgrounds/mobile-menu-background.svg`
- `concepts/02-empower/assets/botanical/botanical-quote.svg`
- `concepts/02-empower/assets/botanical/bronze-branch.svg`
- `concepts/02-empower/assets/botanical/footer-botanical-stamp.svg`
- `concepts/02-empower/assets/botanical/gold-leaf-divider.svg`
- `concepts/02-empower/assets/botanical/monogram-wreath.svg`
- `concepts/02-empower/assets/botanical/sage-botanical-corner.svg`
- `concepts/02-empower/assets/botanical/section-separator.svg`
- `concepts/02-empower/assets/brand/assinatura-1.jpg`
- `concepts/02-empower/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Empower | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Empower concept.`
- H1 pattern: 1 H1 parsed; `A calmer way to care for skin and confidence`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/02-empower/sitemap.html` exists.
...
- What makes it different: It is identified by `business-card seal system`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-capsule`, menu `public-menu-layout-bottom-sheet`, footer recipe `empower`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `leaf orbit controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `03` and `10` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `decision-led consultation studio.` visual grammar.
...
## 21. Fixes Applied
- C02-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/02-empower/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C02-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/02-empower/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C02-RENDER-001
