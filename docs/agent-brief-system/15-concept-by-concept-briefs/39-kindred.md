# Concept 39 - Kindred Brief

## 1. Concept Snapshot
- Concept number: 39
- Concept folder path: `concepts/39-kindred`
- Files inspected: 40 files, including `concepts/39-kindred/index.html`, `concepts/39-kindred/css/style.css`, `concepts/39-kindred/partials/header.html`, `concepts/39-kindred/partials/mobile-menu.html`, `concepts/39-kindred/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/39-kindred-desktop.png`
- `audit/screenshots/mobile/39-kindred-mobile.png`
- `final/homepage-screenshots/desktop/concept-39-kindred-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-39-kindred-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: scientific skincare brand translated into a Sofiati visual world, using science ingredient diagrams as the governing asset language.
- Visitor emotion: kindred warm guidance.
...
- How it fits Sofiati: It is identified by `science ingredient diagrams`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: kindred warm guidance.
...
## 4. Layout Signature
- Homepage structure: kindred-asymmetric-laser-panel-hero-01, kindred-radial-results-map-content-02, kindred-magazine-article-grid-content-03, kindred-contact-card-overlap-content-04, kindred-minimal-legal-ledger-pathway-05, kindred-stacked-proof-column-visual-story-06
- Section rhythm: # 39-kindred Page Flow Map Concept strategy: Kindred uses kindred warm guidance as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are kindred-asymmetric-laser-panel-hero-01, kindred-radial-results-map-content-02, kindred-magazine-article-grid-content-03, kindred-contact-card-overlap-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-kindred`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/39-kindred/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a science brand header. The header is assigned the unique runtime marker `header-39-kindred` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/39-kindred/partials/header.html`, `concepts/39-kindred/partials/navigation.html`, `concepts/39-kindred/partials/mobile-menu.html`, `concepts/39-kindred/css/style.css`, `concepts/39-kindred/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/39-kindred/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-warm-card`.
...
- Visual personality: The mobile menu uses a ingredient menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Skin quality begins with listening`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-kindred.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: kindred-full-bleed-botanical-divider, kindred-magazine-article-grid, kindred-floating-note-system, kindred-quiet-route-index. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: kindred-full-bleed-botanical-divider, kindred-magazine-article-grid, kindred-floating-note-system, kindred-quiet-route-index. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: kindred-horizontal-care-journey, kindred-radial-results-map, kindred-stacked-proof-column, kindred-accordion-guidance-panel. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: kindred-full-bleed-botanical-divider, kindred-magazine-article-grid, kindred-floating-note-system, kindred-quiet-route-index. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: kindred-radial-results-map, kindred-minimal-legal-ledger, kindred-image-led-trust-strip, kindred-consultation-desk-still-life. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: kindred-floating-note-system, kindred-accordion-guidance-panel, kindred-skin-texture-editorial, kindred-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: kindred-radial-results-map, kindred-minimal-legal-ledger, kindred-image-led-trust-strip, kindred-consultation-desk-still-life. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: kindred-editorial-image-chapter, kindred-asymmetric-laser-panel, kindred-minimal-legal-ledger, kindred-image-led-trust-strip. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: kindred-radial-results-map, kindred-minimal-legal-ledger, kindred-image-led-trust-strip, kindred-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: kindred-horizontal-care-journey, kindred-radial-results-map, kindred-stacked-proof-column, kindred-accordion-guidance-panel. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: kindred-full-bleed-botanical-divider, kindred-magazine-article-grid, kindred-floating-note-system, kindred-quiet-route-index. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-39, public-footer-recipe-kindred, public-footer-icons-circle, public-footer-divider-soft-arc, public-footer-hover-soft-shift, public-footer-shell`; recipe `kindred`.
...
- Decorative assets/background: The footer uses a science footer, local contact hierarchy and concept-specific footer marker `footer-39-kindred`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C39-LABEL-001, C39-SITEMAP-001, C39-RENDER-001
- Files involved: `concepts/39-kindred/partials/footer.html`, `concepts/39-kindred/css/style.css`.
...
- Hero/portrait use: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-kindred.webp`.
- Service/botanical/icons: A custom science ingredient diagrams SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/39-kindred/assets/animations/motion-path.svg`
- `concepts/39-kindred/assets/backgrounds/botanical-background.svg`
- `concepts/39-kindred/assets/backgrounds/mobile-menu-background.svg`
- `concepts/39-kindred/assets/botanical/botanical-quote.svg`
- `concepts/39-kindred/assets/botanical/bronze-branch.svg`
- `concepts/39-kindred/assets/botanical/footer-botanical-stamp.svg`
- `concepts/39-kindred/assets/botanical/gold-leaf-divider.svg`
- `concepts/39-kindred/assets/botanical/monogram-wreath.svg`
- `concepts/39-kindred/assets/botanical/sage-botanical-corner.svg`
- `concepts/39-kindred/assets/botanical/section-separator.svg`
- `concepts/39-kindred/assets/brand/assinatura-1.jpg`
- `concepts/39-kindred/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Kindred | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Kindred concept.`
- H1 pattern: 1 H1 parsed; `Skin quality begins with listening`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/39-kindred/sitemap.html` exists.
...
- What makes it different: It is identified by `science ingredient diagrams`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-kindred`, menu `public-menu-layout-warm-card`, footer recipe `kindred`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `journal card rise controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `40` and `47` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `kindred warm guidance.` visual grammar.
...
## 21. Fixes Applied
- C39-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/39-kindred/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C39-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/39-kindred/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C39-RENDER-001
