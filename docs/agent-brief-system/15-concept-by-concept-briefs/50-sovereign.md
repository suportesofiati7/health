# Concept 50 - Sovereign Brief

## 1. Concept Snapshot
- Concept number: 50
- Concept folder path: `concepts/50-sovereign`
- Files inspected: 40 files, including `concepts/50-sovereign/index.html`, `concepts/50-sovereign/css/style.css`, `concepts/50-sovereign/partials/header.html`, `concepts/50-sovereign/partials/mobile-menu.html`, `concepts/50-sovereign/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/50-sovereign-desktop.png`
- `audit/screenshots/mobile/50-sovereign-mobile.png`
- `final/homepage-screenshots/desktop/concept-50-sovereign-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-50-sovereign-home-mobile.png`
- Status: strong
- Confidence level: high

## 2. Concept Purpose
- Intended impression: minimalist ingredient lab translated into a Sofiati visual world, using ingredient lab minimal grid as the governing asset language.
- Visitor emotion: sovereign editorial authority.
...
- How it fits Sofiati: It is identified by `ingredient lab minimal grid`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: sovereign editorial authority.
...
## 4. Layout Signature
- Homepage structure: sovereign-large-type-statement-hero-01, sovereign-consultation-desk-still-life-visual-story-02, sovereign-skin-texture-editorial-pathway-03, sovereign-laser-light-sequence-content-04, sovereign-split-portrait-hero-content-05, sovereign-offset-consultation-ledger-content-06
- Section rhythm: # 50-sovereign Page Flow Map Concept strategy: Sovereign uses sovereign editorial authority as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are sovereign-large-type-statement-hero-01, sovereign-consultation-desk-still-life-visual-story-02, sovereign-skin-texture-editorial-pathway-03, sovereign-laser-light-sequence-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-sovereign`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/50-sovereign/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a ingredient lab header. The header is assigned the unique runtime marker `header-50-sovereign` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/50-sovereign/partials/header.html`, `concepts/50-sovereign/partials/navigation.html`, `concepts/50-sovereign/partials/mobile-menu.html`, `concepts/50-sovereign/css/style.css`, `concepts/50-sovereign/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/50-sovereign/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-premium-brand`.
...
- Visual personality: The mobile menu uses a ingredient drawer menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Minimal care, precise evaluation`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-sovereign.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: sovereign-quiet-route-index, sovereign-skin-texture-editorial, sovereign-editorial-image-chapter, sovereign-radial-results-map. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: sovereign-quiet-route-index, sovereign-skin-texture-editorial, sovereign-editorial-image-chapter, sovereign-radial-results-map. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: sovereign-accordion-guidance-panel, sovereign-consultation-desk-still-life, sovereign-offset-consultation-ledger, sovereign-asymmetric-laser-panel. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: sovereign-quiet-route-index, sovereign-skin-texture-editorial, sovereign-editorial-image-chapter, sovereign-radial-results-map. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: sovereign-consultation-desk-still-life, sovereign-split-portrait-hero, sovereign-full-bleed-botanical-divider, sovereign-contact-card-overlap. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: sovereign-editorial-image-chapter, sovereign-asymmetric-laser-panel, sovereign-minimal-legal-ledger, sovereign-image-led-trust-strip. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: sovereign-consultation-desk-still-life, sovereign-split-portrait-hero, sovereign-full-bleed-botanical-divider, sovereign-contact-card-overlap. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: sovereign-image-led-trust-strip, sovereign-large-type-statement, sovereign-split-portrait-hero, sovereign-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: sovereign-consultation-desk-still-life, sovereign-split-portrait-hero, sovereign-full-bleed-botanical-divider, sovereign-contact-card-overlap. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: sovereign-accordion-guidance-panel, sovereign-consultation-desk-still-life, sovereign-offset-consultation-ledger, sovereign-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: sovereign-quiet-route-index, sovereign-skin-texture-editorial, sovereign-editorial-image-chapter, sovereign-radial-results-map. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-50, public-footer-recipe-sovereign, public-footer-icons-crest, public-footer-divider-champagne-rule, public-footer-hover-gold-sweep, public-footer-shell`; recipe `sovereign`.
...
- Decorative assets/background: The footer uses a minimal lab footer, local contact hierarchy and concept-specific footer marker `footer-50-sovereign`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C50-LABEL-001, C50-SITEMAP-001
- Files involved: `concepts/50-sovereign/partials/footer.html`, `concepts/50-sovereign/css/style.css`.
...
- Hero/portrait use: journal-side portrait notecard, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-sovereign.webp`.
- Service/botanical/icons: A custom ingredient lab minimal grid SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/50-sovereign/assets/animations/motion-path.svg`
- `concepts/50-sovereign/assets/backgrounds/botanical-background.svg`
- `concepts/50-sovereign/assets/backgrounds/mobile-menu-background.svg`
- `concepts/50-sovereign/assets/botanical/botanical-quote.svg`
- `concepts/50-sovereign/assets/botanical/bronze-branch.svg`
- `concepts/50-sovereign/assets/botanical/footer-botanical-stamp.svg`
- `concepts/50-sovereign/assets/botanical/gold-leaf-divider.svg`
- `concepts/50-sovereign/assets/botanical/monogram-wreath.svg`
- `concepts/50-sovereign/assets/botanical/sage-botanical-corner.svg`
- `concepts/50-sovereign/assets/botanical/section-separator.svg`
- `concepts/50-sovereign/assets/brand/assinatura-1.jpg`
- `concepts/50-sovereign/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Sovereign | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Sovereign concept.`
- H1 pattern: 1 H1 parsed; `Minimal care, precise evaluation`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/50-sovereign/sitemap.html` exists.
...
- What makes it different: It is identified by `ingredient lab minimal grid`, portrait treatment `journal-side portrait notecard`, motion `service badge pulse`, form `portrait-led consultation form` and footer `credential stamp footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-sovereign`, menu `public-menu-layout-premium-brand`, footer recipe `sovereign`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `service badge pulse controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `01` and `08` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `sovereign editorial authority.` visual grammar.
...
## 21. Fixes Applied
- C50-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/50-sovereign/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C50-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/50-sovereign/sitemap.html`. Verification: Run rg for Brand and education..
