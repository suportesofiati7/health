# Concept 24 - Signal Brief

## 1. Concept Snapshot
- Concept number: 24
- Concept folder path: `concepts/24-signal`
- Files inspected: 40 files, including `concepts/24-signal/index.html`, `concepts/24-signal/css/style.css`, `concepts/24-signal/partials/header.html`, `concepts/24-signal/partials/mobile-menu.html`, `concepts/24-signal/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/24-signal-desktop.png`
- `audit/screenshots/mobile/24-signal-mobile.png`
- `final/homepage-screenshots/desktop/concept-24-signal-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-24-signal-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: fine clinic calm translated into a Sofiati visual world, using fine-list micro glyphs as the governing asset language.
- Visitor emotion: signal-led decision guide.
...
- How it fits Sofiati: It is identified by `fine-list micro glyphs`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: signal-led decision guide.
...
## 4. Layout Signature
- Homepage structure: signal-stacked-proof-column-hero-01, signal-floating-note-system-content-02, signal-portrait-and-process-band-pathway-03, signal-image-led-trust-strip-content-04, signal-accordion-guidance-panel-content-05, signal-quiet-route-index-content-06
- Section rhythm: # 24-signal Page Flow Map Concept strategy: Signal uses signal-led decision guide as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are signal-stacked-proof-column-hero-01, signal-floating-note-system-content-02, signal-portrait-and-process-band-pathway-03, signal-image-led-trust-strip-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-signal`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/24-signal/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a ultra-minimal header. The header is assigned the unique runtime marker `header-24-signal` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/24-signal/partials/header.html`, `concepts/24-signal/partials/navigation.html`, `concepts/24-signal/partials/mobile-menu.html`, `concepts/24-signal/css/style.css`, `concepts/24-signal/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/24-signal/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-signal-drawer`.
...
- Visual personality: The mobile menu uses a quiet list menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Laser decisions made with care`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-signal.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: signal-minimal-legal-ledger, signal-portrait-and-process-band, signal-large-type-statement, signal-split-portrait-hero. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: signal-minimal-legal-ledger, signal-portrait-and-process-band, signal-large-type-statement, signal-split-portrait-hero. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: signal-contact-card-overlap, signal-floating-note-system, signal-quiet-route-index, signal-laser-light-sequence. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: signal-minimal-legal-ledger, signal-portrait-and-process-band, signal-large-type-statement, signal-split-portrait-hero. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: signal-floating-note-system, signal-accordion-guidance-panel, signal-skin-texture-editorial, signal-editorial-image-chapter. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: signal-large-type-statement, signal-laser-light-sequence, signal-horizontal-care-journey, signal-magazine-article-grid. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: signal-floating-note-system, signal-accordion-guidance-panel, signal-skin-texture-editorial, signal-editorial-image-chapter. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: signal-magazine-article-grid, signal-stacked-proof-column, signal-accordion-guidance-panel, signal-skin-texture-editorial. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: signal-floating-note-system, signal-accordion-guidance-panel, signal-skin-texture-editorial, signal-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: signal-contact-card-overlap, signal-floating-note-system, signal-quiet-route-index, signal-laser-light-sequence. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: signal-minimal-legal-ledger, signal-portrait-and-process-band, signal-large-type-statement, signal-split-portrait-hero. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-24, public-footer-recipe-signal, public-footer-icons-signal, public-footer-divider-scanline, public-footer-hover-soft-shift, public-footer-shell`; recipe `signal`.
...
- Decorative assets/background: The footer uses a fine-print footer, local contact hierarchy and concept-specific footer marker `footer-24-signal`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C24-LABEL-001, C24-SITEMAP-001, C24-RENDER-001
- Files involved: `concepts/24-signal/partials/footer.html`, `concepts/24-signal/css/style.css`.
...
- Hero/portrait use: business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-signal.webp`.
- Service/botanical/icons: A custom fine-list micro glyphs SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/24-signal/assets/animations/motion-path.svg`
- `concepts/24-signal/assets/backgrounds/botanical-background.svg`
- `concepts/24-signal/assets/backgrounds/mobile-menu-background.svg`
- `concepts/24-signal/assets/botanical/botanical-quote.svg`
- `concepts/24-signal/assets/botanical/bronze-branch.svg`
- `concepts/24-signal/assets/botanical/footer-botanical-stamp.svg`
- `concepts/24-signal/assets/botanical/gold-leaf-divider.svg`
- `concepts/24-signal/assets/botanical/monogram-wreath.svg`
- `concepts/24-signal/assets/botanical/sage-botanical-corner.svg`
- `concepts/24-signal/assets/botanical/section-separator.svg`
- `concepts/24-signal/assets/brand/assinatura-1.jpg`
- `concepts/24-signal/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Signal | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Signal concept.`
- H1 pattern: 1 H1 parsed; `Laser decisions made with care`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/24-signal/sitemap.html` exists.
...
- What makes it different: It is identified by `fine-list micro glyphs`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-signal`, menu `public-menu-layout-signal-drawer`, footer recipe `signal`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `icon tilt controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `25` and `32` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `signal-led decision guide.` visual grammar.
...
## 21. Fixes Applied
- C24-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/24-signal/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C24-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/24-signal/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C24-RENDER-001
