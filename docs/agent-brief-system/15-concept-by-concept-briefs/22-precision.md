# Concept 22 - Precision Brief

## 1. Concept Snapshot
- Concept number: 22
- Concept folder path: `concepts/22-precision`
- Files inspected: 40 files, including `concepts/22-precision/index.html`, `concepts/22-precision/css/style.css`, `concepts/22-precision/partials/header.html`, `concepts/22-precision/partials/mobile-menu.html`, `concepts/22-precision/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/22-precision-desktop.png`
- `audit/screenshots/mobile/22-precision-mobile.png`
- `final/homepage-screenshots/desktop/concept-22-precision-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-22-precision-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: consultant authority translated into a Sofiati visual world, using signature consultant trace as the governing asset language.
- Visitor emotion: precision technical atlas.
...
- How it fits Sofiati: It is identified by `signature consultant trace`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: precision technical atlas.
...
## 4. Layout Signature
- Homepage structure: precision-contact-card-overlap-hero-01, precision-portrait-and-process-band-contextual-journey, precision-stacked-proof-column-consultation-form-03, precision-floating-note-system-pathway-04, precision-portrait-and-process-band-content-05, precision-image-led-trust-strip-content-06
- Section rhythm: # 22-precision Page Flow Map Concept strategy: Precision uses precision technical atlas as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are precision-contact-card-overlap-hero-01, precision-portrait-and-process-band-contextual-journey, precision-stacked-proof-column-consultation-form-03, precision-floating-note-system-pathway-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-precision`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/22-precision/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a doctor-signature header. The header is assigned the unique runtime marker `header-22-precision` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/22-precision/partials/header.html`, `concepts/22-precision/partials/navigation.html`, `concepts/22-precision/partials/mobile-menu.html`, `concepts/22-precision/css/style.css`, `concepts/22-precision/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/22-precision/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-precise-drawer`.
...
- Visual personality: The mobile menu uses a consultant menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `A responsible path to visible care`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-precision.webp`..
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: precision-minimal-legal-ledger, precision-portrait-and-process-band, precision-large-type-statement, precision-split-portrait-hero. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: precision-accordion-guidance-panel, precision-consultation-desk-still-life, precision-offset-consultation-ledger, precision-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: precision-minimal-legal-ledger, precision-portrait-and-process-band, precision-large-type-statement, precision-split-portrait-hero. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: precision-asymmetric-laser-panel, precision-contact-card-overlap, precision-portrait-and-process-band, precision-large-type-statement. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: precision-minimal-legal-ledger, precision-portrait-and-process-band, precision-large-type-statement, precision-split-portrait-hero. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: precision-radial-results-map, precision-minimal-legal-ledger, precision-image-led-trust-strip, precision-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
...
## 9. Footer Signature
- Footer structure: classes `public-footer-22, public-footer-recipe-precision, public-footer-icons-ledger, public-footer-divider-vertical-rules, public-footer-hover-left-indent, public-footer-shell`; recipe `precision`.
...
- Decorative assets/background: The footer uses a appointment footer, local contact hierarchy and concept-specific footer marker `footer-22-precision`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C22-LABEL-001, C22-SITEMAP-001, C22-RENDER-001, C22-RENDER-002
- Files involved: `concepts/22-precision/partials/footer.html`, `concepts/22-precision/css/style.css`.
...
- Hero/portrait use: round monogram-backed portrait stamp, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-precision.webp`.
- Service/botanical/icons: A custom signature consultant trace SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/22-precision/assets/animations/motion-path.svg`
- `concepts/22-precision/assets/backgrounds/botanical-background.svg`
- `concepts/22-precision/assets/backgrounds/mobile-menu-background.svg`
- `concepts/22-precision/assets/botanical/botanical-quote.svg`
- `concepts/22-precision/assets/botanical/bronze-branch.svg`
- `concepts/22-precision/assets/botanical/footer-botanical-stamp.svg`
- `concepts/22-precision/assets/botanical/gold-leaf-divider.svg`
- `concepts/22-precision/assets/botanical/monogram-wreath.svg`
- `concepts/22-precision/assets/botanical/sage-botanical-corner.svg`
- `concepts/22-precision/assets/botanical/section-separator.svg`
- `concepts/22-precision/assets/brand/assinatura-1.jpg`
- `concepts/22-precision/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Precision | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Precision concept.`
- H1 pattern: 1 H1 parsed; `A responsible path to visible care`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/22-precision/sitemap.html` exists.
...
- What makes it different: It is identified by `signature consultant trace`, portrait treatment `round monogram-backed portrait stamp`, motion `leaf orbit`, form `sage panel form` and footer `large monogram ledger`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-precision`, menu `public-menu-layout-precise-drawer`, footer recipe `precision`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `leaf orbit controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `23` and `30` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `precision technical atlas.` visual grammar.
...
## 21. Fixes Applied
- C22-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/22-precision/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C22-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/22-precision/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C22-RENDER-001, C22-RENDER-002
