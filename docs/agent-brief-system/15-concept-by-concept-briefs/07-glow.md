# Concept 07 - Glow Brief

## 1. Concept Snapshot
- Concept number: 07
- Concept folder path: `concepts/07-glow`
- Files inspected: 40 files, including `concepts/07-glow/index.html`, `concepts/07-glow/css/style.css`, `concepts/07-glow/partials/header.html`, `concepts/07-glow/partials/mobile-menu.html`, `concepts/07-glow/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/07-glow-desktop.png`
- `audit/screenshots/mobile/07-glow-mobile.png`
- `final/homepage-screenshots/desktop/concept-07-glow-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-07-glow-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: luminous skin-quality story translated into a Sofiati visual world, using proof-grid bronze markers as the governing asset language.
- Visitor emotion: soft radiance editorial.
...
- How it fits Sofiati: It is identified by `proof-grid bronze markers`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: soft radiance editorial.
...
## 4. Layout Signature
- Homepage structure: glow-image-led-trust-strip-hero-01, glow-accordion-guidance-panel-content-02, glow-quiet-route-index-visual-story-03, glow-consultation-desk-still-life-contextual-journey, glow-consultation-desk-still-life-consultation-form-05, glow-skin-texture-editorial-pathway-06
- Section rhythm: # 07-glow Page Flow Map Concept strategy: Glow uses soft radiance editorial as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are glow-image-led-trust-strip-hero-01, glow-accordion-guidance-panel-content-02, glow-quiet-route-index-visual-story-03, glow-consultation-desk-still-life-contextual-journey
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-luminous`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/07-glow/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a light-filled evidence header. The header is assigned the unique runtime marker `header-07-glow` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/07-glow/partials/header.html`, `concepts/07-glow/partials/navigation.html`, `concepts/07-glow/partials/mobile-menu.html`, `concepts/07-glow/css/style.css`, `concepts/07-glow/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/07-glow/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-luminous-overlay`.
...
- Visual personality: The mobile menu uses a luminous bottom-sheet menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Refined aesthetic care in Londrina`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-glow.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: glow-portrait-and-process-band, glow-quiet-route-index, glow-laser-light-sequence, glow-horizontal-care-journey. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: glow-portrait-and-process-band, glow-quiet-route-index, glow-laser-light-sequence, glow-horizontal-care-journey. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: glow-floating-note-system, glow-accordion-guidance-panel, glow-skin-texture-editorial, glow-editorial-image-chapter. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: glow-portrait-and-process-band, glow-quiet-route-index, glow-laser-light-sequence, glow-horizontal-care-journey. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: glow-accordion-guidance-panel, glow-consultation-desk-still-life, glow-offset-consultation-ledger, glow-asymmetric-laser-panel. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: glow-laser-light-sequence, glow-editorial-image-chapter, glow-radial-results-map, glow-stacked-proof-column. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: glow-accordion-guidance-panel, glow-consultation-desk-still-life, glow-offset-consultation-ledger, glow-asymmetric-laser-panel. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: glow-stacked-proof-column, glow-image-led-trust-strip, glow-consultation-desk-still-life, glow-offset-consultation-ledger. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: glow-accordion-guidance-panel, glow-consultation-desk-still-life, glow-offset-consultation-ledger, glow-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: glow-floating-note-system, glow-accordion-guidance-panel, glow-skin-texture-editorial, glow-editorial-image-chapter. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: glow-portrait-and-process-band, glow-quiet-route-index, glow-laser-light-sequence, glow-horizontal-care-journey. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-07, public-footer-recipe-glow, public-footer-icons-circle, public-footer-divider-glowline, public-footer-hover-soft-shift, public-footer-shell`; recipe `glow`.
...
- Decorative assets/background: The footer uses a bright skin-quality footer, local contact hierarchy and concept-specific footer marker `footer-07-glow`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C07-LABEL-001, C07-SITEMAP-001, C07-RENDER-001, C07-RENDER-002
- Files involved: `concepts/07-glow/partials/footer.html`, `concepts/07-glow/css/style.css`.
...
- Hero/portrait use: clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-glow.webp`.
- Service/botanical/icons: A custom proof-grid bronze markers SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/07-glow/assets/animations/motion-path.svg`
- `concepts/07-glow/assets/backgrounds/botanical-background.svg`
- `concepts/07-glow/assets/backgrounds/mobile-menu-background.svg`
- `concepts/07-glow/assets/botanical/botanical-quote.svg`
- `concepts/07-glow/assets/botanical/bronze-branch.svg`
- `concepts/07-glow/assets/botanical/footer-botanical-stamp.svg`
- `concepts/07-glow/assets/botanical/gold-leaf-divider.svg`
- `concepts/07-glow/assets/botanical/monogram-wreath.svg`
- `concepts/07-glow/assets/botanical/sage-botanical-corner.svg`
- `concepts/07-glow/assets/botanical/section-separator.svg`
- `concepts/07-glow/assets/brand/assinatura-1.jpg`
- `concepts/07-glow/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Glow | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Glow concept.`
- H1 pattern: 1 H1 parsed; `Refined aesthetic care in Londrina`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/07-glow/sitemap.html` exists.
...
- What makes it different: It is identified by `proof-grid bronze markers`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-luminous`, menu `public-menu-layout-luminous-overlay`, footer recipe `glow`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `divider trace controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `08` and `15` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `soft radiance editorial.` visual grammar.
...
## 21. Fixes Applied
- C07-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/07-glow/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C07-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/07-glow/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C07-RENDER-001, C07-RENDER-002
