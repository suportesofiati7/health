# Concept 14 - Aura Brief

## 1. Concept Snapshot
- Concept number: 14
- Concept folder path: `concepts/14-aura`
- Files inspected: 40 files, including `concepts/14-aura/index.html`, `concepts/14-aura/css/style.css`, `concepts/14-aura/partials/header.html`, `concepts/14-aura/partials/mobile-menu.html`, `concepts/14-aura/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/14-aura-desktop.png`
- `audit/screenshots/mobile/14-aura-mobile.png`
- `final/homepage-screenshots/desktop/concept-14-aura-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-14-aura-home-mobile.png`
- Status: strong
- Confidence level: high

## 2. Concept Purpose
- Intended impression: atmospheric sensory flow translated into a Sofiati visual world, using champagne ritual overlays as the governing asset language.
- Visitor emotion: aura-based trust story.
...
- How it fits Sofiati: It is identified by `champagne ritual overlays`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: aura-based trust story.
...
## 4. Layout Signature
- Homepage structure: aura-split-portrait-hero-hero-01, aura-offset-consultation-ledger-content-02, aura-editorial-image-chapter-pathway-03, aura-horizontal-care-journey-content-04, aura-full-bleed-botanical-divider-content-05, aura-asymmetric-laser-panel-content-06
- Section rhythm: # 14-aura Page Flow Map Concept strategy: Aura uses aura-based trust story as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are aura-split-portrait-hero-hero-01, aura-offset-consultation-ledger-content-02, aura-editorial-image-chapter-pathway-03, aura-horizontal-care-journey-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-aura`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/14-aura/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a soft overlay capsule header. The header is assigned the unique runtime marker `header-14-aura` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/14-aura/partials/header.html`, `concepts/14-aura/partials/navigation.html`, `concepts/14-aura/partials/mobile-menu.html`, `concepts/14-aura/css/style.css`, `concepts/14-aura/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/14-aura/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-soft-overlay`.
...
- Visual personality: The mobile menu uses a atmospheric full-screen menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Laser care with safety and warmth`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-aura.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: aura-laser-light-sequence, aura-editorial-image-chapter, aura-radial-results-map, aura-stacked-proof-column. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: aura-laser-light-sequence, aura-editorial-image-chapter, aura-radial-results-map, aura-stacked-proof-column. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: aura-skin-texture-editorial, aura-offset-consultation-ledger, aura-asymmetric-laser-panel, aura-minimal-legal-ledger. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: aura-laser-light-sequence, aura-editorial-image-chapter, aura-radial-results-map, aura-stacked-proof-column. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: aura-offset-consultation-ledger, aura-full-bleed-botanical-divider, aura-contact-card-overlap, aura-portrait-and-process-band. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: aura-radial-results-map, aura-minimal-legal-ledger, aura-image-led-trust-strip, aura-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: aura-offset-consultation-ledger, aura-full-bleed-botanical-divider, aura-contact-card-overlap, aura-portrait-and-process-band. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: aura-consultation-desk-still-life, aura-split-portrait-hero, aura-full-bleed-botanical-divider, aura-contact-card-overlap. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: aura-offset-consultation-ledger, aura-full-bleed-botanical-divider, aura-contact-card-overlap, aura-portrait-and-process-band. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: aura-skin-texture-editorial, aura-offset-consultation-ledger, aura-asymmetric-laser-panel, aura-minimal-legal-ledger. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: aura-laser-light-sequence, aura-editorial-image-chapter, aura-radial-results-map, aura-stacked-proof-column. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-14, public-footer-recipe-aura, public-footer-icons-halo, public-footer-divider-glowline, public-footer-hover-soft-shift, public-footer-shell`; recipe `aura`.
...
- Decorative assets/background: The footer uses a ritual atmosphere footer, local contact hierarchy and concept-specific footer marker `footer-14-aura`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C14-LABEL-001, C14-SITEMAP-001
- Files involved: `concepts/14-aura/partials/footer.html`, `concepts/14-aura/css/style.css`.
...
- Hero/portrait use: business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-aura.webp`.
- Service/botanical/icons: A custom champagne ritual overlays SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/14-aura/assets/animations/motion-path.svg`
- `concepts/14-aura/assets/backgrounds/botanical-background.svg`
- `concepts/14-aura/assets/backgrounds/mobile-menu-background.svg`
- `concepts/14-aura/assets/botanical/botanical-quote.svg`
- `concepts/14-aura/assets/botanical/bronze-branch.svg`
- `concepts/14-aura/assets/botanical/footer-botanical-stamp.svg`
- `concepts/14-aura/assets/botanical/gold-leaf-divider.svg`
- `concepts/14-aura/assets/botanical/monogram-wreath.svg`
- `concepts/14-aura/assets/botanical/sage-botanical-corner.svg`
- `concepts/14-aura/assets/botanical/section-separator.svg`
- `concepts/14-aura/assets/brand/assinatura-1.jpg`
- `concepts/14-aura/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Aura | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Aura concept.`
- H1 pattern: 1 H1 parsed; `Laser care with safety and warmth`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/14-aura/sitemap.html` exists.
...
- What makes it different: It is identified by `champagne ritual overlays`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-aura`, menu `public-menu-layout-soft-overlay`, footer recipe `aura`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `icon tilt controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `15` and `22` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `aura-based trust story.` visual grammar.
...
## 21. Fixes Applied
- C14-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/14-aura/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C14-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/14-aura/sitemap.html`. Verification: Run rg for Brand and education..
