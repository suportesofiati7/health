# Concept 16 - Grace Brief

## 1. Concept Snapshot
- Concept number: 16
- Concept folder path: `concepts/16-grace`
- Files inspected: 40 files, including `concepts/16-grace/index.html`, `concepts/16-grace/css/style.css`, `concepts/16-grace/partials/header.html`, `concepts/16-grace/partials/mobile-menu.html`, `concepts/16-grace/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/16-grace-desktop.png`
- `audit/screenshots/mobile/16-grace-mobile.png`
- `final/homepage-screenshots/desktop/concept-16-grace-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-16-grace-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: graceful portrait-led care translated into a Sofiati visual world, using service shelf labels as the governing asset language.
- Visitor emotion: graceful treatment diary.
...
- How it fits Sofiati: It is identified by `service shelf labels`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: graceful treatment diary.
...
## 4. Layout Signature
- Homepage structure: grace-editorial-image-chapter-hero-01, grace-horizontal-care-journey-pathway-02, grace-full-bleed-botanical-divider-visual-story-03, grace-asymmetric-laser-panel-content-04, grace-radial-results-map-content-05, grace-magazine-article-grid-content-06
- Section rhythm: # 16-grace Page Flow Map Concept strategy: Grace uses graceful treatment diary as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are grace-editorial-image-chapter-hero-01, grace-horizontal-care-journey-pathway-02, grace-full-bleed-botanical-divider-visual-story-03, grace-asymmetric-laser-panel-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-curved`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/16-grace/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a portrait-led service navigation. The header is assigned the unique runtime marker `header-16-grace` and a concept-specific CSS composition.
- Risks: C16-NAV-001
- Files involved: `concepts/16-grace/partials/header.html`, `concepts/16-grace/partials/navigation.html`, `concepts/16-grace/partials/mobile-menu.html`, `concepts/16-grace/css/style.css`, `concepts/16-grace/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/16-grace/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-curved-panel`.
...
- Visual personality: The mobile menu uses a flowing portrait menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Technology guided by clinical judgement`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-grace.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: grace-offset-consultation-ledger, grace-full-bleed-botanical-divider, grace-contact-card-overlap, grace-portrait-and-process-band. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: grace-offset-consultation-ledger, grace-full-bleed-botanical-divider, grace-contact-card-overlap, grace-portrait-and-process-band. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: grace-split-portrait-hero, grace-horizontal-care-journey, grace-magazine-article-grid, grace-floating-note-system. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: grace-offset-consultation-ledger, grace-full-bleed-botanical-divider, grace-contact-card-overlap, grace-portrait-and-process-band. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: grace-horizontal-care-journey, grace-radial-results-map, grace-stacked-proof-column, grace-accordion-guidance-panel. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: grace-contact-card-overlap, grace-floating-note-system, grace-quiet-route-index, grace-laser-light-sequence. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: grace-horizontal-care-journey, grace-radial-results-map, grace-stacked-proof-column, grace-accordion-guidance-panel. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: grace-laser-light-sequence, grace-editorial-image-chapter, grace-radial-results-map, grace-stacked-proof-column. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: grace-horizontal-care-journey, grace-radial-results-map, grace-stacked-proof-column, grace-accordion-guidance-panel. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: grace-split-portrait-hero, grace-horizontal-care-journey, grace-magazine-article-grid, grace-floating-note-system. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: grace-offset-consultation-ledger, grace-full-bleed-botanical-divider, grace-contact-card-overlap, grace-portrait-and-process-band. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-16, public-footer-recipe-grace, public-footer-icons-curve, public-footer-divider-soft-arc, public-footer-hover-opacity-lift, public-footer-shell`; recipe `grace`.
...
- Decorative assets/background: The footer uses a graceful profile footer, local contact hierarchy and concept-specific footer marker `footer-16-grace`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C16-LABEL-001, C16-SITEMAP-001, C16-RENDER-001
- Files involved: `concepts/16-grace/partials/footer.html`, `concepts/16-grace/css/style.css`.
...
- Hero/portrait use: soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-grace.webp`.
- Service/botanical/icons: A custom service shelf labels SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/16-grace/assets/animations/motion-path.svg`
- `concepts/16-grace/assets/backgrounds/botanical-background.svg`
- `concepts/16-grace/assets/backgrounds/mobile-menu-background.svg`
- `concepts/16-grace/assets/botanical/botanical-quote.svg`
- `concepts/16-grace/assets/botanical/bronze-branch.svg`
- `concepts/16-grace/assets/botanical/footer-botanical-stamp.svg`
- `concepts/16-grace/assets/botanical/gold-leaf-divider.svg`
- `concepts/16-grace/assets/botanical/monogram-wreath.svg`
- `concepts/16-grace/assets/botanical/sage-botanical-corner.svg`
- `concepts/16-grace/assets/botanical/section-separator.svg`
- `concepts/16-grace/assets/brand/assinatura-1.jpg`
- `concepts/16-grace/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Grace | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Grace concept.`
- H1 pattern: 1 H1 parsed; `Technology guided by clinical judgement`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/16-grace/sitemap.html` exists.
...
- What makes it different: It is identified by `service shelf labels`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-curved`, menu `public-menu-layout-curved-panel`, footer recipe `grace`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `menu bloom controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `17` and `24` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `graceful treatment diary.` visual grammar.
...
## 21. Fixes Applied
- C16-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/16-grace/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C16-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/16-grace/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C16-NAV-001, C16-RENDER-001
