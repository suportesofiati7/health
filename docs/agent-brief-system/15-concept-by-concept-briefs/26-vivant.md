# Concept 26 - Vivant Brief

## 1. Concept Snapshot
- Concept number: 26
- Concept folder path: `concepts/26-vivant`
- Files inspected: 40 files, including `concepts/26-vivant/index.html`, `concepts/26-vivant/css/style.css`, `concepts/26-vivant/partials/header.html`, `concepts/26-vivant/partials/mobile-menu.html`, `concepts/26-vivant/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/26-vivant-desktop.png`
- `audit/screenshots/mobile/26-vivant-mobile.png`
- `final/homepage-screenshots/desktop/concept-26-vivant-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-26-vivant-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: Harley editorial authority translated into a Sofiati visual world, using editorial authority plaques as the governing asset language.
- Visitor emotion: vivant editorial system.
...
- How it fits Sofiati: It is identified by `editorial authority plaques`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: vivant editorial system.
...
## 4. Layout Signature
- Homepage structure: vivant-portrait-and-process-band-hero-01, vivant-image-led-trust-strip-pathway-02, vivant-accordion-guidance-panel-visual-story-03, vivant-quiet-route-index-content-04, vivant-large-type-statement-content-05, vivant-consultation-desk-still-life-content-06
- Section rhythm: # 26-vivant Page Flow Map Concept strategy: Vivant uses vivant editorial system as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are vivant-portrait-and-process-band-hero-01, vivant-image-led-trust-strip-pathway-02, vivant-accordion-guidance-panel-visual-story-03, vivant-quiet-route-index-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-vivant`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/26-vivant/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a editorial authority header. The header is assigned the unique runtime marker `header-26-vivant` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/26-vivant/partials/header.html`, `concepts/26-vivant/partials/navigation.html`, `concepts/26-vivant/partials/mobile-menu.html`, `concepts/26-vivant/css/style.css`, `concepts/26-vivant/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/26-vivant/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-animated-full`.
...
- Visual personality: The mobile menu uses a article menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Personalised protocols for considered results`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-vivant.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: vivant-floating-note-system, vivant-accordion-guidance-panel, vivant-skin-texture-editorial, vivant-editorial-image-chapter. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: vivant-floating-note-system, vivant-accordion-guidance-panel, vivant-skin-texture-editorial, vivant-editorial-image-chapter. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: vivant-stacked-proof-column, vivant-image-led-trust-strip, vivant-consultation-desk-still-life, vivant-offset-consultation-ledger. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: vivant-floating-note-system, vivant-accordion-guidance-panel, vivant-skin-texture-editorial, vivant-editorial-image-chapter. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: vivant-image-led-trust-strip, vivant-large-type-statement, vivant-split-portrait-hero, vivant-full-bleed-botanical-divider. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: vivant-skin-texture-editorial, vivant-offset-consultation-ledger, vivant-asymmetric-laser-panel, vivant-minimal-legal-ledger. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: vivant-image-led-trust-strip, vivant-large-type-statement, vivant-split-portrait-hero, vivant-full-bleed-botanical-divider. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: vivant-minimal-legal-ledger, vivant-portrait-and-process-band, vivant-large-type-statement, vivant-split-portrait-hero. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: vivant-image-led-trust-strip, vivant-large-type-statement, vivant-split-portrait-hero, vivant-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: vivant-stacked-proof-column, vivant-image-led-trust-strip, vivant-consultation-desk-still-life, vivant-offset-consultation-ledger. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: vivant-floating-note-system, vivant-accordion-guidance-panel, vivant-skin-texture-editorial, vivant-editorial-image-chapter. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-26, public-footer-recipe-vivant, public-footer-icons-arrow, public-footer-divider-motion-line, public-footer-hover-left-indent, public-footer-shell`; recipe `vivant`.
...
- Decorative assets/background: The footer uses a Harley-style footer, local contact hierarchy and concept-specific footer marker `footer-26-vivant`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C26-LABEL-001, C26-SITEMAP-001, C26-RENDER-001
- Files involved: `concepts/26-vivant/partials/footer.html`, `concepts/26-vivant/css/style.css`.
...
- Hero/portrait use: soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-vivant.webp`.
- Service/botanical/icons: A custom editorial authority plaques SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/26-vivant/assets/animations/motion-path.svg`
- `concepts/26-vivant/assets/backgrounds/botanical-background.svg`
- `concepts/26-vivant/assets/backgrounds/mobile-menu-background.svg`
- `concepts/26-vivant/assets/botanical/botanical-quote.svg`
- `concepts/26-vivant/assets/botanical/bronze-branch.svg`
- `concepts/26-vivant/assets/botanical/footer-botanical-stamp.svg`
- `concepts/26-vivant/assets/botanical/gold-leaf-divider.svg`
- `concepts/26-vivant/assets/botanical/monogram-wreath.svg`
- `concepts/26-vivant/assets/botanical/sage-botanical-corner.svg`
- `concepts/26-vivant/assets/botanical/section-separator.svg`
- `concepts/26-vivant/assets/brand/assinatura-1.jpg`
- `concepts/26-vivant/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Vivant | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Vivant concept.`
- H1 pattern: 1 H1 parsed; `Personalised protocols for considered results`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/26-vivant/sitemap.html` exists.
...
- What makes it different: It is identified by `editorial authority plaques`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-vivant`, menu `public-menu-layout-animated-full`, footer recipe `vivant`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `menu bloom controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `27` and `34` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `vivant editorial system.` visual grammar.
...
## 21. Fixes Applied
- C26-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/26-vivant/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C26-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/26-vivant/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C26-RENDER-001
