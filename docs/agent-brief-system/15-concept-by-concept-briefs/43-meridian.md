# Concept 43 - Meridian Brief

## 1. Concept Snapshot
- Concept number: 43
- Concept folder path: `concepts/43-meridian`
- Files inspected: 40 files, including `concepts/43-meridian/index.html`, `concepts/43-meridian/css/style.css`, `concepts/43-meridian/partials/header.html`, `concepts/43-meridian/partials/mobile-menu.html`, `concepts/43-meridian/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/43-meridian-desktop.png`
- `audit/screenshots/mobile/43-meridian-mobile.png`
- `final/homepage-screenshots/desktop/concept-43-meridian-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-43-meridian-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: luxury maison skincare translated into a Sofiati visual world, using maison collection crests as the governing asset language.
- Visitor emotion: meridian structured journey.
...
- How it fits Sofiati: It is identified by `maison collection crests`, portrait treatment `sage duotone editorial profile tile`, motion `portrait lift`, form `botanical framed form` and footer `signature seal footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: meridian structured journey.
...
## 4. Layout Signature
- Homepage structure: meridian-minimal-legal-ledger-hero-01, meridian-stacked-proof-column-visual-story-02, meridian-floating-note-system-content-03, meridian-portrait-and-process-band-content-04, meridian-image-led-trust-strip-pathway-05, meridian-accordion-guidance-panel-content-06
- Section rhythm: # 43-meridian Page Flow Map Concept strategy: Meridian uses meridian structured journey as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are meridian-minimal-legal-ledger-hero-01, meridian-stacked-proof-column-visual-story-02, meridian-floating-note-system-content-03, meridian-portrait-and-process-band-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-meridian`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/43-meridian/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a maison header. The header is assigned the unique runtime marker `header-43-meridian` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/43-meridian/partials/header.html`, `concepts/43-meridian/partials/navigation.html`, `concepts/43-meridian/partials/mobile-menu.html`, `concepts/43-meridian/css/style.css`, `concepts/43-meridian/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/43-meridian/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-meridian-drawer`.
...
- Visual personality: The mobile menu uses a collection menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Professional care with botanical softness`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is sage duotone editorial profile tile, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-meridian.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: meridian-contact-card-overlap, meridian-floating-note-system, meridian-quiet-route-index, meridian-laser-light-sequence. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: meridian-contact-card-overlap, meridian-floating-note-system, meridian-quiet-route-index, meridian-laser-light-sequence. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: meridian-magazine-article-grid, meridian-stacked-proof-column, meridian-accordion-guidance-panel, meridian-skin-texture-editorial. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: meridian-contact-card-overlap, meridian-floating-note-system, meridian-quiet-route-index, meridian-laser-light-sequence. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: meridian-stacked-proof-column, meridian-image-led-trust-strip, meridian-consultation-desk-still-life, meridian-offset-consultation-ledger. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: meridian-quiet-route-index, meridian-skin-texture-editorial, meridian-editorial-image-chapter, meridian-radial-results-map. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: meridian-stacked-proof-column, meridian-image-led-trust-strip, meridian-consultation-desk-still-life, meridian-offset-consultation-ledger. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: meridian-radial-results-map, meridian-minimal-legal-ledger, meridian-image-led-trust-strip, meridian-consultation-desk-still-life. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: meridian-stacked-proof-column, meridian-image-led-trust-strip, meridian-consultation-desk-still-life, meridian-offset-consultation-ledger. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: meridian-magazine-article-grid, meridian-stacked-proof-column, meridian-accordion-guidance-panel, meridian-skin-texture-editorial. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: meridian-contact-card-overlap, meridian-floating-note-system, meridian-quiet-route-index, meridian-laser-light-sequence. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-43, public-footer-recipe-meridian, public-footer-icons-compass, public-footer-divider-centerline, public-footer-hover-left-indent, public-footer-shell`; recipe `meridian`.
...
- Decorative assets/background: The footer uses a maison footer, local contact hierarchy and concept-specific footer marker `footer-43-meridian`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C43-LABEL-001, C43-SITEMAP-001, C43-RENDER-001
- Files involved: `concepts/43-meridian/partials/footer.html`, `concepts/43-meridian/css/style.css`.
...
- Hero/portrait use: sage duotone editorial profile tile, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-meridian.webp`.
- Service/botanical/icons: A custom maison collection crests SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/43-meridian/assets/animations/motion-path.svg`
- `concepts/43-meridian/assets/backgrounds/botanical-background.svg`
- `concepts/43-meridian/assets/backgrounds/mobile-menu-background.svg`
- `concepts/43-meridian/assets/botanical/botanical-quote.svg`
- `concepts/43-meridian/assets/botanical/bronze-branch.svg`
- `concepts/43-meridian/assets/botanical/footer-botanical-stamp.svg`
- `concepts/43-meridian/assets/botanical/gold-leaf-divider.svg`
- `concepts/43-meridian/assets/botanical/monogram-wreath.svg`
- `concepts/43-meridian/assets/botanical/sage-botanical-corner.svg`
- `concepts/43-meridian/assets/botanical/section-separator.svg`
- `concepts/43-meridian/assets/brand/assinatura-1.jpg`
- `concepts/43-meridian/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Meridian | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Meridian concept.`
- H1 pattern: 1 H1 parsed; `Professional care with botanical softness`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/43-meridian/sitemap.html` exists.
...
- What makes it different: It is identified by `maison collection crests`, portrait treatment `sage duotone editorial profile tile`, motion `portrait lift`, form `botanical framed form` and footer `signature seal footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-meridian`, menu `public-menu-layout-meridian-drawer`, footer recipe `meridian`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `portrait lift controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `44` and `01` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `meridian structured journey.` visual grammar.
...
## 21. Fixes Applied
- C43-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/43-meridian/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C43-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/43-meridian/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C43-RENDER-001
