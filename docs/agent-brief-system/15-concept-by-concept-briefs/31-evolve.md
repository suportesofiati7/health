# Concept 31 - Evolve Brief

## 1. Concept Snapshot
- Concept number: 31
- Concept folder path: `concepts/31-evolve`
- Files inspected: 40 files, including `concepts/31-evolve/index.html`, `concepts/31-evolve/css/style.css`, `concepts/31-evolve/partials/header.html`, `concepts/31-evolve/partials/mobile-menu.html`, `concepts/31-evolve/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/31-evolve-desktop.png`
- `audit/screenshots/mobile/31-evolve-mobile.png`
- `final/homepage-screenshots/desktop/concept-31-evolve-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-31-evolve-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: confidence transformation narrative translated into a Sofiati visual world, using confidence timeline leaves as the governing asset language.
- Visitor emotion: evolving care notebook.
...
- How it fits Sofiati: It is identified by `confidence timeline leaves`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: evolving care notebook.
...
## 4. Layout Signature
- Homepage structure: evolve-consultation-desk-still-life-hero-01, evolve-skin-texture-editorial-pathway-02, evolve-laser-light-sequence-content-03, evolve-split-portrait-hero-content-04, evolve-offset-consultation-ledger-visual-story-05, evolve-editorial-image-chapter-content-06
- Section rhythm: # 31-evolve Page Flow Map Concept strategy: Evolve uses evolving care notebook as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are evolve-consultation-desk-still-life-hero-01, evolve-skin-texture-editorial-pathway-02, evolve-laser-light-sequence-content-03, evolve-split-portrait-hero-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-evolve`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/31-evolve/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a authority hero header. The header is assigned the unique runtime marker `header-31-evolve` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/31-evolve/partials/header.html`, `concepts/31-evolve/partials/navigation.html`, `concepts/31-evolve/partials/mobile-menu.html`, `concepts/31-evolve/css/style.css`, `concepts/31-evolve/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/31-evolve/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-animated-reveal`.
...
- Visual personality: The mobile menu uses a confidence menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Advanced care with ethical boundaries`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-evolve.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: evolve-large-type-statement, evolve-laser-light-sequence, evolve-horizontal-care-journey, evolve-magazine-article-grid. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: evolve-large-type-statement, evolve-laser-light-sequence, evolve-horizontal-care-journey, evolve-magazine-article-grid. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: evolve-quiet-route-index, evolve-skin-texture-editorial, evolve-editorial-image-chapter, evolve-radial-results-map. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: evolve-large-type-statement, evolve-laser-light-sequence, evolve-horizontal-care-journey, evolve-magazine-article-grid. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: evolve-skin-texture-editorial, evolve-offset-consultation-ledger, evolve-asymmetric-laser-panel, evolve-minimal-legal-ledger. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: evolve-horizontal-care-journey, evolve-radial-results-map, evolve-stacked-proof-column, evolve-accordion-guidance-panel. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: evolve-skin-texture-editorial, evolve-offset-consultation-ledger, evolve-asymmetric-laser-panel, evolve-minimal-legal-ledger. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: evolve-accordion-guidance-panel, evolve-consultation-desk-still-life, evolve-offset-consultation-ledger, evolve-asymmetric-laser-panel. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: evolve-skin-texture-editorial, evolve-offset-consultation-ledger, evolve-asymmetric-laser-panel, evolve-minimal-legal-ledger. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: evolve-quiet-route-index, evolve-skin-texture-editorial, evolve-editorial-image-chapter, evolve-radial-results-map. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: evolve-large-type-statement, evolve-laser-light-sequence, evolve-horizontal-care-journey, evolve-magazine-article-grid. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-31, public-footer-recipe-evolve, public-footer-icons-arrow, public-footer-divider-motion-line, public-footer-hover-gold-sweep, public-footer-shell`; recipe `evolve`.
...
- Decorative assets/background: The footer uses a authority footer, local contact hierarchy and concept-specific footer marker `footer-31-evolve`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C31-LABEL-001, C31-SITEMAP-001, C31-RENDER-001, C31-RENDER-002
- Files involved: `concepts/31-evolve/partials/footer.html`, `concepts/31-evolve/css/style.css`.
...
- Primary colors: #A2AE9F, #798A80, #F3EFE5, #F8F4EA, #F8F7F2, #9A6B35, #FDE3B0, #252321, #706B63, #1F2825
...
- Hero/portrait use: arched ivory portrait with bronze pressed-leaf edge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-evolve.webp`.
- Service/botanical/icons: A custom confidence timeline leaves SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/31-evolve/assets/animations/motion-path.svg`
- `concepts/31-evolve/assets/backgrounds/botanical-background.svg`
- `concepts/31-evolve/assets/backgrounds/mobile-menu-background.svg`
- `concepts/31-evolve/assets/botanical/botanical-quote.svg`
- `concepts/31-evolve/assets/botanical/bronze-branch.svg`
- `concepts/31-evolve/assets/botanical/footer-botanical-stamp.svg`
- `concepts/31-evolve/assets/botanical/gold-leaf-divider.svg`
- `concepts/31-evolve/assets/botanical/monogram-wreath.svg`
- `concepts/31-evolve/assets/botanical/sage-botanical-corner.svg`
- `concepts/31-evolve/assets/botanical/section-separator.svg`
- `concepts/31-evolve/assets/brand/assinatura-1.jpg`
- `concepts/31-evolve/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Evolve | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Evolve concept.`
- H1 pattern: 1 H1 parsed; `Advanced care with ethical boundaries`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/31-evolve/sitemap.html` exists.
...
- What makes it different: It is identified by `confidence timeline leaves`, portrait treatment `arched ivory portrait with bronze pressed-leaf edge`, motion `line reveal`, form `minimal ivory form` and footer `business-card footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-evolve`, menu `public-menu-layout-animated-reveal`, footer recipe `evolve`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `line reveal controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `32` and `39` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `evolving care notebook.` visual grammar.
...
## 21. Fixes Applied
- C31-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/31-evolve/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C31-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/31-evolve/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C31-RENDER-001, C31-RENDER-002
