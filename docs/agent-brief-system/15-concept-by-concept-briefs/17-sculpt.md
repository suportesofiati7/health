# Concept 17 - Sculpt Brief

## 1. Concept Snapshot
- Concept number: 17
- Concept folder path: `concepts/17-sculpt`
- Files inspected: 40 files, including `concepts/17-sculpt/index.html`, `concepts/17-sculpt/css/style.css`, `concepts/17-sculpt/partials/header.html`, `concepts/17-sculpt/partials/mobile-menu.html`, `concepts/17-sculpt/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/17-sculpt-desktop.png`
- `audit/screenshots/mobile/17-sculpt-mobile.png`
- `final/homepage-screenshots/desktop/concept-17-sculpt-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-17-sculpt-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: shape-led contour composition translated into a Sofiati visual world, using local branch contact marks as the governing asset language.
- Visitor emotion: sculpted process system.
...
- How it fits Sofiati: It is identified by `local branch contact marks`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: sculpted process system.
...
## 4. Layout Signature
- Homepage structure: sculpt-horizontal-care-journey-hero-01, sculpt-full-bleed-botanical-divider-content-02, sculpt-asymmetric-laser-panel-visual-story-03, sculpt-magazine-article-grid-contextual-journey, sculpt-magazine-article-grid-consultation-form-05, sculpt-contact-card-overlap-pathway-06
- Section rhythm: # 17-sculpt Page Flow Map Concept strategy: Sculpt uses sculpted process system as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are sculpt-horizontal-care-journey-hero-01, sculpt-full-bleed-botanical-divider-content-02, sculpt-asymmetric-laser-panel-visual-story-03, sculpt-magazine-article-grid-contextual-journey
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-sculptural`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/17-sculpt/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a contour location header. The header is assigned the unique runtime marker `header-17-sculpt` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/17-sculpt/partials/header.html`, `concepts/17-sculpt/partials/navigation.html`, `concepts/17-sculpt/partials/mobile-menu.html`, `concepts/17-sculpt/css/style.css`, `concepts/17-sculpt/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/17-sculpt/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-geometric-layer`.
...
- Visual personality: The mobile menu uses a layered contour menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `A quiet studio for advanced care`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-sculpt.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: sculpt-editorial-image-chapter, sculpt-asymmetric-laser-panel, sculpt-minimal-legal-ledger, sculpt-image-led-trust-strip. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: sculpt-editorial-image-chapter, sculpt-asymmetric-laser-panel, sculpt-minimal-legal-ledger, sculpt-image-led-trust-strip. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: sculpt-offset-consultation-ledger, sculpt-full-bleed-botanical-divider, sculpt-contact-card-overlap, sculpt-portrait-and-process-band. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: sculpt-editorial-image-chapter, sculpt-asymmetric-laser-panel, sculpt-minimal-legal-ledger, sculpt-image-led-trust-strip. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: sculpt-full-bleed-botanical-divider, sculpt-magazine-article-grid, sculpt-floating-note-system, sculpt-quiet-route-index. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: sculpt-minimal-legal-ledger, sculpt-portrait-and-process-band, sculpt-large-type-statement, sculpt-split-portrait-hero. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: sculpt-full-bleed-botanical-divider, sculpt-magazine-article-grid, sculpt-floating-note-system, sculpt-quiet-route-index. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: sculpt-split-portrait-hero, sculpt-horizontal-care-journey, sculpt-magazine-article-grid, sculpt-floating-note-system. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: sculpt-full-bleed-botanical-divider, sculpt-magazine-article-grid, sculpt-floating-note-system, sculpt-quiet-route-index. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: sculpt-offset-consultation-ledger, sculpt-full-bleed-botanical-divider, sculpt-contact-card-overlap, sculpt-portrait-and-process-band. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: sculpt-editorial-image-chapter, sculpt-asymmetric-laser-panel, sculpt-minimal-legal-ledger, sculpt-image-led-trust-strip. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-17, public-footer-recipe-sculpt, public-footer-icons-angle, public-footer-divider-diagonal, public-footer-hover-left-indent, public-footer-shell`; recipe `sculpt`.
...
- Decorative assets/background: The footer uses a dimensional unit footer, local contact hierarchy and concept-specific footer marker `footer-17-sculpt`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C17-LABEL-001, C17-SITEMAP-001, C17-RENDER-001
- Files involved: `concepts/17-sculpt/partials/footer.html`, `concepts/17-sculpt/css/style.css`.
...
- Hero/portrait use: clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-sculpt.webp`.
- Service/botanical/icons: A custom local branch contact marks SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/17-sculpt/assets/animations/motion-path.svg`
- `concepts/17-sculpt/assets/backgrounds/botanical-background.svg`
- `concepts/17-sculpt/assets/backgrounds/mobile-menu-background.svg`
- `concepts/17-sculpt/assets/botanical/botanical-quote.svg`
- `concepts/17-sculpt/assets/botanical/bronze-branch.svg`
- `concepts/17-sculpt/assets/botanical/footer-botanical-stamp.svg`
- `concepts/17-sculpt/assets/botanical/gold-leaf-divider.svg`
- `concepts/17-sculpt/assets/botanical/monogram-wreath.svg`
- `concepts/17-sculpt/assets/botanical/sage-botanical-corner.svg`
- `concepts/17-sculpt/assets/botanical/section-separator.svg`
- `concepts/17-sculpt/assets/brand/assinatura-1.jpg`
- `concepts/17-sculpt/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Sculpt | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Sculpt concept.`
- H1 pattern: 1 H1 parsed; `A quiet studio for advanced care`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/17-sculpt/sitemap.html` exists.
...
- What makes it different: It is identified by `local branch contact marks`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-sculptural`, menu `public-menu-layout-geometric-layer`, footer recipe `sculpt`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `divider trace controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `18` and `25` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `sculpted process system.` visual grammar.
...
### C17-MOBILE-001
- Page/component: homepage/header/footer / Mobile header overflow
...
## 21. Fixes Applied
- C17-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/17-sculpt/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C17-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/17-sculpt/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C17-MOBILE-001, C17-RENDER-001
