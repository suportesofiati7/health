# Concept 09 - Radiance Brief

## 1. Concept Snapshot
- Concept number: 09
- Concept folder path: `concepts/09-radiance`
- Files inspected: 40 files, including `concepts/09-radiance/index.html`, `concepts/09-radiance/css/style.css`, `concepts/09-radiance/partials/header.html`, `concepts/09-radiance/partials/mobile-menu.html`, `concepts/09-radiance/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/09-radiance-desktop.png`
- `audit/screenshots/mobile/09-radiance-mobile.png`
- `final/homepage-screenshots/desktop/concept-09-radiance-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-09-radiance-home-mobile.png`
- Status: needs review
- Confidence level: high

## 2. Concept Purpose
- Intended impression: airy radiant light landing translated into a Sofiati visual world, using consultation studio badges as the governing asset language.
- Visitor emotion: light-washed skin journal.
...
- How it fits Sofiati: It is identified by `consultation studio badges`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: light-washed skin journal.
...
## 4. Layout Signature
- Homepage structure: radiance-quiet-route-index-hero-01, radiance-large-type-statement-content-02, radiance-consultation-desk-still-life-content-03, radiance-skin-texture-editorial-content-04, radiance-laser-light-sequence-pathway-05, radiance-split-portrait-hero-visual-story-06
- Section rhythm: # 09-radiance Page Flow Map Concept strategy: Radiance uses light-washed skin journal as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are radiance-quiet-route-index-hero-01, radiance-large-type-statement-content-02, radiance-consultation-desk-still-life-content-03, radiance-skin-texture-editorial-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-editorial`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/09-radiance/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a floating light appointment header. The header is assigned the unique runtime marker `header-09-radiance` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/09-radiance/partials/header.html`, `concepts/09-radiance/partials/navigation.html`, `concepts/09-radiance/partials/mobile-menu.html`, `concepts/09-radiance/css/style.css`, `concepts/09-radiance/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/09-radiance/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-soft-gradient`.
...
- Visual personality: The mobile menu uses a bronze light menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Clinical precision with a softer rhythm`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-radiance.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: radiance-accordion-guidance-panel, radiance-consultation-desk-still-life, radiance-offset-consultation-ledger, radiance-asymmetric-laser-panel. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: radiance-accordion-guidance-panel, radiance-consultation-desk-still-life, radiance-offset-consultation-ledger, radiance-asymmetric-laser-panel. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: radiance-image-led-trust-strip, radiance-large-type-statement, radiance-split-portrait-hero, radiance-full-bleed-botanical-divider. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: radiance-accordion-guidance-panel, radiance-consultation-desk-still-life, radiance-offset-consultation-ledger, radiance-asymmetric-laser-panel. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: radiance-large-type-statement, radiance-laser-light-sequence, radiance-horizontal-care-journey, radiance-magazine-article-grid. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: radiance-offset-consultation-ledger, radiance-full-bleed-botanical-divider, radiance-contact-card-overlap, radiance-portrait-and-process-band. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: radiance-large-type-statement, radiance-laser-light-sequence, radiance-horizontal-care-journey, radiance-magazine-article-grid. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: radiance-portrait-and-process-band, radiance-quiet-route-index, radiance-laser-light-sequence, radiance-horizontal-care-journey. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: radiance-large-type-statement, radiance-laser-light-sequence, radiance-horizontal-care-journey, radiance-magazine-article-grid. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: radiance-image-led-trust-strip, radiance-large-type-statement, radiance-split-portrait-hero, radiance-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: radiance-accordion-guidance-panel, radiance-consultation-desk-still-life, radiance-offset-consultation-ledger, radiance-asymmetric-laser-panel. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-09, public-footer-recipe-radiance, public-footer-icons-sun, public-footer-divider-topline, public-footer-hover-gold-sweep, public-footer-shell`; recipe `radiance`.
...
- Decorative assets/background: The footer uses a radiant magazine footer, local contact hierarchy and concept-specific footer marker `footer-09-radiance`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C09-LABEL-001, C09-SITEMAP-001, C09-RENDER-001
- Files involved: `concepts/09-radiance/partials/footer.html`, `concepts/09-radiance/css/style.css`.
...
- Hero/portrait use: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-radiance.webp`.
- Service/botanical/icons: A custom consultation studio badges SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/09-radiance/assets/animations/motion-path.svg`
- `concepts/09-radiance/assets/backgrounds/botanical-background.svg`
- `concepts/09-radiance/assets/backgrounds/mobile-menu-background.svg`
- `concepts/09-radiance/assets/botanical/botanical-quote.svg`
- `concepts/09-radiance/assets/botanical/bronze-branch.svg`
- `concepts/09-radiance/assets/botanical/footer-botanical-stamp.svg`
- `concepts/09-radiance/assets/botanical/gold-leaf-divider.svg`
- `concepts/09-radiance/assets/botanical/monogram-wreath.svg`
- `concepts/09-radiance/assets/botanical/sage-botanical-corner.svg`
- `concepts/09-radiance/assets/botanical/section-separator.svg`
- `concepts/09-radiance/assets/brand/assinatura-1.jpg`
- `concepts/09-radiance/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Radiance | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Radiance concept.`
- H1 pattern: 1 H1 parsed; `Clinical precision with a softer rhythm`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/09-radiance/sitemap.html` exists.
...
- What makes it different: It is identified by `consultation studio badges`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-editorial`, menu `public-menu-layout-soft-gradient`, footer recipe `radiance`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `journal card rise controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `10` and `17` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `light-washed skin journal.` visual grammar.
...
## 21. Fixes Applied
- C09-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/09-radiance/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C09-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/09-radiance/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: needs review
- Confidence level: high
- Remaining issues: C09-RENDER-001
