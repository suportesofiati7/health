# Concept 46 - Curate Brief

## 1. Concept Snapshot
- Concept number: 46
- Concept folder path: `concepts/46-curate`
- Files inspected: 40 files, including `concepts/46-curate/index.html`, `concepts/46-curate/css/style.css`, `concepts/46-curate/partials/header.html`, `concepts/46-curate/partials/mobile-menu.html`, `concepts/46-curate/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/46-curate-desktop.png`
- `audit/screenshots/mobile/46-curate-mobile.png`
- `final/homepage-screenshots/desktop/concept-46-curate-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-46-curate-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: spa menu curation translated into a Sofiati visual world, using spa menu botanical tabs as the governing asset language.
- Visitor emotion: curated consultation guide.
...
- How it fits Sofiati: It is identified by `spa menu botanical tabs`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: curated consultation guide.
...
## 4. Layout Signature
- Homepage structure: curate-portrait-and-process-band-hero-01, curate-image-led-trust-strip-pathway-02, curate-accordion-guidance-panel-visual-story-03, curate-quiet-route-index-content-04, curate-large-type-statement-content-05, curate-consultation-desk-still-life-content-06
- Section rhythm: # 46-curate Page Flow Map Concept strategy: Curate uses curated consultation guide as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are curate-portrait-and-process-band-hero-01, curate-image-led-trust-strip-pathway-02, curate-accordion-guidance-panel-visual-story-03, curate-quiet-route-index-content-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-curate`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/46-curate/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a spa services header. The header is assigned the unique runtime marker `header-46-curate` and a concept-specific CSS composition.
- Risks: C46-NAV-001
- Files involved: `concepts/46-curate/partials/header.html`, `concepts/46-curate/partials/navigation.html`, `concepts/46-curate/partials/mobile-menu.html`, `concepts/46-curate/css/style.css`, `concepts/46-curate/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/46-curate/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-boutique-selection`.
...
- Visual personality: The mobile menu uses a spa treatment menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Aesthetic decisions with clinical clarity`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-curate.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: curate-floating-note-system, curate-accordion-guidance-panel, curate-skin-texture-editorial, curate-editorial-image-chapter. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: curate-floating-note-system, curate-accordion-guidance-panel, curate-skin-texture-editorial, curate-editorial-image-chapter. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: curate-stacked-proof-column, curate-image-led-trust-strip, curate-consultation-desk-still-life, curate-offset-consultation-ledger. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: curate-floating-note-system, curate-accordion-guidance-panel, curate-skin-texture-editorial, curate-editorial-image-chapter. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: curate-image-led-trust-strip, curate-large-type-statement, curate-split-portrait-hero, curate-full-bleed-botanical-divider. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: curate-skin-texture-editorial, curate-offset-consultation-ledger, curate-asymmetric-laser-panel, curate-minimal-legal-ledger. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: curate-image-led-trust-strip, curate-large-type-statement, curate-split-portrait-hero, curate-full-bleed-botanical-divider. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: curate-minimal-legal-ledger, curate-portrait-and-process-band, curate-large-type-statement, curate-split-portrait-hero. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: curate-image-led-trust-strip, curate-large-type-statement, curate-split-portrait-hero, curate-full-bleed-botanical-divider. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: curate-stacked-proof-column, curate-image-led-trust-strip, curate-consultation-desk-still-life, curate-offset-consultation-ledger. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: curate-floating-note-system, curate-accordion-guidance-panel, curate-skin-texture-editorial, curate-editorial-image-chapter. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-46, public-footer-recipe-curate, public-footer-icons-bracket, public-footer-divider-champagne-rule, public-footer-hover-gold-sweep, public-footer-shell`; recipe `curate`.
...
- Decorative assets/background: The footer uses a spa footer, local contact hierarchy and concept-specific footer marker `footer-46-curate`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C46-LABEL-001, C46-SITEMAP-001, C46-RENDER-001, C46-RENDER-002
- Files involved: `concepts/46-curate/partials/footer.html`, `concepts/46-curate/css/style.css`.
...
- Hero/portrait use: soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-curate.webp`.
- Service/botanical/icons: A custom spa menu botanical tabs SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/46-curate/assets/animations/motion-path.svg`
- `concepts/46-curate/assets/backgrounds/botanical-background.svg`
- `concepts/46-curate/assets/backgrounds/mobile-menu-background.svg`
- `concepts/46-curate/assets/botanical/botanical-quote.svg`
- `concepts/46-curate/assets/botanical/bronze-branch.svg`
- `concepts/46-curate/assets/botanical/footer-botanical-stamp.svg`
- `concepts/46-curate/assets/botanical/gold-leaf-divider.svg`
- `concepts/46-curate/assets/botanical/monogram-wreath.svg`
- `concepts/46-curate/assets/botanical/sage-botanical-corner.svg`
- `concepts/46-curate/assets/botanical/section-separator.svg`
- `concepts/46-curate/assets/brand/assinatura-1.jpg`
- `concepts/46-curate/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Curate | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Curate concept.`
- H1 pattern: 1 H1 parsed; `Aesthetic decisions with clinical clarity`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/46-curate/sitemap.html` exists.
...
- What makes it different: It is identified by `spa menu botanical tabs`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-curate`, menu `public-menu-layout-boutique-selection`, footer recipe `curate`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `menu bloom controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `47` and `04` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `curated consultation guide.` visual grammar.
...
## 21. Fixes Applied
- C46-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/46-curate/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C46-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/46-curate/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C46-NAV-001, C46-RENDER-001, C46-RENDER-002
