# Concept 18 - Lumin Brief

## 1. Concept Snapshot
- Concept number: 18
- Concept folder path: `concepts/18-lumin`
- Files inspected: 40 files, including `concepts/18-lumin/index.html`, `concepts/18-lumin/css/style.css`, `concepts/18-lumin/partials/header.html`, `concepts/18-lumin/partials/mobile-menu.html`, `concepts/18-lumin/partials/footer.html`, and planning docs.
- Missing expected files: none
- Screenshots inspected/available:
- `audit/screenshots/desktop/18-lumin-desktop.png`
- `audit/screenshots/mobile/18-lumin-mobile.png`
- `final/homepage-screenshots/desktop/concept-18-lumin-home-desktop.png`
- `final/homepage-screenshots/mobile/concept-18-lumin-home-mobile.png`
- Status: high risk
- Confidence level: high

## 2. Concept Purpose
- Intended impression: translucent light clinic suite translated into a Sofiati visual world, using high-contrast clinic strokes as the governing asset language.
- Visitor emotion: luminous technology narrative.
...
- How it fits Sofiati: It is identified by `high-contrast clinic strokes`, portrait treatment `champagne line portrait seal`, motion `form focus glow`, form `business-card form` and footer `bronze strip footer`. The HTML, CSS and JS include unique markers for this concept.

## 3. Visual Personality
- Mood: luminous technology narrative.
...
## 4. Layout Signature
- Homepage structure: lumin-full-bleed-botanical-divider-hero-01, lumin-asymmetric-laser-panel-content-02, lumin-radial-results-map-content-03, lumin-magazine-article-grid-visual-story-04, lumin-contact-card-overlap-pathway-05, lumin-minimal-legal-ledger-content-06
- Section rhythm: # 18-lumin Page Flow Map Concept strategy: Lumin uses luminous technology narrative as its page-flow lens. Same facts, distinct rhythm.
...
- Use of split layouts/image blocks: first homepage layout signatures are lumin-full-bleed-botanical-divider-hero-01, lumin-asymmetric-laser-panel-content-02, lumin-radial-results-map-content-03, lumin-magazine-article-grid-visual-story-04
...
## 5. Header Signature
- Logo placement: header class tokens `public-header-layout-glass`; brand mark path appears in header partial.
- Desktop nav structure: labels parsed as Home, About, Care, Laser, Skin, Results, Consultation, Contact, Home, About, Care, Laser.
- Nav spacing: controlled by `concepts/18-lumin/css/style.css` around `.public-header`, `.desktop-nav`, and concept header layout classes.
...
- Background behavior: This concept uses a luminous split header. The header is assigned the unique runtime marker `header-18-lumin` and a concept-specific CSS composition.
- Risks: no active header issue recorded
- Files involved: `concepts/18-lumin/partials/header.html`, `concepts/18-lumin/partials/navigation.html`, `concepts/18-lumin/partials/mobile-menu.html`, `concepts/18-lumin/css/style.css`, `concepts/18-lumin/js/main.js`.

## 6. Mobile Menu Signature
- Trigger style: `.public-menu-button` / `[data-menu-toggle]` in the header partial.
- Menu opening style: local JS in `concepts/18-lumin/js/main.js` toggles the `#mobile-menu` state.
- Layout: menu class tokens `public-menu-layout-frosted-glass`.
...
- Visual personality: The mobile menu uses a translucent panel menu with local JavaScript in `js/main.js`, local partial loading in `js/partials.js` and local markup in `partials/mobile-menu.html`.
...
- Heading style: homepage H1 is `Evaluation-led care for skin quality`.
...
- Cropping risks: image refs and object-fit rules in CSS must be preserved; portrait concept is champagne line portrait seal, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-lumin.webp`..
...
- Home: Introduce evaluation-led aesthetic biomedicine, orient visitors, and move them calmly toward consultation. Layout rhythm: lumin-horizontal-care-journey, lumin-radial-results-map, lumin-stacked-proof-column, lumin-accordion-guidance-panel. Internal links: about.html, care.html, laser.html, skin.html, results.html, values.html, mission.html, faq.html, journal.html, blog.html, consultation.html, contact.html.
- About: Build trust around Franciele's professional identity, credentials, care philosophy, and ethical boundaries. Layout rhythm: lumin-horizontal-care-journey, lumin-radial-results-map, lumin-stacked-proof-column, lumin-accordion-guidance-panel. Internal links: mission.html, values.html, care.html, laser.html, skin.html, results.html, consultation.html, contact.html.
- Care: Explain how personalised care moves from evaluation to planning, aftercare, and responsible expectations. Layout rhythm: lumin-editorial-image-chapter, lumin-asymmetric-laser-panel, lumin-minimal-legal-ledger, lumin-image-led-trust-strip. Internal links: consultation.html, laser.html, skin.html, results.html, faq.html, journal.html, blog.html.
- Laser: Frame laser care through suitability, preparation, technology, aftercare, and realistic outcomes. Layout rhythm: lumin-horizontal-care-journey, lumin-radial-results-map, lumin-stacked-proof-column, lumin-accordion-guidance-panel. Internal links: consultation.html, care.html, skin.html, results.html, faq.html, journal.html, blog.html.
...
- Results: Set responsible expectations without promises, fake outcomes, or pressure-based conversion. Layout rhythm: lumin-asymmetric-laser-panel, lumin-contact-card-overlap, lumin-portrait-and-process-band, lumin-large-type-statement. Internal links: consultation.html, care.html, laser.html, skin.html, testimonials.html, faq.html, legal.html, privacy.html.
- Consultation: Help visitors request evaluation with clear expectations, privacy notes, and useful preparation. Layout rhythm: lumin-stacked-proof-column, lumin-image-led-trust-strip, lumin-consultation-desk-still-life, lumin-offset-consultation-ledger. Internal links: care.html, laser.html, skin.html, results.html, faq.html, privacy.html, contact.html.
- Contact: Make approved contact routes clear while keeping care decisions evaluation-led. Layout rhythm: lumin-asymmetric-laser-panel, lumin-contact-card-overlap, lumin-portrait-and-process-band, lumin-large-type-statement. Internal links: consultation.html, faq.html, privacy.html, accessibility.html, legal.html.
- FAQ: Answer practical questions in concise, careful language that guides visitors to professional evaluation. Layout rhythm: lumin-offset-consultation-ledger, lumin-full-bleed-botanical-divider, lumin-contact-card-overlap, lumin-portrait-and-process-band. Internal links: care.html, laser.html, skin.html, results.html, consultation.html, contact.html, privacy.html.
- Journal: Offer editorial education that helps visitors ask better questions before care. Layout rhythm: lumin-asymmetric-laser-panel, lumin-contact-card-overlap, lumin-portrait-and-process-band, lumin-large-type-statement. Internal links: care.html, laser.html, skin.html, results.html, blog.html, consultation.html.
- Blog: Present deeper educational articles on skin, laser, consultation, aftercare, and expectations. Layout rhythm: lumin-editorial-image-chapter, lumin-asymmetric-laser-panel, lumin-minimal-legal-ledger, lumin-image-led-trust-strip. Internal links: care.html, laser.html, skin.html, results.html, journal.html, consultation.html.
- Legal: Clarify responsible website use, educational limits, legal boundaries, and approved contact routes. Layout rhythm: lumin-horizontal-care-journey, lumin-radial-results-map, lumin-stacked-proof-column, lumin-accordion-guidance-panel. Internal links: privacy.html, cookies.html, accessibility.html, contact.html, sitemap.html.

## 9. Footer Signature
- Footer structure: classes `public-footer-18, public-footer-recipe-lumin, public-footer-icons-ray, public-footer-divider-glowline, public-footer-hover-gold-sweep, public-footer-shell`; recipe `lumin`.
...
- Decorative assets/background: The footer uses a light-panel footer, local contact hierarchy and concept-specific footer marker `footer-18-lumin`.
- Mobile stacking: verify in the mobile header/footer screenshot sheet after any footer edit.
- Alignment risks: C18-LABEL-001, C18-SITEMAP-001, C18-FOOTER-001, C18-RENDER-001
- Files involved: `concepts/18-lumin/partials/footer.html`, `concepts/18-lumin/css/style.css`.
...
- Hero/portrait use: champagne line portrait seal, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-lumin.webp`.
- Service/botanical/icons: A custom high-contrast clinic strokes SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
- Key asset paths:
- `concepts/18-lumin/assets/animations/motion-path.svg`
- `concepts/18-lumin/assets/backgrounds/botanical-background.svg`
- `concepts/18-lumin/assets/backgrounds/mobile-menu-background.svg`
- `concepts/18-lumin/assets/botanical/botanical-quote.svg`
- `concepts/18-lumin/assets/botanical/bronze-branch.svg`
- `concepts/18-lumin/assets/botanical/footer-botanical-stamp.svg`
- `concepts/18-lumin/assets/botanical/gold-leaf-divider.svg`
- `concepts/18-lumin/assets/botanical/monogram-wreath.svg`
- `concepts/18-lumin/assets/botanical/sage-botanical-corner.svg`
- `concepts/18-lumin/assets/botanical/section-separator.svg`
- `concepts/18-lumin/assets/brand/assinatura-1.jpg`
- `concepts/18-lumin/assets/brand/footer-signature-watermark.png`
...
- Title/meta pattern: `Evaluation-Led Aesthetic Care | Lumin | Franciele Sofiati` / `Evaluation-Led Aesthetic Care for Franciele Sofiati in Londrina, PR, guided by evaluation-first care, ethical expectations and the Lumin concept.`
- H1 pattern: 1 H1 parsed; `Evaluation-led care for skin quality`
- Schema pattern: `partials/schema.html` plus page head partials control JSON-LD evidence.
- Sitemap presence: `concepts/18-lumin/sitemap.html` exists.
...
- What makes it different: It is identified by `high-contrast clinic strokes`, portrait treatment `champagne line portrait seal`, motion `form focus glow`, form `business-card form` and footer `bronze strip footer`. The HTML, CSS and JS include unique markers for this concept.
- Protected features: header `public-header-layout-glass`, menu `public-menu-layout-frosted-glass`, footer recipe `lumin`, asset language `Local assets combine the approved logo, FS monogram, signature mark, a custom Franciele portrait treatment, botanical dividers, service visuals, form framing and an icon pack.`, motion `form focus glow controls strip dividers, icon hover behaviour, portrait movement and scroll CSS variables.`.
- Concepts it risks resembling: compare closely against concepts `19` and `26` during duplicate-layout audits.
...
- Can improve: active issues can be fixed using spacing, contrast, label, and alignment adjustments without replacing the `luminous technology narrative.` visual grammar.
...
## 21. Fixes Applied
- C18-LABEL-001: Footer public labels were cleaned from Brand/Brand and Trust to About. File: `concepts/18-lumin/partials/footer.html`. Verification: Run rg label search and screenshot footer..
- C18-SITEMAP-001: Sitemap Brand and education label was cleaned to About and education. File: `concepts/18-lumin/sitemap.html`. Verification: Run rg for Brand and education..

## 22. Final Concept Status
- Status: high risk
- Confidence level: high
- Remaining issues: C18-FOOTER-001, C18-RENDER-001
