...
ROUTES = {
    ...
    "faq": ("faq.html", "perguntas.html", "/perguntas.html"),
...
SEO = {
    ...
    "faq": ("Perguntas | Franciele Sofiati", "Respostas sobre consulta, tratamentos estéticos, preparo, recuperação, segurança e acompanhamento com Franciele Sofiati."),
