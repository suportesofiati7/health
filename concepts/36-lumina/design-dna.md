# 36 Lumina Design DNA

Concept name: Lumina

Visual idea: membership skincare bar translated into a Sofiati visual world, using skincare bar progress marks as the governing asset language.
...
Navigation idea: membership header on desktop and pass menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-lumina.webp`.

Botanical/gold idea: soft leaf watermark appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom skincare bar progress marks SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `skincare bar progress marks`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: lumina reflective story.
...
- Visual storytelling style: Lumina should feel like lumina reflective story, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `37` and `44` during duplicate-layout audits.
