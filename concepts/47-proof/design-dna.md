...
Visual idea: expert routine blog translated into a Sofiati visual world, using expert routine sequence as the governing asset language.
...
Navigation idea: expert routine header on desktop and routine menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-proof.webp`.

Botanical/gold idea: animated leaf path appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom expert routine sequence SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `expert routine sequence`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: proof-focused responsibility system.
...
- Visual storytelling style: Proof should feel like proof-focused responsibility system, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `48` and `05` during duplicate-layout audits.
