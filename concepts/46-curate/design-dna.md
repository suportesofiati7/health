# 46 Curate Design DNA

Concept name: Curate

Visual idea: spa menu curation translated into a Sofiati visual world, using spa menu botanical tabs as the governing asset language.
...
Navigation idea: spa services header on desktop and spa treatment menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-curate.webp`.

Botanical/gold idea: soft leaf watermark appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom spa menu botanical tabs SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `spa menu botanical tabs`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: curated consultation guide.
...
- Visual storytelling style: Curate should feel like curated consultation guide, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `47` and `04` during duplicate-layout audits.
