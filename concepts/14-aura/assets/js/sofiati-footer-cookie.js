...
(() => {
  ...
  const CONFIG = {"code": "14", "slug": "aura", "bg": "#F8F7F2", "fg": "#252321", "muted": "rgba(37,35,33,.62)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.18)", "width": "min(1080px,calc(100% - 34px))", "padding": "10px 0", "fontSize": ".81rem", "align": "center", "layout": "center", "separator": "halo", "marker": "circle", "buttonStyle": "solid-first", "radius": "999px", "autoDelayMs": 10680};
