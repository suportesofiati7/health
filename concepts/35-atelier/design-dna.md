# 35 Atelier Design DNA

Concept name: Atelier

Visual idea: laser studio franchise translated into a Sofiati visual world, using laser studio membership passes as the governing asset language.
...
Navigation idea: laser studio header on desktop and membership laser menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: full-height consultation portrait badge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-atelier.webp`.

Botanical/gold idea: botanical section separator appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom laser studio membership passes SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `laser studio membership passes`, portrait treatment `full-height consultation portrait badge`, motion `gold shimmer`, form `step-style consultation form` and footer `botanical map footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: atelier object study.
...
- Visual storytelling style: Atelier should feel like atelier object study, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `36` and `43` during duplicate-layout audits.
