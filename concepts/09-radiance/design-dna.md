...
Doctor portrait idea: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-radiance.webp`.

Botanical/gold idea: mobile-menu botanical field appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom consultation studio badges SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `consultation studio badges`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: light-washed skin journal.
...
- Visual storytelling style: Radiance should feel like light-washed skin journal, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `10` and `17` during duplicate-layout audits.
