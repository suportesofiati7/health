...
(() => {
  ...
  const CONFIG = {"code": "49", "slug": "wisdom", "bg": "#252321", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.70)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.20)", "width": "min(1080px,calc(100% - 34px))", "padding": "10px 0", "fontSize": ".77rem", "align": "left", "layout": "fine-print", "separator": "gold-top", "marker": "book", "buttonStyle": "pill-outline", "radius": "999px", "autoDelayMs": 14880};
