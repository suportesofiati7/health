# 49 Wisdom Design DNA

Concept name: Wisdom

Visual idea: clean farm skincare translated into a Sofiati visual world, using farm-clean field notes as the governing asset language.
...
Navigation idea: farm-luxury header on desktop and farm story menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-wisdom.webp`.

Botanical/gold idea: mobile-menu botanical field appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom farm-clean field notes SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `farm-clean field notes`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: wisdom-led care library.
...
- Visual storytelling style: Wisdom should feel like wisdom-led care library, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `50` and `07` during duplicate-layout audits.
