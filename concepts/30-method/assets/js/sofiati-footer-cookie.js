...
(() => {
  ...
  const CONFIG = {"code": "30", "slug": "method", "bg": "#FBFAF6", "fg": "#252321", "muted": "rgba(37,35,33,.64)", "accent": "#9A6B35", "border": "1px solid rgba(154,107,53,.18)", "width": "min(940px,calc(100% - 30px))", "padding": "10px 0", "fontSize": ".81rem", "align": "left", "layout": "ledger", "separator": "step", "marker": "step", "buttonStyle": "square", "radius": "4px", "autoDelayMs": 12600};
