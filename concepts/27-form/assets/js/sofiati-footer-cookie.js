...
(() => {
  ...
  const CONFIG = {"code": "27", "slug": "form", "bg": "#2B2B27", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.72)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.22)", "width": "min(1080px,calc(100% - 34px))", "padding": "10px 0", "fontSize": ".81rem", "align": "left", "layout": "angular", "separator": "diagonal", "marker": "angle", "buttonStyle": "square", "radius": "4px", "autoDelayMs": 12240};
