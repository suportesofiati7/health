...
Visual idea: procedure library translated into a Sofiati visual world, using procedure library tabs as the governing asset language.
...
Navigation idea: library header on desktop and mega library menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: clinical credential portrait card, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-form.webp`.

Botanical/gold idea: animated leaf path appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom procedure library tabs SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `procedure library tabs`, portrait treatment `clinical credential portrait card`, motion `divider trace`, form `floating editorial form` and footer `apothecary fine-print footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: form and structure study.
...
- Visual storytelling style: Form should feel like form and structure study, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `28` and `35` during duplicate-layout audits.
