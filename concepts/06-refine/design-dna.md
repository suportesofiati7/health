# 06 Refine Design DNA

Concept name: Refine

Visual idea: ultra-minimal clinical edit translated into a Sofiati visual world, using mobile story botanical path as the governing asset language.
...
Navigation idea: fine-line side navigation on desktop and minimal line drawer on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: soft oval botanical frame, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-refine.webp`.

Botanical/gold idea: soft leaf watermark appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom mobile story botanical path SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `mobile story botanical path`, portrait treatment `soft oval botanical frame`, motion `menu bloom`, form `sidebar form` and footer `concierge contact footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: minimal refinement.
...
- Visual storytelling style: Refine should feel like minimal refinement, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `07` and `14` during duplicate-layout audits.
