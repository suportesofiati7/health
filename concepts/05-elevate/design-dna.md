# 05 Elevate Design DNA

Concept name: Elevate

Visual idea: high luxury editorial maison translated into a Sofiati visual world, using quiet luxury watermark as the governing asset language.
...
Navigation idea: split luxury wordmark navigation on desktop and image-led maison menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: full-height consultation portrait badge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-elevate.webp`.

Botanical/gold idea: botanical section separator appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom quiet luxury watermark SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `quiet luxury watermark`, portrait treatment `full-height consultation portrait badge`, motion `gold shimmer`, form `step-style consultation form` and footer `botanical map footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: elevated spa atelier.
...
- Visual storytelling style: Elevate should feel like elevated spa atelier, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `06` and `13` during duplicate-layout audits.
