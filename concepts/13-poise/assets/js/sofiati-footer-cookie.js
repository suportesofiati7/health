...
(() => {
  ...
  const CONFIG = {"code": "13", "slug": "poise", "bg": "#252321", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.70)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.22)", "width": "min(1080px,calc(100% - 34px))", "padding": "10px 0", "fontSize": ".81rem", "align": "left", "layout": "editorial", "separator": "gold-top", "marker": "diamond", "buttonStyle": "text", "radius": "4px", "autoDelayMs": 10560};
