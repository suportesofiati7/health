# 29 Solace Design DNA

Concept name: Solace

Visual idea: doctor journal translated into a Sofiati visual world, using doctor journal notecards as the governing asset language.
...
Navigation idea: journal doctor header on desktop and notebook menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: mobile avatar with FS watermark, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-solace.webp`.

Botanical/gold idea: mobile-menu botanical field appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom doctor journal notecards SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `doctor journal notecards`, portrait treatment `mobile avatar with FS watermark`, motion `journal card rise`, form `mobile-first bottom form` and footer `story-background footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: solace support journey.
...
- Visual storytelling style: Solace should feel like solace support journey, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `30` and `37` during duplicate-layout audits.
