# 15 Clarity Design DNA

Concept name: Clarity

Visual idea: clinical technology atlas translated into a Sofiati visual world, using procedure atlas symbols as the governing asset language.
...
Navigation idea: indexed precision header on desktop and diagram-style treatment menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: full-height consultation portrait badge, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-clarity.webp`.

Botanical/gold idea: botanical section separator appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom procedure atlas symbols SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `procedure atlas symbols`, portrait treatment `full-height consultation portrait badge`, motion `gold shimmer`, form `step-style consultation form` and footer `botanical map footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: clarity-first clinical guide.
...
- Visual storytelling style: Clarity should feel like clarity-first clinical guide, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `16` and `23` during duplicate-layout audits.
