...
Visual idea: artisan boutique clinic translated into a Sofiati visual world, using artisan botanical craft as the governing asset language.
...
Navigation idea: atelier header on desktop and artisan menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: business-card portrait with signature line, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-flora.webp`.

Botanical/gold idea: monogram wreath appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom artisan botanical craft SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `artisan botanical craft`, portrait treatment `business-card portrait with signature line`, motion `icon tilt`, form `gold line form` and footer `clinical column footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: flora clinical garden.
...
- Visual storytelling style: Flora should feel like flora clinical garden, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `35` and `42` during duplicate-layout audits.
