...
(() => {
  ...
  const CONFIG = {"code": "01", "slug": "inspire", "bg": "#252321", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.70)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.24)", "width": "min(1180px,calc(100% - 38px))", "padding": "10px 0", "fontSize": ".81rem", "align": "left", "layout": "split", "separator": "gold-top", "marker": "dot", "buttonStyle": "solid-first", "radius": "999px", "autoDelayMs": 9120};
