...
(() => {
  ...
  const CONFIG = {"code": "38", "slug": "origin", "bg": "#2B312D", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.70)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.20)", "width": "min(1080px,calc(100% - 34px))", "padding": "10px 0", "fontSize": ".81rem", "align": "left", "layout": "botanical", "separator": "left-rule", "marker": "leaf", "buttonStyle": "pill-outline", "radius": "999px", "autoDelayMs": 13560};
