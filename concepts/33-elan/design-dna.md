...
Visual idea: destination premium care translated into a Sofiati visual world, using destination journey pins as the governing asset language.
...
Navigation idea: destination header on desktop and journey planner menu on mobile, with botanical background assets and a small portrait cue in the menu.
...
Doctor portrait idea: sage duotone editorial profile tile, generated from `brand identity/Dr Fran.png` and saved as `assets/portrait/franciele-portrait-elan.webp`.

Botanical/gold idea: bronze corner frame appears in the hero, section strip, mobile menu, form and footer.

Icon idea: A custom destination journey pins SVG icon pack covers consultation, laser, skin, care, evaluation, safety, aftercare, results, journal, mission, values, contact, technology, credentials, WhatsApp and back to top.
...
How this concept differs from the other 49: It is identified by `destination journey pins`, portrait treatment `sage duotone editorial profile tile`, motion `portrait lift`, form `botanical framed form` and footer `signature seal footer`. The HTML, CSS and JS include unique markers for this concept.

## Required Planning Expansion

- Concept mood: elan brand narrative.
...
- Visual storytelling style: Elan should feel like elan brand narrative, not a recolor of another concept.
...
- Resemblance risks: compare closely against concepts `34` and `41` during duplicate-layout audits.
