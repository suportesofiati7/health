...
(() => {
  ...
  const CONFIG = {"code": "33", "slug": "elan", "bg": "#252321", "fg": "#F8F7F2", "muted": "rgba(248,247,242,.72)", "accent": "#C9A56A", "border": "1px solid rgba(201,165,106,.24)", "width": "min(1180px,calc(100% - 38px))", "padding": "10px 0", "fontSize": ".81rem", "align": "left", "layout": "editorial", "separator": "gold-top", "marker": "diamond", "buttonStyle": "text", "radius": "4px", "autoDelayMs": 12960};
