...
const member={id:'20000000-0000-4000-8000-000000000001',organization_id:org,user_id:uid,name:'Franciele (teste fictício)',email:user.email,role:'owner',status:'active',profession:'Biomedicina',council:'CRBM',registration:'TESTE',state:'PR'};
const patient={id:'30000000-0000-4000-8000-000000000001',organization_id:org,full_name:'Marina Exemplo Fictício',preferred_name:'',birth_date:'1992-03-12',phone:'43999990000',email:'marina@example.invalid',cpf:null,rg:'',cns:null,address:{},guardian:{},emergency_contact:{},status:'active',created_at:created,version:1};
const entry={id:'40000000-0000-4000-8000-000000000001',organization_id:org,patient_id:patient.id,kind:'assessment',title:'Avaliação fictícia',content:'CONTEÚDO FICTÍCIO: pele sensível; avaliação sem dados reais.',data:{concern:'Objetivo fictício de cuidado'},status:'final',created_by:uid,clinical_at:created,created_at:created,version:1};
const fixtures={memberships:[member],patients:[patient],entries:[entry],entry_versions:[],documents:[],document_links:[],communications:[],admin_notes:[],enquiries:[{id:'70000000-0000-4000-8000-000000000001',organization_id:org,full_name:'Contato Exemplo Fictício',phone:'43988880000',email:'enquiry@example.invalid',status:'new',internal_notes:'',created_at:created,consent_at:created}],appointments:[{id:'50000000-0000-4000-8000-000000000001',organization_id:org,patient_id:patient.id,patients:patient,starts_at:`${day}T14:00:00-03:00`,ends_at:`${day}T15:00:00-03:00`,status:'confirmed',label:'Avaliação estética',version:1}],tasks:[{id:'60000000-0000-4000-8000-000000000001',organization_id:org,patient_id:patient.id,patients:patient,title:'Confirmar retorno fictício',due_at:`${day}T10:00:00-03:00`,status:'pending',priority:'high',version:1}],audit_events:[]};
...
async function contextFor(width,height,role='owner'){
