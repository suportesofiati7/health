export const STANDARD_PLACEHOLDERS = [
  ...
  ['link', 'Link relevante', 'Atendimento'], ['link_reuniao', 'Link da reunião', 'Agendamento'], ['link_formulario', 'Formulário prévio', 'Documentos'], ['link_google_avaliacao', 'Avaliação Google', 'Feedback'], ['valor', 'Valor', 'Financeiro'],
  ['forma_pagamento', 'Forma de pagamento', 'Financeiro'], ['vencimento', 'Data de vencimento', 'Financeiro'],
  ['numero_parcela', 'Número da parcela', 'Financeiro'], ['proximo_pagamento', 'Próximo pagamento', 'Financeiro'], ['data_pagamento', 'Data do pagamento', 'Financeiro'], ['documento', 'Nome do documento', 'Documentos'],
  ['lista_documentos', 'Documentos necessários', 'Documentos'], ['prazo', 'Prazo', 'Processo/serviço'], ['protocolo', 'Protocolo', 'Processo/serviço'],
  ['status', 'Status atual', 'Processo/serviço'], ['proxima_etapa', 'Próxima etapa', 'Processo/serviço'], ['opcoes_consulta', 'Opções de consulta', 'Agendamento'], ['observacao', 'Informação complementar', 'Atendimento'],
...
export function valuesForPatient(patient, member, appointment) {
  ...
  return {
    ...
    link_formulario: 'https://francielesofiati.com/formulario', link_google_avaliacao: 'https://share.google/3x0ErYeWQ4EHJTpJB', opcoes_consulta: 'os horários e opções disponíveis enviados pela equipe', proxima_etapa: 'a confirmação da consulta e as orientações da equipe',
